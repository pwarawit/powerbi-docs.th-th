...
นอกจากนี้คุณยังสามารถกำหนด และสร้างมาตรฐานองค์ประกอบเกือบทั้งหมดได้ด้วยตนเอง หากต้องการกำหนดเอง ให้ใช้ไฟล์ JSON ที่คุณปรับด้วยตนเองในบานหน้าต่าง **การจัดรูปแบบ** เป้าหมายคือเพื่อ ให้คุณควบคุมวิธีรายงานของคุณ ตา การระดับแยกย่อยทั้งหมด
...
* **background**, **foreground** และ **tableAccent**: สีที่ใช้ควรในวิชวลชนิดต่าง ๆ 
  - **พื้นหน้า**นำไปใช้กับข้อความในกล่องข้อความ ข้อความเป้าหมายของ KPI การ์ดแบบหลายแถวข้อความ ข้อ ความค่าบัตร ตัววัดคำบรรยายภาพแบบข้อความ ตัวแบ่งส่วนข้อมูลแนวตั้งองค์ประกอบ และ**ตาราง**และ**เมทริกซ์**ผลรวมและค่าข้อความ 
...
* **ชื่อ**: ชื่อธีมซึ่งเป็นเขตข้อมูลเดียวที่บังคับ
* **dataColors**: รายการรหัสสีรหัสฐานสิบหกที่ใช้เป็นข้อมูลในวิชวล Power BI Desktop รายการสามารถมีจำนวนสีมากหรือน้อยตามความต้องการของคุณได้
* **background**, **foreground** และ **tableAccent**: สีที่ใช้ควรในวิชวลชนิดต่าง ๆ การ**พื้น**นำไปใช้กับข้อความในกล่องข้อความ ข้อความเป้าหมายของ KPI การ์ดแบบหลายแถวข้อความ ข้อ ความค่าบัตร ตัววัดคำบรรยายภาพแบบข้อความ ตัวแบ่งส่วนข้อมูลแนวตั้งองค์ประกอบ และ**ตาราง**และ**เมทริกซ์** ผลรวมและค่าข้อความ **background** ใช้เพื่อเติมสีปุ่มและพื้นหลังป้ายชื่อแผนภูมิผสม วิธีที่ใช้สีเหล่านี้จะขึ้นอยู่กับลักษณะวิชวลที่ถูกนำไปใช้ วิชวล**ตาราง**และ**เมทริกซ์** นำสไตล์เหล่านี้ไปใช้ตามค่าเริ่มต้น
