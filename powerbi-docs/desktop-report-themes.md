...
นอกจากนี้ คุณยังสามารถปรับแต่งและกำหนดมาตรฐานองค์ประกอบส่วนใหญ่ที่เห็นในบานหน้าต่าง**การจัดรูปแบบ**ผ่านการปรับแต่งโดยตรงใน Power BI Desktop หรือผ่านธีมไฟล์ JSON เป้าหมายคือการเปิดให้คุณสามารถควบคุมการแสดงรายงานของคุณอย่างเต็มที่ ไปจนถึงระดับแยกย่อยได้

## <a name="how-report-themes-work"></a>ธีมรายงาน ทำงานอย่างไร
หากต้องการใช้ธีมรายงานกับรายงาน Power BI Desktop ให้เลือกจากธีมรายงานที่มีอยู่ภายในระบบหรือสร้างหรือนำเข้าธีมแบบกำหนดเอง
...
มีสองวิธีในการกำหนดธีมใน Power BI Desktop มาดูรายละเอียดของแต่ละวิธีกัน


## <a name="customize-report-themes-preview"></a>ปรับแต่งธีมรายงาน (ตัวอย่าง)

ตั้งแต่การเปิดตัว **Power BI Desktop** ในเดือนธันวาคม 2019 ตอนนี้มีวิธีการปรับแต่งธีมรายงานสองวิธี

* สร้างและปรับแต่งธีมใน Power BI Desktop (ตัวอย่าง)
* การสร้างและการปรับแต่งไฟล์ JSON ของธีมรายงานแบบกำหนดเองผ

ในการกำหนดธีมใน Power BI Desktop โดยตรง คุณต้องเลือก **ไฟล์ > ตัวเลือกและการตั้งค่า > ตัวเลือก** และจากนั้น ในส่วน **ฟีเจอร์ตัวอย่าง** เลือกกล่องข้าง **กำหนดธีมปัจจุบัน** ดัวที่แสดงในรูปต่อไปนี้

![เปิดใช้งานธีมที่กำหนดเอง](media/desktop-report-themes/report-themes_5a.png)

คุณจะได้รับข้อความให้รีสตาร์ท Power BI Desktop สำหรับเปิดใช้งานฟีเจอร์ตัวอย่าง

หลังจากที่คุณรีสตาร์ท คุณสามารถเริ่มปรับแต่งธีมปัจจุบันโดยเลือกริบบิ้น**หน้าหลัก** จากนั้นเลือก **เปลี่นนธีม > กำหนดธีมปัจจุบัน**จากริบบิ้น กล่องข้อความจะปรากฎขึ้น ซึ่งแสดงวิธีต่าง ๆ ที่คุณสามารถกำหนดธีมที่มีอยู่ได้

![กำหนดธีม](media/desktop-report-themes/report-themes_5b.png)

หากคุณชอบธีมที่มีอยู่และต้องการปรับแต่งเพียงเล็กน้อย คุณสามารถเลือกธีมที่มีอยู่ และจากนั้นเลือก **กำหนดธีมปัจจุบัน** จากกล่องข้อความดังที่แสดงในรูปต่อไปนี้ 

![กำหนดธีมปัจจุบัน](media/desktop-report-themes/report-themes_5c.png)

> [!NOTE]
> ภาพก่อนหน้านี้แสดงภาพริบบิ้นใหม่ ซึ่งเป็นขณะนี้อยู่ในตัวอย่าง คุณสามารถเปิดใช้งานตัวอย่างริบบิ้นใหม่โดยการเลือก**ไฟล์ > ตัวเลือกและการตั้งค่า > ตัวเลือก** และจากนั้น ในส่วน **ฟีเจอร์ตัวอย่าง** ให้เลือก **ตัวอย่างริบบิ้นใหม่**

การตั้งค่าธีมที่สามารถกำหนดได้นั้นอยู่ในประเภทต่อไปนี้ ซึ่งแสดงประเภทดังต่อไปนี้ ซึ่งแสดงในกล่องข้อความธีมที่กำหนด:

* ชื่อธีม (คุณจะต้องตั้งชื่อธีมที่คุณกำหนด) และตั้งค่าสีต่าง ๆ (สีธีม สีตามความรู้สึก สีที่แตกต่าง และอื่น ๆ)
* การตั้งค่าข้อความ ประกอบด้วย รูปแบบตัวอักษร ขนาด สี รวมทั้งชื่อแกน สี การ์ด และ KPI และส่วนหัวของแถบ
* องค์ประกอบของวิชวล เช่น พื้นหลัง กรอบ ส่วนหัว และคำแนะนำเครื่องมือ
* องค์ประกอบของหน้าเช่น เช่น วอล์เปเปอร์ และพื้นหลัง
* การตั้งค่าบานหน้าต่างตัวกรอง ประกอบด้วย สีภาพพื้นหลัง ความโปร่งแสง สีตัวอักษรและไอคอน ขนาด การ์ดตัวกรอง และอื่น ๆ

เมื่อคุณเปลี่ยนแปลงและเลือกปุ่ม **ปรับใช้และบันทึก** ธีมของคุณจะถูกบันทึก และสามารถใช้งานได้ในรายงานปัจจุบัน โดยสามารถส่งออกได้ด้วย 

การปรับแต่งธีมปัจจุบันของคุณด้วยวิธีนี้สามารถทำให้การปรับแต่งธีมสำหรับวิชวลเป็นไปอย่างง่ายดายและรวดเร็ว อย่างไรก็ตาม มีการปรับเปลี่ยนที่จำกัดบางอย่างสำหรับธีม ซึ่งจำเป็นต้องแก้ไขไฟล์ JSON ของธีมดังที่อธิบายไว้ในส่วนต่อไปนี้

> [!TIP]
> คุณสามารถกำหนดองค์ประกอบของธีมส่วนใหญ่โดยใช้องค์ประกอบที่มองเห็นได้โดยใช้กล่องข้อความ **กำหนดธีมปัจจุบัน** จากนั้นคุณสามารถส่งออกไฟล์ JSON และปรับแต่งโดยละเอียดด้วยตนเอง (โดยการปรับเปลี่ยนไฟล์ JSON) จากนั้นคุณสามารถเปลี่ยนชื่อไฟล์ JSON ที่ปรับแต่งโดยละเอียดแล้ว นำเข้าไฟล์ และมีการปรับปรุงทั้งหมดที่คุณต้องการ
