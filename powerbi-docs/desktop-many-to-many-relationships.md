...
ด้วยคุณลักษณะ *ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม* ใน Power BI Desktop คุณสามารถเข้าร่วมตารางที่ใช้คาร์ดินาลลิตี้ของ *กลุ่มต่อกลุ่ม* คุณสามารถสร้างโมเดลข้อมูลที่มีสองแหล่งข้อมูลหรือมากกว่าได้อย่างง่ายดาย คุณลักษณะ *ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม* คือหนึ่งในความสามารถของ *โมเดลรวม* ที่มากกว่าใน Power BI Desktop
...
ความสามารถของ *ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม* ใน Power BI Desktop ถือเป็นหนึ่งใน 3 คุณลักษณะที่เกี่ยวข้อง:
...
* **ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม**: ด้วย *โมเดลแบบรวม* คุณสามารถสร้าง *ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม* ระหว่างตารางได้ วิธีการนี้จะลบขอคำสำหรับค่าไม่ซ้ำกันในตาราง นอกจากนี้ยังลบการแก้ปัญหาชั่วคราวก่อนหน้า เช่น การเริ่มตารางใหม่เพียงเพื่อสร้างความสัมพันธ์ จะอธิบายคุณลักษณะต่อไปในบทความนี้
...
## <a name="enable-the-many-to-many-relationships-preview-feature"></a>เปิดใช้งานคุณลักษณะตัวอย่าง *ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม*

จะต้องเปิดใช้งานคุณลักษณะ *ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม* ใน Power BI Desktop หากต้องการเปิดใช้งานโมเดลแบบรวม ให้ไปที่ **ไฟล์** >  **ตัวเลือกและการตั้งค่า** > **ตัวเลือก** > **คุณลักษณะตัวอย่าง** จากนั้นเลือกกล่องกาเครื่องหมาย **โมเดลแบบรวม**
...
## <a name="what-many-to-many-relationships-solves"></a>*ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม* ช่วยแก้ปัญหาอะไรบ้าง

ก่อนที่คุณลักษณะ *ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม* จะให้บริการ ความสัมพันธ์ระหว่างสองตารางถูกกำหนดใน Power BI อย่างน้อยหนึ่งในคอลัมน์ของตารางที่อยู่ในความสัมพันธ์ต้องมีค่าเฉพาะ แต่บ่อยครั้งที่ไม่มีคอลัมน์ที่มีค่าเฉพาะ 
...
## <a name="use-many-to-many-relationships"></a>ใช้ *ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม*
...
ดังที่เห็น *TX*&mdash;กับข้อมูล *การขาย* แต่ไม่ทราบข้อมูล *ประชากร* &mdash;และ *นิวยอร์ก*&mdash;กับข้อมูล *ประชากร* ที่ทราบแต่ไม่มีข้อมูล *การขาย* &mdash;จะรวมอยู่ด้วย การแก้ปัญหาชั่วคราวนี้ไม่เหมาะสม และมีหลายปัญหา ด้วยการมาถึงของความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม ปัญหาที่เกิดขึ้นได้รับการแก้ไข ดังที่อธิบายในส่วนถัดไป

## <a name="use-many-to-many-relationships-instead-of-the-workaround"></a>ใช้ *ความสัมพันธ์แบบ-กลุ่ม-ต่อ-กลุ่ม* แทนการแก้ปัญหาชั่วคราว
...
> [!NOTE]
> ความสามารถในการสร้าง *ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม* อยู่ในช่วงตัวอย่าง ในขณะที่อยู่ในช่วงตัวอย่างจะไม่สามารถเผยแพร่ไปยังโมเดลบริการของ Power BI ที่ใช้ *ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม* 
...
ความแตกต่างที่สำคัญระหว่างความสัมพันธ์แบบ *กลุ่มต่อกลุ่ม* กับความสัมพันธ์แบบ *Many-1* ที่ใช้กันเป็นปกติกว่าจะเป็นดังนี้:
...
มีข้อจำกัดจำนวนหนึ่งสำหรับ*ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่ม*และโมเดลแบบรวมในรุ่นนี้
