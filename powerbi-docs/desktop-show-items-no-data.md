...
เมื่อต้องเริ่มต้นทำความเข้าใจวิธี Power BI กำหนดข้อมูลที่เกี่ยวข้องในการแสดงผล ให้พิจารณาตารางนี้ในฐานะตัวอย่างอย่างง่าย ใช้แบบจำลองที่แสดงในส่วนของตัวอย่าง (ซึ่งอยู่ที่ส่วนท้ายของบทความนี้) พิจารณาการสร้างตารางด้วยการตั้งค่าต่อไปนี้:
...
ตัวอย่างแบบจำลองไม่มีการรวมนี้ แต่ถ้าเป็นกลุ่มจากตารางอื่นและไม่มีความเกี่ยวข้องกัน Power BI จะไม่สามารถเชื่อมสองคอลัมน์ และผลลัพธ์จะเป็นการรวมข้ามตารางของค่าทั้งหมดในแต่ละคอลัมน์ ในสถานการณ์นั้น Power BI จะแจ้งข้อผิดพลาดเป็นปัญหาประเภท*การรวมแบบไม่มีข้อจำกัด*เนื่อง จากการรวมข้ามเช่นนั้นฐานข้อมูลต้องใช้ข้อมูลจำนวนมหาศาลในการคำนวณและไม่สามารถให้ข้อมูลจำนวนมากขนาดนั้นกับผู้ใช้ได้ 
