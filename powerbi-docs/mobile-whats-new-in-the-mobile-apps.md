...
**แอปสำหรับอุปกรณ์เคลื่อน Power BI**สำหรับแท็บเล็ต Android ใช้งานได้ทั่วโลก เริ่มต้นใช้งานการ[Power BI บนแท็บเล็ต Android](mobile-android-tablet-app-get-started.md)
...
* ใช้งาน[Power BI บนแท็บเล็ต Android ของคุณ](mobile-android-tablet-app-get-started.md)
...
#### <a name="all-devices"></a>อุปกรณ์ทั้งหมด
**รายการโปรดใช้เป็นเพจเริ่มต้น** ถ้าคุณได้ทำเครื่องหมาย ของแดชบอร์ดว่ารายการโปรด จากนั้นเพจเริ่มต้นของคุณจะเป็นรายการโปรดของคุณ 
...
**แดชบอร์ด Bing** ใน Power BI service คุณสามารถสร้างในตอนนี้[ผลลัพธ์การค้นหาแดชบอร์ด โดยใช้ Bing](service-connect-to-bing.md)และดูบนอุปกรณ์เคลื่อนที่ของคุณได้
