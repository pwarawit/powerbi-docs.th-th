---
title: คำแนะนำและเคล็ดลับในการสรา้งรายงานใน Power BI Desktop
description: คำแนะนำและเคล็ดลับในการสรา้งรายงานใน Power BI Desktop
services: powerbi
documentationcenter: ''
...
ในตัวนำทางของตัวแก้ไขคิวรี เมื่อคุณคลิกขวาที่คิวรีหนึ่งครั้ง ตัวเลือกสำหรับ "การอ้างอิง" ก็จะพร้อมใช้งาน  การดำเนินการนี้จะเป็นประโยชน์ด้วยเหตุผลต่อไปนี้:
...
ใช้ตัวอย่างของตารางอย่างง่ายสำหรับอุณหภูมิและเวลาที่ได้ทำการอ่านข้อมูล ถ้าคุณลงจุดค่าเหล่านี้ลงในแผนภูมิกระจายโดยตรง Power BI Desktop ก็จะรวมค่าทั้งหมดไว้ในจุดเดียว เมื่อต้องการแสดงจุดข้อมูลแต่ละจุด คุณก็จะต้องเพิ่มเขตข้อมูลลงในบักเก็ตรายละเอียดในเขตข้อมูลตามที่เหมาะสม   วิธีง่ายๆ ในการดำเนินการนี้ คือ ที่แท็บคิวรี ให้ใช้ตัวเลือก "เพิ่มคอลัมน์ดัชนี" ใน Ribbon "เพิ่มคอลัมน์" 

## <a name="reference-lines-in-your-report"></a>เส้นอ้างอิงในรายงานของคุณ
คุณสามารถใช้คอลัมน์จากการคำนวณ เพื่อกำหนดเส้นอ้างอิง  ระบุตารางและคอลัมน์ที่คุณต้องการสร้างเส้นอ้างอิง  เลือก "คอลัมน์ใหม่" ใน Ribbon และ ในแถบสูตร ให้พิมพ์สูตรต่อไปนี้:
...
เมื่อคุณใช้ค่าแบบกลุ่ม (สตริง) ใน Power BI Desktop สำหรับแกนของแผนภูมิ หรือในตัวแบ่งส่วนข้อมูลหรือตัวกรอง ลำดับเริ่มต้นจะเป็นแบบตัวอักษร ถ้าคุณต้องการแทนลำดับนี้ ตัวอย่างเช่น สำหรับสิ่งต่างๆ เช่น วันในสัปดาห์หรือเดือน จากนั้นก็สามารถกำหนดให้ Power BI Desktop เรียงลำดับตามคอลัมน์ต่างๆ หากต้องการเรียนรู้เพิ่มเติม โปรดดู[เรียงลำดับตามคอลัมน์ใน Power BI Desktop](desktop-sort-by-column.md)
...
เมื่อคุณสร้างแมป คุณมักจะต้องการลงจุดประเทศ รัฐและเมืองต่างๆ  ถ้าคุณใช้ชื่อคอลัมน์ต่อท้ายชื่อทางภูมิศาสตร์ ก็จะช่วยให้ Bing สามารถคาดเดาสิ่งที่คุณต้องการแสดงได้ ตัวอย่างเช่น ถ้าคุณมีเขตข้อมูลชื่อรัฐของสหรัฐอเมริกา เช่น "แคลิฟอร์เนีย" และ "วอชิงตัน" Bing อาจแสดงตำแหน่งที่ตั้งของวอชิงตัน ดีซี แทนรัฐวอชิงตัน สำหรับคำว่า "วอชิงตัน"  การตั้งชื่อคอลัมน์ "รัฐ" จะช่วยปรับปรุงการกำหนดพิกัดทางภูมิศาสตร์  เช่นเดียวกับคอลัมน์ที่ใช้ชื่อว่า "ประเทศ" "รัฐ" และ "เมือง"   
...
คุณสามารถใส่ข้อมูลตำแหน่งละติจูดและลองจิจูดที่เฉพาะเจาะจงได้ทุกครั้ง  เมื่อคุณดำเนินการดังกล่าว คุณก็ยังจะต้องระบุข้อมูลลงในเขตข้อมูลตำแหน่งที่ตั้ง มิฉะนั้นระบบจะรวมข้อมูลไว้ตามค่าเริ่มต้น ดังนั้นตำแหน่งที่ตั้งของละติจูดและลองจิจูดจึงอาจไม่ตรงกับที่คุณคาดว่าจะได้รับ
...
ใน Power BI Desktop คุณสามารถตรวจสอบให้แน่ใจว่าเขตข้อมูลได้รับการกำหนดพิกัดทางภูมิศาสตร์ไว้ถูกต้องหรือไม่ โดยตั้งค่าประเภทข้อมูลในเขตข้อมูลนั้น   ใน Power BI Desktop ให้เลือกตารางที่คุณต้องการ ไปที่ Ribbon ขั้นสูง แล้วตั้งค่าประเภทข้อมูลให้เป็นที่อยู่ เมือง ทวีป ประเทศ/ภูมิภาค ประเทศ รหัสไปรษณีย์ รัฐหรือจังหวัด  ประเภทข้อมูลเหล่านี้ช่วยให้ Bing สามารถเข้ารหัสวันที่ได้อย่างถูกต้อง ถ้าต้องการเรียนรู้เพิ่มเติม โปรดดู[การจัดประเภทข้อมูลใน Power BI Desktop](desktop-data-categorization.md)
...
บางครั้ง อาจตั้งค่าประเภทข้อมูลสำหรับการแมปไม่เพียงพอ  ภายในคิวรี คุณสามารถสร้างตำแหน่งที่ตั้งที่เฉพาะเจาะจงมากขึ้นได้ เช่น ที่อยู่ถนน โดยใช้ตัวแก้ไขคิวรีใน Power BI Desktop  ใช้คุณลักษณะเพิ่มคอลัมน์ เพื่อสร้างคอลัมน์แบบกำหนดเอง  จากนั้น สร้างตำแหน่งที่ตั้งตามที่ต้องการดังต่อไปนี้: 

    = [Field1] & " " & [Field2]

จากนั้น ใช้เขตข้อมูลผลลัพธ์นี้ในการแสดงภาพแมป วิธีการนี้จะมีประโยชน์เป็นอย่างมากในการสร้างที่อยู่ถนนจากเขตข้อมูลที่อยู่สำหรับจัดส่งซึ่งพบได้ทั่วไปในชุดข้อมูล  ข้อควรระลึกไว้ประการหนึ่ง คือ การเรียงต่อกันสามารถใช้งานได้เฉพาะกับเขตข้อมูลข้อความเท่านั้น  ในกรณีที่จำเป็น ให้แปลงหมายเลขถนนเป็นชนิดข้อมูลข้อความก่อนที่จะนำไปใช้สร้างอยู่

## <a name="histograms-in-the-query-stage"></a>ฮิสโทแกรมในขั้นคิวรี
มีหลายวิธีในการสร้างฮิสโทแกรม เราจะเริ่มต้นจากวิธีที่ง่ายที่สุด และต่อยอดไปจากวิธีเหล่านั้น ดังนี้:
...
คุณสามารถใช้เขตข้อมูลจากการคำนวณเพื่อกำหนดฮิสโทแกรมได้  ระบุตารางและคอลัมน์ที่คุณต้องการสร้างฮิสโทแกรม  ในพื้นที่การคำนวณ ให้พิมพ์สูตรต่อไปนี้:
...
## <a name="tips-and-tricks-for-creating-relationships"></a>คำแนะนำและเคล็ดลับในการสร้างความสัมพันธ์
...
### <a name="creating-relationships-when-the-data-has-null-or-blank-values"></a>การสร้างความสัมพันธ์ เมื่อข้อมูลมีค่า null หรือมีค่าว่าง
...
### <a name="creating-relationships-when-the-data-has-duplicate-values"></a>การสร้างความสัมพันธ์ เมื่อข้อมูลมีค่าซ้ำกัน
...
[การเริ่มต้นใช้งานด่วน: เรียนรู้ความรู้พื้นฐานเกี่ยวกับ DAX ใน Power BI Desktop](desktop-quickstart-learn-dax-basics.md)
