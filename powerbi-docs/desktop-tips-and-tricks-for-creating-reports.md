...
ในตัวนำทางตัวแก้ไขคิวรีใน Power BI Desktop เมื่อคุณคลิกขวาคิวรี หนึ่งตัวเลือกสำหรับ "การอ้างอิง" จะพร้อมใช้งาน การดำเนินการนี้จะเป็นประโยชน์ด้วยเหตุผลต่อไปนี้:
...
ตามค่าเริ่มต้น คิวรีทั้งหมดจะโหลดไปยังเวิร์กชีต Excel หรือรูปแบบข้อมูล (หรือทั้งสองอย่าง) คิวรีบางรายการจะเป็นขั้นตอน และไม่ได้มีไว้สำหรับผู้ใช้ปลายทาง เมื่อมีการอ้างอิงคิวรีตามที่ระบุไว้ด้านบน ก็มักจะเป็นกรณีนี้ คุณสามารถควบคุมคิวรีโหลดลักษณะการทำงาน โดยการคลิกขวาคิวรีในตัวนำทางสลับตัวเลือก "เปิดใช้งานการโหลด" เมื่อ*เปิดใช้งานการโหลด*ไม่มีเครื่องหมายถูกอยู่ข้าง ๆ แบบสอบถามจะยังคงอยู่ในแท็บคิวรี และคุณสามารถใช้กับคิวรีอื่น ๆ ซึ่งมีประโยชน์อย่างยิ่ง เมื่อใช้งานร่วมกับการผสาน การผนวก และการแปลงข้อมูลอ้างอิง อย่างไรก็ตาม เนื่องจากไม่มีการโหลดผลลัพธ์ของคิวรีลงในรูปแบบข้อมูล คิวรีก็จะไม่กระจายอยู่ในรายการเขตข้อมูลในรายงานของคุณ หรือรูปแบบข้อมูลของคุณ 

## <a name="scatter-charts-need-a-point-identifier"></a>แผนภูมิกระจายต้องมีตัวระบุจุด
ใช้ตัวอย่างของตารางอย่างง่ายสำหรับอุณหภูมิและเวลาที่ได้ทำการอ่านข้อมูล ถ้าคุณลงจุดค่าเหล่านี้ลงในแผนภูมิกระจายโดยตรง Power BI Desktop ก็จะรวมค่าทั้งหมดไว้เป็นจุดเดียว เพื่อแสดงแต่ละจุดข้อมูล คุณต้องเพิ่มเขตข้อมูลลงในบักเก็ตรายละเอียดในเขตข้อมูลได้ดีขึ้น วิธีง่ายๆ ในการสร้างตัวระบุจุดใน Power BI Desktop คือ ที่แท็บคิวรี ให้ใช้ตัวเลือก "เพิ่มคอลัมน์ดัชนี" ใน ribbon "เพิ่มคอลัมน์" 
...
เมื่อคุณใช้ค่าแบบประเภท (สตริง) ใน Power BI Desktop สำหรับแกนของแผนภูมิ หรือในตัวแบ่งส่วนข้อมูลหรือตัวกรอง ค่าเริ่มต้นของการเรียงลำดับจะเรียงตามตัวอักษร ถ้าคุณต้องการแทนลำดับนี้ ตัวอย่างสำหรับสิ่งต่าง ๆ เช่นวันสัปดาห์หรือเดือน จากนั้นคุณสามารถบอก Power BI Desktop เพื่อเรียงลำดับตามคอลัมน์อื่น เมื่อต้องการเรียนรู้เพิ่มเติม ดู[เรียงลำดับตามคอลัมน์ใน Power BI Desktop](desktop-sort-by-column.md)
...
อีกวิธีในการทำให้แน่ใจว่าเขตข้อมูลได้รับการกำหนดพิกัดทางภูมิศาสตร์ไว้ถูกต้อง คือการตั้งค่าประเภทข้อมูลในเขตข้อมูลนั้น ใน Power BI Desktop เลือกตารางที่คุณต้อง ไป ribbon ขั้นสูง และจากนั้น ตั้งค่าประเภทข้อมูลที่อยู่ เมือง ทวีป ประเทศ/ภูมิภาค ประเทศ รหัสไปรษณีย์ สถานะ หรือจังหวัด ประเภทข้อมูลเหล่านี้ช่วยให้ Bing เข้ารหัสข้อมูลได้อย่างถูกต้อง เมื่อต้องการเรียนรู้เพิ่มเติม ดู[จัดประเภทข้อมูลใน Power BI Desktop](desktop-data-categorization.md)
...
กำหนดฮิสโตแกรมที่สนับสนุน brushing - Brushing ถูกเชื่อมโยงวิชวลเข้าด้วยกันเพื่อให้เมื่อผู้ใช้เลือกจุดข้อมูลในหนึ่งภาพ ภาพอื่น ๆ บนหน้ารายงานไฮไลต์ หรือกรองจุดข้อมูลที่เกี่ยวข้องกับจุดข้อมูลที่เลือก เนื่องจากเรากำลังจัดการกับข้อมูลในขณะเวลาของคิวรี เราจึงต้องสร้างความสัมพันธ์ระหว่างตารางต่างๆ และตรวจสอบให้แน่ใจว่าเราได้ทราบว่ารายการรายละเอียดรายการใดเกี่ยวข้องกับบักเก็ตในฮิสโทแกรมและในทางกลับกันก็เช่นกัน
