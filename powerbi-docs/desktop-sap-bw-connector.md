...
สำหรับข้อมูลเกี่ยวกับว่า ลูกค้า SAP จะได้ประโยชน์จากการเชื่อมต่อ Power BI กับระบบ SAP Business Warehouse (BW) ที่มีอยู่ของพวกเขาอย่างไร ดูที่[เอกสารทางเทคนิค Power BI และ SAP BW](https://aka.ms/powerbiandsapbw)

เริ่มตั้งแต่การเผยแพร่เดือนมิถุนายน 2018 ของ **Power BI Desktop** คุณสามารถใช้ตัวเชื่อมต่อ SAP BW กับการใช้งานที่มีการปรับปรุงประสิทธิภาพและความสามารถอย่างมาก เวอร์ชันของตัวเชื่อมต่อ SAP BW ที่อัปเดตนี้ พัฒนาโดย Microsoft และเรียกว่า **Implementation 2.0** คุณสามารถเลือก**ตัวเชื่อมต่อ SAP BW** มาตรฐาน หรือ**ตัวเชื่อมต่อ SAP Implementation 2.0** ได้ ส่วนต่อไปนี้จะอธิบายการติดตั้งแต่ละเวอร์ชันตามลำดับ คุณสามารถเลือกตัวเชื่อมต่อตัวใดตัวหนึ่ง เพื่อเชื่อมต่อกับ SAP BW จาก Power BI Desktop ได้

เราแนะนำให้คุณใช้**ตัวเชื่อมต่อ SAP Implementation 2.0** ถ้าเป็นไปได้

## <a name="installation-of-the-standard-sap-bw-connector"></a>การติดตั้งตัวเชื่อมต่อ SAP BW มาตรฐาน
เราแนะนำให้ใช้ตัวเชื่อมต่อ SAP Implementation 2.0 ถ้าทำได้ (ดูคำแนะนำในส่วนต่อไป) ส่วนนี้จะอธิบายเกี่ยวกับการติดตั้ง**ตัวเชื่อมต่อ SAP BW**มาตรฐาน ซึ่งคุณสามารถติดตั้งโดยทำตามขั้นตอนการติดตั้งต่อไปนี้:
...
**Implementation 2.0** ของตัวเชื่อมต่อ SAP ต้องการ SAP .NET Connector 3.0 คุณสามารถ[ดาวน์โหลด SAP .NET Connector 3.0](https://go.microsoft.com/fwlink/?linkid=872300) จากเว็บไซต์ของ SAP ด้วยลิงก์ต่อไปนี้:
...
> [!NOTE]
> การใช้งาน SAP BW มาตรฐานจำเป็นต้องมี Netweaver DLL แต่ถ้าคุณกำลังใช้ Implementation 2.0 ของตัวเชื่อมต่อ SAP และไม่ได้ใช้เวอร์ชันมาตรฐาน ไม่จำเป็นต้องมี Netweaver DLL


## <a name="standard-sap-bw-connector-features"></a>คุณลักษณะของตัวเชื่อมต่อ SAP BW มาตรฐาน
**ตัวเชื่อมต่อ SAP BW** มาตรฐานใน Power BI Desktop ให้คุณนำเข้าข้อมูลจากคิวบ์**เซิร์ฟเวอร์ SAP Business Warehouse** ของคุณ หรือใช้ DirectQuery 
...
3. เลือก**ตกลง** จากนั้น ประสบการณ์การใช้งานของ**ตัวนำทาง**จะเหมือนกับที่อธิบายไว้ในส่วนก่อนหน้านี้ สำหรับตัวเชื่อมต่อ SAP BW มาตรฐาน 
...
1. **ExecutionMode** (โหมดการดำเนินการ) - ระบุอินเทอร์เฟซ MDX ที่ใช้ในการดำเนินการคิวรีบนเซิร์ฟเวอร์ ตัวเลือกที่เป็นไปได้มีดังนี้:
    ...
    การใช้ *SapBusinessWarehouseExecutionMode.BasXmlGzip* อาจช่วยปรับปรุงประสิทธิภาพการทำงาน เมื่อพบปัญหาเวลาแฝงสูงเมื่อใช้กับชุดข้อมูลมีขนาดใหญ่
...
4. มีความพยายามทุกทางเพื่อทำให้ Implementation 2.0 เข้ากันได้กับตัวเชื่อมต่อ SAP BW มาตรฐาน แต่อาจมีความแตกต่างบางเรื่อง เนื่องจาก MDX ของ SAP BW ใช้โหมดการดำเนินการต่างกัน เพื่อแก้ไขปัญหาที่เกิดจากความแตกต่าง ลองสลับโหมดการดำเนินการดู
