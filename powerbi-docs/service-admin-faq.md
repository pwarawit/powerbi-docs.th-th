...
ใช้สคริปต์ PowerShell ต่อไปนี้เพื่อให้ผู้ใช้ใหม่เข้าร่วมผู้เช่าที่ได้รับการจัดการ ([เรียนรู้เพิ่มเติมเกี่ยวกับ PowerShell][1])
...
ใช้สคริปต์ PowerShell ต่อไปนี้เพื่อยืนยันการตั้งค่า *AllowEmailVerifiedUsers* ควรเป็นเท็จ ([เรียนรู้เพิ่มเติมเกี่ยวกับ PowerShell][1])
...
* **สถานการณ์ที่ 3**: ถ้าองค์กรของคุณไม่มีสภาพแวดล้อม Office 365 ที่เชื่อมต่อกับโดเมนอีเมลของคุณ วิธีการที่คุณใช้บริหารข้อมูลประจำตัวจะไม่มีการเปลี่ยนแปลง
...
เมื่อผู้ใช้แบบบริการตนเองลงทะเบียนเข้าใช้บริการระบบคลาวด์บน Azure AD พวกเขาจะถูกเพิ่มลงไปใน Azure AD ที่ไม่มีการจัดการแบบไดเรกทอรี ระบบจะให้ยึดตามโดเมนอีเมลของของพวกเขา คุณสามารถอ้างสิทธิ์ และจัดการผู้เช่าที่ถูกแต่งตั้งขึ้นโดยผ่านกระบวนการ*เข้าครอบครองเป็น ผู้ดูแลระบบ*ได้ รูปแบบการเข้าครอบครองของคุณจะขึ้นอยู่กับว่าคนที่เป็นผู้เช่าอยู่มีความเชื่อมโยงกับโดเมนของคุณ:
...
สำหรับรายละเอียดเพิ่มเติมสามารถเข้าไปดูได้ที่ [การครอบครองไดเรกทอรีที่ยังไม่มีการจัดการในฐานะผู้ดูแลระบบใน Azure Active Directory](/azure/active-directory/users-groups-roles/domains-admin-takeover).

เมื่อคุณทำการเข้าครอบครองจากภายนอก เนื้อหาใน Power BI ที่ถูกสร้างก่อนจะมีการเข้าครอบครองจะถูกเก็บไว้ใน [Power BI Archived Workspace](service-admin-power-bi-archived-workspace.md). คุณจะต้องดำเนินการย้ายเนื้อหาที่คุณต้องการใช้กับผู้เช่ารายใหม่ด้วยตัวคุณเอง
...
หากคุณไม่ดำเนินการ จะมีการสร้างผู้เช่าขึ้นสำหรับแต่ละโดเมนอีเมลของผู้ใช้และโดเมนย่อย ถ้าคุณต้องการให้ผู้ใช้ทั้งหมดอยู่ในผู้เช่าเดียวกันโดยไม่คำนึงถึงนามสกุลที่อยู่อีเมลของพวกเขา: สร้างผู้เช่าเป้าหมายล่วงหน้า หรือใช้ผู้เช่าที่มีอยู่แล้ว และเพิ่มโดเมนและโดเมนย่อยทั้งหมดที่มีอยู่ที่คุณต้องการให้รวมเข้าภายในผู้เช่านั้น จากนั้น ผู้ใช้ทั้งหมดที่มีที่อยู่อีเมลที่ลงท้ายด้วยโดเมนและโดเมนย่อยเหล่านั้นจะเข้าร่วมผู้เช่าเป้าหมายโดยอัตโนมัติเมื่อพวกเขาลงทะเบียน
...
สำหรับข้อมูลเกี่ยวกับความพร้อมใช้งานสูงและการเฟลโอเวอร์ ให้ดูที่ [คำถามที่พบบ่อยเกี่ยวกับความพร้อมใช้งานสูง การเฟลโอเวอร์ และการกู้คืนความเสียหายของ Power BI](service-admin-failover.md)
