...
* ผู้ใช ้**Enterprise Agreement** ควรเชื่อมต่อกับ **ตัวเชื่อมต่อ Azure Consumption Insights**

* ผู้ใช้ **Customer Agreement** ควรเชื่อมต่อกับ **ตัวเชื่อมต่อ Azure Cost Management**
...
ในส่วนนี้ คุณจะได้เรียนรู้วิธีการรับข้อมูลที่คุณต้องการ วิธีการโอนย้ายระบบโดยใช้ตัวเชื่อมต่อAzure Enterprise และคุณจะพบการแมปของ *คอลัมน์รายละเอียดการใช้งาน* พร้อมใช้งานใน **ACI** (Azure Consumption Insights) API
...
ดูวิดีโอ [วิธีการวิเคราะห์ค่าใช้จ่ายใน Power BI ด้วย Azure Consumption Insights](https://www.youtube.com/watch?v=QKBMXXrlpEk) เกี่ยวกับการตรวจทานข้อมูลค่าใช้จ่ายของคุณใน Power BI Desktop โดยใช้ตัวเชื่อมต่อ Azure Consumption Insights
