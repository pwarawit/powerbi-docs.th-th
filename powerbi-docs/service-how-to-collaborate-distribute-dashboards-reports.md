...
**การฝังใน SharePoint Online ** และตัวเลือก **แบบฝัง** ในบริการ Power BI ช่วยให้คุณสามารถฝังรายงานสำหรับผู้ใช้ภายในของคุณได้อย่างปลอดภัย ตัวเลือกการฝังใน SharePoint Online ทำงานร่วมกับส่วนของเว็บ Power BI สำหรับ SharePoint Online และมอบประสบการณ์การลงชื่อเข้าใช้ระบบเพียงครั้งเดียวพร้อมการควบคุมวิธีการฝังรายงาน ตัวเลือกแบบฝังทำงานร่วมกับพอร์ทัลหรือเว็บไซต์ใดก็ได้ที่รองรับเนื้อหาการฝังโดยใช้ URL หรือ iFrame ไม่ว่าคุณจะเลือกตัวเลือกใด พวกเขาทั้งคู่รับรองว่าจะมีการบังคับใช้สิทธิ์ทั้งหมดและความปลอดภัยของข้อมูลก่อนที่ผู้ใช้จะสามารถดูเนื้อหาได้หรือไม่ ผู้ที่ดูรายงานนั้นจำเป็นต้องมีใบอนุญาตที่เหมาะสม เพิ่มเติมเกี่ยวกับ [การฝังใน SharePoint Online ](service-embed-report-spo.md) และตัวเลือก [แบบฝัง](service-embed-secure.md) ใน Power BI
