...
description: เอกสารประกอบสำหรับการใช้แบบสอบถามภาษาธรรมชาติ Power BI q&a ที่ มีการเชื่อมต่อสดไปยังข้อมูล Analysis Services และเกตเวย์ข้อมูลภายในองค์กร
author: maggiesMSFT
manager: kfile
ms.reviewer: mihart
ms.service: powerbi
...
ms.locfileid: "65624942"
---
# <a name="enable-qa-for-live-connections-in-power-bi"></a>เปิดใช้งาน Q&A กับการเชื่อมต่อแบบสดใน Power BI
## <a name="what-is-the-on-premises-data-gateway--what-is-a-live-connection"></a>เกตเวย์ข้อมูลภายในองค์กรคืออะไร  เชื่อมแบบไลฟ์คืออะไร
ชุดข้อมูลใน Power BI สามารถนำเข้ามาใน Power BI หรือคุณสามารถสร้างการเชื่อมต่อแบบไลฟ์ไปยังพวกนั้นได้ การเชื่อมต่อชุดข้อมูลจะมักเรียกสดเป็น "องค์กร" การเชื่อมต่อแบบไลฟ์ถูกจัดการโดยใช้[เกตเวย์](service-gateway-onprem.md)และข้อมูลและคิวรี่ถูกส่งกลับไปกลับมาโดยใช้คิวรแบบไลฟ์

## <a name="qa-for-on-premises-data-gateway-datasets"></a>ถามตอบสำหรับชุดข้อมูลเกตเวย์ข้อมูลภายในองค์กร
...
* มีอะไร[เกตเวย์ข้อมูลภายในองค์กร](service-gateway-onprem.md)หรือไม่
* [Power BI ถามตอบสำหรับผู้บริโภค](consumer/end-user-q-and-a.md)
...
* โดยเริ่มต้นฟีเจอร์เฉพาะสำหรับแหล่งข้อมูล SQL Server 2016 Analysis Services แบบตาราง ฟีเจอร์ที่ปรับให้เหมาะสมเพื่อทำงานกับข้อมูลแบบตาราง ถามตอบประสบการณ์การใช้งานไม่ได้รับการสนับสนุนสำหรับข้อมูลหลายมิติ แหล่งข้อมูลเพิ่มเติมที่ได้รับการสนับสนุน โดยเกตเวย์ข้อมูลภายในองค์กรจะเผยแพร่เมื่อเวลาผ่านไป
* การสนับสนุนแบบเต็มสำหรับความปลอดภัยระดับแถวที่กำหนดไว้ใน SQL Server Analysis Services ไม่พร้อมใช้งานเบื้องต้น ในขณะที่การถามคำถามในถามตอบ การ "กรอกข้อมูลอัตโนมัติ" ของคำถามในขณะที่พิมพ์สามารถแสดงค่าสตริผู้ใช้ไม่สามารถเข้าถึง อย่างไรก็ตาม RLS ที่กำหนดไว้ในแบบจำลองจะถูกทำในรายงานและแผนภูมิภาพเพื่อให้สามารถแสดงข้อมูลเป็นตัวเลขที่ไม่มีขีดเส้นใต้ ตัวเลือกเพื่อควบคุมลักษณะการทำงานนี้จะถูกเผยแพร่ในการปรับปรุงที่จะมาถึง
* รักษาความปลอดภัยระดับวัตถุ (OLS) ไม่ได้รับการสนับสนุน ถามตอบไม่คำนึงถึงความปลอดภัยระดับวัตถุ และสามารถแสดงตารางหรือคอลัมน์ชื่อผู้ใช้ที่ไม่มีสิทธิ์เข้าถึง คุณควรเปิดใช้งาน RLS เพื่อให้แน่ใจว่า ค่าข้อมูลมีการรักษาความปลอดภัยอย่างเหมาะสม 
* เชื่อมต่อแบบสดเท่านั้นได้รับการสนับสนุนกับเกตเวย์ข้อมูลภายในองค์กร ผล นี้ไม่สามารถใช้กับเกตเวย์ส่วนบุคคล
