...
การแทนที่ใน[คำสั่งรีเฟรช (TMSL)](https://docs.microsoft.com/analysis-services/tmsl/refresh-command-tmsl) จะอนุญาตให้ผู้ใช้เลือกข้อกำหนดคิวรีของพาร์ติชันที่แตกต่างกัน หรือข้อกำหนดแหล่งข้อมูลสำหรับการดำเนินการรีเฟรช ในขณะนี้ Power BI Premium **ยังไม่รองรับการแทนที่** ข้อผิดพลาด "ไม่อนุญาตให้ทำการผูกข้อมูลนอกบรรทัด" ใน Power BI Premium โปรดดูข้อมูลเพิ่มเติมที่ 'การสนับสนุนการอ่าน/เขียน XMLA' ในเอกสารประกอบของผลิตภัณฑ์" จะถูกส่งกลับ
