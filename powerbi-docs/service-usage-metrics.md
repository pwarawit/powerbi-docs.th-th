...
> [!NOTE]
> เมตริกการใช้งานจะติดตามการใช้งานของรายงานที่ฝังอยู่ใน SharePoint Online นอกจากนี้ เมตริกการใช้งานจะติดตามการฝังของแดชบอร์ดและรายงานผ่านทั้งกระแส "ผู้ใช้ที่เป็นเจ้าของข้อมูลประจำตัว" และ "แอปฯที่เป็นเจ้าของข้อมูลประจำตัว" เมตริกการใช้งานจะไม่ติดตามการใช้งานของรายงานที่ฝังผ่าน[เผยแพร่ไปยังเว็บ](service-publish-to-web.md)
...
- คุณลักษณะเมตริกการใช้งานรวบรวมข้อมูลการใช้งานจากผู้ใช้ทั้งหมด ทั้งแบบฟรีและแบบ Pro อย่างไรก็ตาม ต้องมีใบอนุญาตสิทธิ์การใช้งาน Pro สำหรับการเรียกใช้และเข้าถึงข้อมูลเมตริกการใช้งาน
...
5. อีกทางหนึ่งคือ เลื่อนไปเหนือภาพแล้วเลือกไอคอนหมุดเพื่อเพิ่มการแสดงภาพไปยังแดชบอร์ด หรือจากแถบเมนูด้านบน เลือก**หน้า Pin Live** เพื่อเพิ่มทั้งหน้าไปยังแดชบอร์ดหนึ่ง จากแดชบอร์ดดังกล่าว คุณสามารถตรวจสอบเมตริกการใช้งานหรือแชร์ไปยังผู้อื่นไดง่ายยิ่งขึ้น
   ...
   > **หมายเหตุ**: หากคุณปักหมุดบนแผ่นจากรายงานเมตริกการใช้งานไปยังแดชบอร์ด จะไม่สามารถเพิ่มแดชบอร์ดนั้นลงในแอปฯหรือชุดเนื้อหาได้
   > 
   > 
...
[แดชบอร์ดที่ชื่นชอบ](service-dashboard-favorite.md)
