...
2. ในกล่องทางด้านบน ใส่อยู่อีเมลแบบเต็มสำหรับแต่ละบุคคล กลุ่มการแจกจ่ายหรือกลุ่มความปลอดภัย คุณไม่สามารถใช้ร่วมกับรายการการแจกแจงแบบไดนามิก 
   ...
   >[!NOTE]
   >กล่องข้อมูลป้อนเข้ารองรับผู้ใช้หรือกลุ่มสูงสุด 100 ผู้ใช้หรือกลุ่ม คุณสามารถแชร์แบบหลายครั้ง หรือแชร์กับกลุ่มผู้ใช้หากต้องการแชร์กับผู้ใช้จำนวนมากได้
   > 
   > 
...
ถ้าผู้ใช้ที่เป็นผู้เยี่ยมชมจะเปิดใช้งานโดยใช้ [อนุญาตผู้ใช้เป็นผู้เยี่ยมชมภายนอกองค์กรเพื่อแก้ไข และจัดการเนื้อหาภายในองค์กร](service-admin-portal.md#export-and-sharing-settings) เฉพาะประสบการณ์การใช้เริ่มต้นจะไม่นำไปใช้ [เรียนรู้เพิ่มเติม](service-admin-azure-ad-b2b.md)
