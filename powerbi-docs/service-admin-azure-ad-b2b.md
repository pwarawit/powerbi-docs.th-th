...
บทความนี้ให้คำแนะนำเบื้องต้นเกี่ยวกับ Azure AD B2B ใน Power BI สำหรับข้อมูล ศึกษา[กระจายเนื้อหา Power BI ให้กับผู้ใช้ที่เป็นผู้เยี่ยมชมภายนอก โดยใช้ Azure Active Directory B2B](whitepaper-azure-b2b-power-bi.md)
...
* มีการตั้งค่า Active Directory ที่สามารถจำกัดสิ่งที่ผู้ใช้ที่เป็นผู้เยี่ยมชมภายนอกสามารถทำได้ภายในองค์กรโดยรวมของคุณ ซึ่งยังนำไปใช้กับสภาพแวดล้อม Power BI ของคุณด้วย เอกสารต่อไปนี้อธิบายถึงการตั้งค่า:
    ...
    * [อนุญาตหรือบล็อกผู้ใช้ที่เป็นผู้เยี่ยมชมจากการเข้าถึงบริการของ Power BI](/azure/active-directory/conditional-access/overview)
