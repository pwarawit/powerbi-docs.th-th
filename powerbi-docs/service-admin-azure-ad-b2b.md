...
Power BI รวมเข้ากับ Azure Active Directory เพื่อธุรกิจ (Azure AD B2B) เพื่ออนุญาตให้กระจายเนื้อหา Power BI ไปยังผู้ใช้ที่เป็นผู้เยี่ยมชมจากภายนอกองค์กร ในขณะที่ยังคงรักษาการควบคุมข้อมูลภายใน นอกจากนี้ คุณสามารถอนุญาตผู้ใช้เป็นผู้เยี่ยมชมภายนอกองค์กรของคุณเพื่อแก้ไข และจัดการเนื้อหาภายในองค์กรของคุณได้
...
> [!NOTE]
> การตั้งค่า [แชร์เนื้อหากับผู้ใช้ภายนอก](service-admin-portal.md#export-and-sharing-settings) ควบคุมว่าผู้ใช้ภายนอกสามารถได้รับเชิญเข้ามาที่องค์กรของคุณผ่านทาง Power BI ได้หรือไม่ เมื่อผู้ใช้ภายนอกยอมรับคำเชิญให้แล้ว พวกเขาจะเป็นผู้ใช้ที่เป็นผู้เยี่ยมชมของ Azure AD B2B ในองค์กรของคุณ พวกเขาจะปรากฏในตัวเลือกบุคคลทั่วทั้งประสบการณ์การใช้งาน Power BI เมื่อการตั้งค่าถูกปิดใช้งาน ผู้ใช้ที่เป็นผู้เยี่ยมชมในองค์กรของคุณยังคงมีสิทธิ์เข้าถึงรายการที่พวกเขามีสิทธิ์เข้าถึงและจะยังคงอยู่ในประสบการณ์ใช้งานตัวเลือกบุคคล นอกจากนี้ ถ้าผู้ใช้ได้รับการเพิ่มเข้าผ่านวิธีการเชิญที่วางแผนไว้ พวกเขาจะปรากฏในตัวเลือกบุคคลเช่นกัน เพื่อป้องกันไม่ให้ผู้ใช้ที่เป็นผู้เยี่ยมชมเข้าถึง Power BI ได้ นโยบายการเข้าถึงแบบมีเงื่อนไขของ  Azure AD สามารถนำมาใช้ได้
...
คุณสามารถเชิญผู้ใช้ที่เป็นผู้เยี่ยมชมผ่านความสามารถใน Power BI ดังต่อไปนี้:
* การแชร์รายงานและแดชบอร์ด
* รายการการเข้าถึงแอป

หากคุณจำเป็นต้องเพิ่มผู้ใช้ภายนอกไปยังพื้นที่ทำงาน ซึ่งไม่ได้เป็นผู้เยี่ยมชมใน Azure AD ของคุณ คุณสามารถใช้วิธีการเชิญที่วางแผนไว้ตามที่แนะนำด้านล่าง 
...
* การแชร์ภายนอกองค์กรของคุณไม่ได้รับการสนับสนุนในระบบคลาวด์ของชาติ อย่างได้ก็ตาม สามารถสร้างบัญชีผู้ใช้ในองค์กรของคุณที่ผู้ใช้ภายนอกสามารถใช้เพื่อเข้าถึงเนื้อหาได้ 
