...
เมื่อคุณสร้างพื้นที่ทำงานใหม่ คุณไม่ได้กำลังสร้างกลุ่ม Office 365 พื้นฐานที่เกี่ยวข้อง การดูแลระบบพื้นที่ทำงานทั้งหมดอยู่ใน Power BI ไม่ได้อยู่ใน Office 365 คุณยังคงสามารถเพิ่มกลุ่ม Office 365 ให้กับพื้นที่ทำงาน เพื่อจัดการผู้ใช้ที่จะเข้าถึงเนื้อหาผ่านทางกลุ่ม Office 365 อย่างไรก็ตาม คุณยังสามารถใช้กลุ่มความปลอดภัย รายการการแจกจ่าย และเพิ่มบุคคลได้โดยตรงภายใน Power BI ดังนั้นจึงให้วิธีที่มีความยืดหยุ่นในการจัดการการเข้าถึงพื้นที่ทำงาน
...
ทุกคนที่คุณเพิ่มลงในพื้นที่ทำงานแอปต้องมีสิทธิ์การใช้งาน Power BI Pro ในพื้นที่ทำงาน ผู้ใช้เหล่านี้สามารถทำงานร่วมกันบนแดชบอร์ดและรายงานที่คุณวางแผนที่จะเผยแพร่ไปยังผู้ชมวงกว้างหรือแม้แต่ทั่วทั้งองค์กรของคุณ ถ้าคุณต้องการกระจายเนื้อหาไปยังผู้อื่นภายในองค์กรของคุณ คุณสามารถกำหนดสิทธิ์การใช้งาน Power BI Pro ให้กับผู้ใช้เหล่านั้น หรือวางพื้นที่ทำงานในความจุ Power BI Premium
เนื่องจากนี่เป็นเพียงฟีเจอร์ตัวอย่าง จึงมีข้อจำกัดบางอย่างที่คุณควรระวัง ดู <section link> ในภายหลังในบทความนี้ สำหรับคำอธิบายเรื่องข้อจำกัดปัจจุบัน ด้วยพื้นที่ทำงานใหม่ เรากำลังออกแบบฟีเจอร์บางอย่างใหม่ ดู <หัวข้อลิงก์ > ในภายหลังในบทความนี้สำหรับคำอธิบายเรื่องการเปลี่ยนแปลงที่คาดว่าจะเกิดขึ้นถาวรพร้อมกับตัวอย่าง
...
- พื้นที่ทำงานแบบอ่านอย่างเดียว: ถูกแทนที่ด้วยบทบาทผู้ดู ที่กำลังจะปรากฏ ซึ่งจะอนุญาตให้เข้าถึงเนื้อหาในพื้นที่ทำงานแบบอ่านอย่างเดียว
