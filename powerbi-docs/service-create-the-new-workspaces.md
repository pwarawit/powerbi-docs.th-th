...
> [!NOTE]
> เมื่อต้องการบังคับใช้การรักษาความปลอดภัยระดับแถว (RLS) สำหรับผู้ใช้ Power BI Pro ที่เรียกดูเนื้อหาในพื้นที่ทำงาน ให้ใช้[พื้นที่ทำงานดั้งเดิม](service-create-workspaces.md)ต่อ เลือกตัวเลือก**สมาชิกสามารถดูเนื้อหา Power BI ได้เท่านั้น** หรืออีกวิธีหนึ่งคือ เผยแพร่แอป Power BI ของผู้ใช้เหล่านั้น หรือใช้การแชร์หรือการแจกจ่ายเนื้อหา บทบาทตัวแสดงที่มีอยู่จะเปิดใช้งานสถานการณ์นี้ในอนาคตในพื้นที่ทำงานสำหรับการใช้งานพื้นที่ทำงานใหม่
...
2. คุณกำลังสร้างพื้นที่ทำงานที่อัปเกรดโดยอัตโนมัติ เว้นแต่ว่าคุณจะเลือกที่จะ**แปลงกลับเป็นแบบดั้งเดิม**
     ...
     ![การณ์ใช้งานพื้นที่ทำงานใหม่](media/service-create-the-new-workspaces/power-bi-new-workspace.png)
     
     ถ้าคุณเลือก**แปลงกลับเป็นแบบดั้งเดิม** คุณจะสร้างพื้นที่ทำงานโดยยึดตาม Office 365 Group. ใช้ตัวเลือกนี้ถ้าคุณต้องการตัวเลือก **สมาชิกสามารถดูเนื้อหา Power BI เท่านั้น** เพื่อบังคับใช้การรักษาความปลอดภัยระดับแถว (RLS) สำหรับสมาชิกพื้นที่ทำงาน
