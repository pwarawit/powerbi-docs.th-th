...
### <a name="aggregation-tables-are-not-addressable"></a>ตารางการรวมไม่ได้ถูกกำหนดไว้
...
![รวบบทบาทการจัดการต่าง ๆ](media/desktop-aggregations/manage-roles.jpg)

นิพจน์ RLS บนตาราง**ผลิตภัณฑ์** จะกรองเฉพาะตาราง **ยอดขาย** ไม่ใช่ตาราง **Sales Agg** ไม่แนะนำให้ใช้ คิวรีที่ส่งโดยผู้ใช้ที่เข้าถึงชุดข้อมูลโดยใช้บทบาทนี้จะไม่ได้รับประโยชน์จากการรวมผู้เยี่ยมชม เนื่องจากตารางการรวมเป็นการแสดงข้อมูลเดียวกันในตารางรายละเอียด ดังนั้นจึงไม่ปลอดภัยที่จะตอบคิวรีจากตารางการรวมเนื่องจากไม่สามารถใช้ตัวกรอง RLS ได้
