...
สมมติว่าตารางมิติข้อมูลต่อไปนี้ใช้บ่อยที่สุดสำหรับคิวรี่ที่มีมูลค่าทางธุรกิจสูง ซึ่งเป็นตารางที่สามารถกรอง **Sales Agg** โดยใช้ความสัมพันธ์ *แบบหนึ่งต่อกลุ่ม* (หรือ *แบบกลุ่มไปหนึ่ง*) ประเภทความสัมพันธ์อื่น ๆ เช่น *กลุ่มต่อกลุ่ม* หรือ *หลายแหล่ง* ไม่ได้รับการพิจารณาสำหรับการรวม
...
> หมายเหตุ: ตาราง **Sales Agg** ถูกซ่อนไว้ ตารางรวมควรซ่อนจากผู้บริโภคของชุดข้อมูล ผู้บริโภคและคิวรี่อ้างอิงถึงตารางรายละเอียดไม่ใช่ตารางรวม ซึ่งไม่จำเป็นต้องรู้ว่ามีตารางรวมอยู่
...
![ตารางรวม Sales Agg](media/desktop-aggregations/aggregations-table_02.jpg)
...
![ตารางรวม Sales Agg](media/desktop-aggregations/aggregations-table_03.jpg)
