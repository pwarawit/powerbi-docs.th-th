...
มุมมองการแก้ไขพร้อมใช้งานสำหรับผู้สร้างรายงาน หรือ[เจ้าของรายงานร่วมในฐานะสมาชิกหรือผู้ดูแลของพื้นที่ทำงานแอป](end-user-create-apps.md)
...
| [ลบรายงาน](end-user-delete.md) | ไม่ใช่  | ใช่ |
|**หน้ารายงาน** |
...
| [ลบหน้ารายงาน](end-user-delete.md) | ไม่ใช่ | ใช่ |
...
| [ลบการแสดงภาพ กล่องข้อความ หรือรูปร่าง](end-user-delete.md)| ไม่ใช่ | ใช่ |
