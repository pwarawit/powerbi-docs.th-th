...
เมื่อต้องแสดงภาพเดียวกันโดยไร้เมนูบาร์ บานหน้าต่างตัวกรอง และโครมอื่น ๆ ให้เลือกไอคอน**เต็มหน้าจอ**จากแถบเมนูด้านบน  ![](media/end-user-reading-view/power-bi-focus-icon.png)
