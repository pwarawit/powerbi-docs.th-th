...
## <a name="explore-the-navigation-pane-nav-bar"></a>สำรวจหน้าต่างนำทาง (แถบนำทาง)

![สกรีนช็อตของแถบนำทางสำหรับบริการของ Power BI](media/end-user-home/power-bi-nav-bar.png)


ใช้หน้าต่างนำทาง (แถบนำทาง) ที่ด้านซ้ายเพื่อค้นหาและสลับไปมาระหว่างแดชบอร์ด รายงาน และแอป ในบางครั้ง การใช้แถบนำทางจะเป็นวิธีที่เร็วที่สุดในการเข้าถึงเนื้อหา
แถบนำทางจะมีอยู่เสมอเมื่อคุณเปิดหน้าแรกของคุณ และจะยังคงอยู่เช่นนั้นเมื่อคุณเปิดบริการของ Power BI ในพื้นที่อื่น ๆ
  
แถบนำทางจัดระเบียบเนื้อหาของคุณไว้เป็นคอนเทนเนอร์คล้าย ๆ กับที่คุณได้เห็นในพื้นที่ทำงานหน้าแรก: รายการโปรด ล่าสุด แอป และแชร์กับฉัน การใช้เมนูลอย (flyout) จะช่วยให้คุณสามารถดูได้เฉพาะเนื้อหาล่าสุดของแต่ละคอนเทนเนอร์เหล่านี้ หรือคุณสามารถนำทางไปยังรายการเนื้อหาเพื่อดูเนื้อหาทั้งหมดของแต่ละคอนเทนเนอร์ได้
...
- หากต้องการดูเนื้อหาล่าสุดในแต่ละคอนเทนเนอร์ ให้เลือกเมนูลอย ( **>** )
    ...
    ![วิดีโอของการใช้แถบนำทางสำหรับล่าสุด (Recent)](media/end-user-home/power-bi-nav-bar.gif)

 
แถบนำทางเป็นอีกวิธีที่คุณสามารถใช้ค้นหาเนื้อหาที่คุณต้องการได้อย่างรวดเร็ว เนื้อหาจะถูกจัดเรียงไว้ในลักษณะที่คล้ายกับพื้นที่ทำงานของหน้าแรก แต่แสดงเป็นรายการแทนที่จะเป็นการ์ด 
