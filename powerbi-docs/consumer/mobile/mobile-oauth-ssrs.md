...
![เชื่อมต่อกับเซิร์ฟเวอร์](media/mobile-oauth-ssrs/powerbi-mobile-oauth.png)
...
เมื่อคุณเลือก**เชื่อมต่อ** คุณจะถูกนำไปยังหน้าการลงชื่อเข้าใช้ ADFS ของคุณ ใส่ข้อมูลประจำตัวที่ถูกต้องสำหรับโดเมนของคุณ
