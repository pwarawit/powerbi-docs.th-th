...
นอกจากนี้ ผู้ดูแลระบบไอทีสามารถ[แทนที่การตั้งค่าเริ่มต้นใหม่ได้จากระยะไกล](./mobile-app-configuration.md#interaction-settings-android) ในนามของผู้ใช้ โดยใช้เครื่องมือ MDM ของตัวเลือกที่มีไฟล์กำหนดค่าแอป ด้วยวิธีนี้ ผู้ใช้ทุกคนในองค์กรสามารถมีลักษณะการทำงานที่กำหนดค่าไว้สำหรับพวกเขาเหมือนกัน
