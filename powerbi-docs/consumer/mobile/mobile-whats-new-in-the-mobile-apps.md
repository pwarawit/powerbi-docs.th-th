...
**ทำให้เป็นแอปโปรด** คุณสามารถทำให้แดชบอร์ดเป็นรายการโปรดได้แล้ว ล่าสุด[แอปที่เพิ่ม Power BI](../end-user-apps.md) และตอนนี้คุณสามารถทำให้เป็นแอปโปรดได้เช่นกัน 
...
ด้วย Q&A คุณถามคำถามเกี่ยวกับข้อมูลของคุณ โดยใช้คำของคุณเอง และ Power BI จะให้คำตอบ Q&A นั้นใช้ได้ใน Power BI service http://powerbi.com  ในตอนนี้[พร้อมใช้งานในแอปมือถือบน iPhone หรือ iPad ของคุณ](mobile-apps-ios-qna.md)
...
**แดชบอร์ด Bing** ใน Power BI service คุณสามารถสร้างในตอนนี้[ผลลัพธ์การค้นหาแดชบอร์ด โดยใช้ Bing](../end-user-connect-to-services.md)และดูบนอุปกรณ์เคลื่อนที่ของคุณได้
