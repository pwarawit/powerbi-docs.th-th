...
*นักออกแบบ* Power BI สามารถแชร์รายงานกับคุณได้โดยตรง เนื้อหาที่แชร์ด้วยวิธีนี้ปรากฏขึ้นในคอนเทนเนอร์**แชร์กับฉัน**บนแถบการนำทาง และในส่วน**แชร์กับฉัน**ของพื้นที่ทำงานของหน้าหลักของคุณ
...
4. เพียงแค่เลือก*การ์ด*รายงานเพื่อเปิดรายงาน
   ...
   ![หน้ารายงาน](./media/end-user-report-open/power-bi-report-open.png)
...
มี[วิธีมากมายเพื่อโต้ตอบกับรายงาน](end-user-reading-view.md)  เริ่มต้นการสำรวจโดยการเลือกแต่ละแท็บไปยังด้านข้างของพื้นที่ทำงานของรายงาน
