...
![สกรีนช็อตแสดงคอลัมน์แรกที่ใช้สำหรับการเรียงลำดับ](media/end-user-change-sort/power-bi-sort-first.png)
...
ถ้าคุณ Shift + คลิกที่ครั้งที่สองในคอลัมน์เดียวกัน การดำเนินการนี้จะเป็นการเปลี่ยนทิศทางการเรียงลำดับสำหรับคอลัมน์นั้น นอกจากนี้ ถ้าคุณกด Shift + คลิกที่คอลัมน์ที่คุณได้เพิ่มไปยังลำดับการจัดเรียงก่อนหน้านี้ จะย้ายคอลัมน์นั้นไปยังด้านหลังของลำดับการจัดเรียง
