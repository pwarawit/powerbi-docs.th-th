---
title: คุณลักษณะที่มีให้ใช้งานสำหรับผู้ใช้แบบฟรี
...
ms.locfileid: "81268017"
---
# <a name="power-bi-feature-list-for-consumers-and-other-free-users"></a>รายการคุณลักษณะ Power BI สำหรับ*ผู้บริโภค*และผู้ใช้ฟรี
...
มีหลายวิธีที่นักออกแบบสามารถแชร์เนื้อหาได้ แต่บทความนี้มีไว้สำหรับ*ผู้บริโภค* Power BI และอธิบายเฉพาะวิธีที่ผู้บริโภครับและโต้ตอบกับเนื้อหา สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีอื่นในการแบ่งปันเนื้อหา โปรดดู [วิธีแบ่งปันงานของคุณใน Power BI](../service-how-to-collaborate-distribute-dashboards-reports.md)

![บานหน้าต่างนำทางของ power BI](media/end-user-features/power-bi-share.png)

[บทความก่อนหน้านี้](end-user-license.md)อธิบายสิทธิการใช้งาน Power BI ประเภทต่างๆ (ฟรีและ Pro) และการสมัครใช้งาน (Premium) และสอนวิธีการค้นหาสิทธิการใช้งานและการสมัครใช้งานที่คุณใช้ว่าเป็นชนิดใด บทความนี้แสดงรายการคุณลักษณะ Power BI ที่พร้อมใช้งานสำหรับคุณโดยพิจารณาจากสิทธิใช้งานและการสมัครใช้งานของคุณ   

<art>

## <a name="quick-review-of-terminology"></a>การทบทวนคำศัพท์อย่างรวดเร็ว
ลองทบทวนแนวคิด Power BI ก่อนที่เราจะไปที่รายการ นี่จะเป็นการทบทวนอย่างรวดเร็วและหากคุณต้องการรายละเอียดเพิ่มเติม ให้ไปที่ [สิทธิการใช้งานและการสมัครใช้งานสำหรับผู้บริโภค](end-user-license.md) หรือ [แนวคิดพื้นฐานของ Power BI](end-user-basic-concepts.md)

### <a name="workspaces-and-roles"></a>พื้นที่ทำงานและบทบาท
มีพื้นที่ทำงานสองชนิด: **พื้นที่ทำงานของฉัน**และพื้นที่ทำงานของแอป เฉพาะคุณเท่านั้นที่สามารถเข้าถึง**พื้นที่ทำงานของฉัน**ได้ การทำงานร่วมกันและการแชร์จำเป็นต้องมีผู้ออกแบบเนื้อหาเพื่อใช้พื้นที่ทำงานของแอป 

นักออกแบบ Power BI ใช้พื้นที่ทำงาน *บทบาท* เพื่อจัดการว่าใครสามารถทำอะไรได้บ้างในพื้นที่ทำงาน *ผู้บริโภค* ได้รับมอบหมายบทบาท**ผู้ชม** 

### <a name="premium-capacity-subscription"></a>การสมัครใช้งานความจุ Premium
เมื่อองค์กรมีการสมัครใช้งานความจุ Premium ผู้ดูแลระบบและผู้ใช้งานแบบ Pro สามารถกำหนดพื้นที่ทำงานเป็น *ความจุ Premium* พื้นที่ทำงานในความจุ Premium คือช่องว่างที่ผู้ใช้ Pro สามารถแชร์และทำงานร่วมกับผู้ใช้ฟรี โดยไม่ต้องมีผู้ใช้ฟรีที่มีสิทธิการใช้งาน Pro ภายในพื้นที่ทำงานเหล่านั้น ผู้ใช้ฟรีมีสิทธิ์การยกระดับ (ดูรายการด้านล่าง) 

### <a name="licenses"></a>สิทธิ์การใช้งาน 
ผู้ใช้ Power BI แต่ละรายมีสิทธิ์การใช้งานฟรีหรือสิทธิ์การใช้งาน Pro คุณลักษณะบางอย่างจะถูกสงวนไว้สำหรับผู้ใช้ที่มีใบอนุญาต Pro

- **สิทธิการใช้งานฟรี** - โดยทั่วไปมอบหมายให้กับ *ผู้บริโภค* ภายในองค์กร นอกจากนี้ยังใช้โดยทุกคนที่ลงทะเบียนสำหรับ Power BI เป็นรายบุคคลและต้องการลอง [บริการ Power BI ในโหมดแบบสแตนด์อโลน](../service-self-service-signup-for-power-bi.md)  
- **สิทธิการใช้งาน Pro** - โดยทั่วไปมอบหมายให้กับนักออกแบบ นักวิเคราะห์ และนักพัฒนาภายในองค์กร   
- **สิทธิการใช้งานฟรี + ความจุ Premium** - อนุญาตให้ผู้ใช้แบบฟรี (*ผู้บริโภค*) ดูและโต้ตอบกับเนื้อหาที่ผู้ใช้ Pro สร้างขึ้นในความจุ Premium และแชร์ด้วย ด้วยวิธีนี้ผู้ใช้ Pro สามารถทำงานร่วมกับผู้ใช้แบบฟรีภายในพื้นที่ทำงานหรือโดยใช้ **แบ่งปันกับฉัน**

สำหรับผู้ใช้ฟรี การเป็นสมาชิกขององค์กรที่มีการสมัครใช้งานความจุ Premium เป็นสิ่งที่จะช่วยคุณอย่างมากมาย ตราบใดที่เพื่อนร่วมงาน Pro ของคุณใช้พื้นที่ทำงานที่มีความจุ Premium ในการแชร์เนื้อหา ผู้ใช้แบบฟรีสามารถดูและทำงานร่วมกับเพื่อนร่วมงานแบบ Pro เหล่านั้นได้  **ด้วยวิธีนี้ผู้ใช้ฟรีกลายเป็น*ผู้บริโภค* Power BI พร้อมความสามารถในการรับและแบ่งปันเนื้อหาเพื่อทำการตัดสินใจทางธุรกิจ** 

## <a name="power-bi-feature-list-for-consumers-and-free-users"></a>รายการคุณลักษณะ Power BI สำหรับ*ผู้บริโภค*และผู้ใช้แบบฟรี
แผนภูมิต่อไปนี้จะระบุว่างานใดที่สามารถดำเนินการโดย *ผู้บริโภค* ในองค์กรที่มีการสมัครใช้งาน Premium    

คอลัมน์แรกแสดงถึงผู้ใช้ฟรีที่ทำงานกับเนื้อหาใน **พื้นที่ทำงานของฉัน** ผู้ใช้นี้ไม่สามารถทำงานร่วมกับเพื่อนร่วมงานในพื้นที่ทำงาน เพื่อนร่วมงานไม่สามารถแบ่งปันเนื้อหาโดยตรงกับผู้ใช้นี้ และผู้ใช้นี้ไม่สามารถแบ่งปันจาก **พื้นที่ทำงานของฉัน** 
...
|คุณลักษณะ   | สถานการณ์ที่ 1: ผู้ใช้ Power BI แบบฟรีที่ไม่มีสิทธิเข้าถึงเนื้อหาที่โฮสต์ในความจุ Premium    | สถานการณ์ที่ 2: ผู้ใช้ Power BI แบบฟรีที่มีสิทธิ **ผู้ชม** สำหรับเนื้อหาที่จัดเก็บไว้ในความจุ Premium บุคคลนี้เป็น*ผู้บริโภค* Power BI |
|---|---|---|
|**แอปฯ** 
...
|คัดลอกวิชวลเป็นรูปภาพหรือไม่ |![myw สีเขียว](media/end-user-features/green-mwo.png) |![จุดสีเขียว](media/end-user-license/power-bi-green-dot.png)|
...
|ส่งออกข้อมูลเบื้องต้นจากวิชวลรายงาน* | ![myw สีเขียว](media/end-user-features/green-mwo.png) |![จุดสีเขียว](media/end-user-license/power-bi-green-dot.png)  | 
