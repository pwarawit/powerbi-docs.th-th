...
![สกรีนช็อตของหน้าจอยินดีต้อนรับสำหรับบริการ Power BI](media/end-user-basic-concepts/power-bi-open.png)
...
![สกรีนช็อตของหน้าผู้ใช้งาน Power BI แสดงแอปที่เลือไว้และลูกศรชี้ไปยังส่วนชุดข้อมูลบนพื้นที่](media/end-user-basic-concepts/power-bi-dataset-list.png)
...
นอกจากนี้ ผู้ออกแบบสามารถใช้ชุดข้อมูลจากพื้นที่ทำงานอื่นๆ ในการสร้างเนื้อหา (รายงาน แดชบอร์ด) ในพื้นที่ทำงานของพวกเขา Power BI จะแสดงชุดข้อมูลเหล่านี้โดยใช้ไอคอนชุดข้อมูลอ้างอิง:

![สกรีนช็อตของฐานข้อมูลที่มีลิงก์ไอคอน](media/end-user-basic-concepts/power-bi-dataset-reference-icon.png)
...
![สกรีนช็อตของรายงานที่มีแท็บ](media/end-user-basic-concepts/power-bi-report2.png)
...
![สกรีนช็อตของแอปที่เลือกในบานหน้าต่างด้านซ้ายของ Power BI](media/end-user-basic-concepts/power-bi-app.png)
