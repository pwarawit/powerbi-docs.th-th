...
ms.locfileid: "49641769"
---
# <a name="power-bi---basic-concepts-for-power-bi-service-consumers"></a>Power BI - แนวคิดพื้นฐานสำหรับ***ลูกค้า***ที่ใช้บริการ Power BI
...
สำหรับลูกค้าของ Power BI บล็อกการสร้าง 5 กลุ่มคือ ***การแสดงภาพข้อมูล***, ***แดชบอร์ด***, ***รายงาน***, ***แอป*** และ ***ชุดข้อมูล*** สิ่งเหล่านี้บางครั้งเรียกว่า***เนื้อหา*** *Power BI* และ *เนื้อหา* อยู่ใน ***พื้นที่ทำงาน*** เวิร์กโฟลว์ทั่วไปเกี่ยวข้องกับบล็อกการสร้างทั้งหมดนี้: *ผู้ออกแบบ* Power BI (สีเหลืองในแผนภาพด้านล่าง) จะรวบรวมข้อมูลจาก *ชุดข้อมูล* นำมาสู่ Power BI เพื่อการวิเคราะห์สร้าง *รายงาน* ที่เต็มไปด้วย *การแสดงภาพข้อมูล*ที่เน้นข้อเท็จจริงและข้อมูลเชิงลึกที่น่าสนใจ ปักหมุดการแสดงภาพข้อมูลจากรายงานไปยังแดชบอร์ดและแชร์รายงานและแดชบอร์ดกับ *ผู้บริโภค* เช่นคุณ (สีดำในแผนภาพด้านล่าง) ในรูปแบบ *แอป* หรือเนื้อหาที่แชร์ประเภทอื่น ๆ 
...
* การแสดงภาพจากชุดข้อมูลหนึ่งสามารถแสดงบนหลายแดชบอร์ดได้
  ...
  ![ชุดข้อมูลที่มีความสัมพันธ์แบบ M:1](media/end-user-basic-concepts/drawing2.png)

ไปที่บล็อกการสร้างถัดไป - การแสดงภาพข้อมูล
__________________________________________________________

## <a name="visualizations"></a>การแสดงภาพ
...
นอกจากนี้ยังมีการแสดงภาพข้อมูลจากชุมชนและเรียกว่า *ภาพแบบกำหนดเอง* หากคุณได้รับรายงานด้วยภาพที่คุณไม่รู้จัก เป็นไปได้ว่าอาจเป็นภาพแบบกำหนดเอง หากคุณต้องการความช่วยเหลือในการแปลภาพแบบกำหนดเอง <!--[look up the name of the report or dashboard *designer*](end-user-owner.md)-->ค้นหาชื่อ*ผู้ออกแบบ*ของรายงานหรือแดชบอร์ด และติดต่อเขา
