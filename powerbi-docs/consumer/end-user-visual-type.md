...
วิชวลที่ไม่รวมอยู่ใน Power BI โดยอัตโนมัติจะเรียกว่า *วิชวลแบบกำหนดเอง* วิชวลแบบกำหนดเองสามารถนำเข้าสู่ Power BI จากเว็บไซต์ภายนอกได้ เช่น Microsoft AppSource หรือจากแหล่งข้อมูลภายใน เช่น ร้านค้าในองค์กรของคุณ การนำเข้าวิชวลแบบกำหนดเองต้องมีสิทธิ์การแก้ไขในรายงาน หากต้องการเรียนรู้เกี่ยวกับวิชวลเสริมเหล่านี้ ไปที่ [วิชวลใน Power BI](../developer/visuals/power-bi-custom-visuals.md)
