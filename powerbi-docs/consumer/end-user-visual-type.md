---
title: ชนิดของวิชวลใน Power BI สำหรับผู้บริโภค
description: ชนิดของภาพในบริการ Power BI
author: mihart
manager: kvivek
ms.reviewer: ''
ms.service: powerbi
...
ms.locfileid: "65711053"
---
# <a name="visual-types-in-power-bi"></a>ชนิดของวิชวลใน Power BI
คุณจะพบรูปภาพในรายงาน แดชบอร์ด แอ ป และถาม ตอบ ชนิดของวิชวลเหล่านี้บางส่วนถูกรวมกับ Power BI และบาง*วิชวลแบบกำหนดเอง* วิชวลแบบกำหนดเองถูกสร้างขึ้นนอก Power BI และในแนวทางที่อนุญาตให้ *ผู้ออกแบบรายงาน* เพิ่มลงในรายงาน Power BI แดชบอร์ด และแอปได้ 

บทความนี้คือ ภาพรวมของภาพที่ถูกรวมกับ Power BI  ต่อไปนี้คือภาพที่คุณจะพบบ่อยที่สุด 
...
## <a name="list-of-visuals-available-in-power-bi"></a>รายการของภาพที่พร้อมใช้งานใน Power BI
ภาพเหล่านี้ทั้งหมดสามารถพบได้ในแอป Power BI แดชบอร์ด รายงาน และ[ระบุในถามตอบ](end-user-q-and-a.md)ได้ เมื่อต้องการเรียนรู้วิธีการโต้ตอบกับวิชวล ดู[โต้ตอบกับวิชวลในรายงาน แดชบอร์ด และแอป](end-user-visualizations.md)
...
- เมื่อต้องแสดงความสัมพันธ์ระหว่างสองหน่วยวัดในหนึ่งภาพ
...
การรวมกันระหว่างแผนที่ ArcGIS และ Power BI ทำให้การนำเสนอจุดต่าง ๆ บนแผนที่ก้าวขึ้นไปอีกระดับ ตัวเลือกพร้อมใช้งานสำหรับแผนที่พื้นฐาน ชนิดตำแหน่งที่ตั้ง ธีม สไตล์ของสัญลักษณ์ และเลเยอร์อ้างอิงสร้างวิชวลแผนที่มีข้อมูลครบครัน gorgeous การรวมกันของเลเยอร์ข้อมูลที่เป็นทาง (เช่นข้อมูล census) บนแผนที่โดยใช้การวิเคราะห์เชิงพื้นที่บ่งบอกเพิ้อทำความเข้าใจข้อมูลในวิชวลของคุณ
...
จากคำนิยาม ข้อมูลความหนาแน่นสูงถูกสุ่มตัวอย่างเพื่อสร้างภาพได้อย่างรวดเร็วที่ตอบสนองต่อการโต้ตอบ การสุ่มตัวอย่างความหนาแน่นสูงใช้อัลกอริทึมที่กำจัดจุดที่ทับซ้อนกันและทำให้มั่นใจได้ว่าจุดทั้งหมดในชุดข้อมูลจะถูกแสดงในภาพ ไม่เพียงแค่ลงจุดตัวอย่างของข้อมูลเท่านั้น  
...
## <a name="qna"></a>บอกถามตอบภาพใดไปใช้
เมื่อพิมพ์คิวรีภาษาธรรมชาติ ด้วย Power BI q&a คุณสามารถระบุชนิดภาพในแบบสอบถามของคุณ  ตัวอย่างเช่น:
