...
แสดงภาพที่คุณเห็นบนแดชบอร์ดเรียกว่า*ไทล์*และจะ*ปักหมุด*ไปยังแดชบอร์ดรายงาน*นัก* ในกรณีส่วนใหญ่ เลือกไทล์นำคุณไปยังหน้ารายงานที่สร้างแสดงภาพ ถ้าคุณไม่คุ้นเคยกับ Power BI คุณสามารถเรียนรู้ข้อมูลพื้นฐานได้โดยการอ่าน[แนวคิดพื้นฐานของ Power BI](end-user-basic-concepts.md)
...
แดชบอร์ดไม่เพียงความสวยงามรูปภาพ เป็นแบบโต้ตอบ และปรับปรุงไทล์เป็นการเปลี่ยนแปลงข้อมูลพื้นฐาน
