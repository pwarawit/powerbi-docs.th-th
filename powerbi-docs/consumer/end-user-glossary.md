...
**บัญชี** ใช้บัญชีที่ทำงานหรือโรงเรียนของคุณเพื่อลงชื่อเข้าใช้ Power BI ผู้ดูแลระบบจะจัดการบัญชีที่ทำงานหรือโรงเรียนใน Azure Active Directory ระดับการเข้าถึงของคุณจะถูกกำหนดโดยสิทธิ์การใช้งาน Power BI ที่เชื่อมโยงกับบัญชีนั้นและชนิดความจุที่จัดเก็บเนื้อหา ดู**สิทธิ์การใช้งาน**และ **Premium**ด้านล่าง 

**admin portal (พอร์ทัลผู้ดูแลระบบ)** ตำแหน่งที่ตั้งที่ผู้ดูแลระบบ Power BI จัดการกับผู้ใช้ คุณลักษณะ และการตั้งค่าสำหรับ Power BI ในองค์กรของพวกเขา (หมายเหตุ: Microsoft 365, Azure และ PowerApps ใช้ศูนย์การจัดการ)
