...
## <a name="what-data-sources-can-i-connect-to"></a>แหล่งข้อมูลใดบ้างที่ฉันสามารถเชื่อมต่อหรือไม่
...
* [เนื้อหาชุดสำหรับบริการ](end-user-connect-to-services.md)กับแดชบอร์ดสำเร็จ รายงาน และชุดข้อมูลสำหรับบริการเช่น Salesforce นอกจากการสร้างการเชื่อมต่อข้อมูลแล้ว Power BI ยังแสดงรายงานและแดชบอร์ดที่สร้างไว้ล่วงหน้าสำหรับแต่ละบริการเหล่านี้
...
นี่คือรายชื่อทั้งหมดของ[เบราว์เซอร์ทีรองรับ Power BI](end-user-browsers.md)
