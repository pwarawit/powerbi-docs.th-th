...
หากต้องการเปิดแดชบอร์ดหรือรายงาน ให้เลือกจุดไข่ปลา (...) ในแถบเมนูและเลือก**มุมมองที่เกี่ยวข้อง**จากรายการแบบดรอปดาวน์
...
จากแถบนำทางให้ค้นหาหัวข้อ**Workspaces**เพื้นที่ทำงานและเลือกพื้นที่ดำเนินการจากรายการ ถ้าคุณมีเนื้อหาในพื้นที่ทำงานแอปจะแสดงใน canvas ทางด้านขวา 

![พื้นที่ทำงานในแถบนำทางด้านซ้าย](./media/end-user-related/power-bi-workspace.png)
