...
ในบริการ Power BI เลือกรายงานที่จะแสดงบนพื้นที่ คุณยังสามารถเลือกรายงานจากหน้าแรก หน้าเพจ แอป หรือคอนเทนเนอร์อื่น ๆ บนแถบนำทางด้านซ้ายของคุณได้

1. เลือก**ส่งออก** > **PDFจาก**แถบเมนู

    ![เลือกส่งออกจากแถบเมนู ชี้ลูกศรไปที่ส่งออกเป็น PDF](media/end-user-pdf/power-bi-export.png)
