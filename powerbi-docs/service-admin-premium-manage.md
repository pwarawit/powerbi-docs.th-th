...
สำหรับแต่ละความจุ คุณจะสามารถใช้การวัด CPU หน่วยความจำ และคิวรีโดยตรง แต่ละ KPI มีตัวบ่งชี้ **ดี (สีเขียว)** **ร่อแร่(สีเหลือง)** และ**เร่งด่วน (สีแดง)** เราขอแนะนำให้ตรวจสอบเมตริกเหล่านี้เพื่อให้แน่ใจว่า ผู้ใช้ของคุณเห็นอประสิทธิภาพที่ดีขณะที่ใช้งานเนื้อหา Premium

**การใช้ความจุ Power BI Embedded จะได้รับการตรวจสอบภายในพอร์ทัล Azure**

![](media/service-admin-premium-manage/usage-metrics-critical.png "เมตริกการใช้กำลังการผลิต - เร่งด่วน ")

| เมตริก | คำอธิบาย |
| --- | --- |
| CPU |การใช้ CPU ของ core ของคุณ |
| หน่วยความจำ |แสดงหน่วยของ backend core ของคุณ โดยเฉพาะ นี่คือเมตริกของวิธีที่โมเดลมักจะเอามาจากหน่วยความจำ เนื่องจากต้องการใช้งานหน่วยความจำจากการใช้งานของโมเดลหลายรายการ |
| DQ/s |* เราจำกัดจำนวนรวมของ DirectQuery และคิวรี่การเชื่อมต่อแบบ live ต่อวินาที<br/>* ขีดจำกัดคือ 30/s สำหรับ P1, 60/s สำหรับ P2 และ 120/s สำหรับ P3<br/>* DirectQuery และแบบคิวรี่การเชื่อมต่อแบบ live นับเท่า ๆ กันเมื่อต้องการควบคุมปริมาณด้านบน ตัวอย่างเช่น ถ้าคุณมี DirectQueries 15 ตัวและ 15 การเชื่อมต่อแบบ live ตัว ในหนึ่งวินาที คุณเหยียบคันเร่ง<br/>* นี่ใช้กับการเชื่อมต่อภายในองค์กรและ cloud อย่างเท้าเทียมกัน |

เมื่อตัวชี้วัดเหล่านี้มีค่าเป็นร่อรแร่/เร่งด่วน ผู้ใช้ของคุณอาจเห็นการลดประสิทธิภาพของรายงานและรีเฟรชประสิทธิภาพการทำงาน โดยเฉพาะอย่างยิ่งในระหว่างเวลาที่มีการโหลดสูงสุด

เมตริกสะท้อนการใช้ประโยชนในสัปดาห์ที่ผ่านมา และถูกออกแบบมาเพื่อนับจำนวนอินสแตนซ์ เมความจุโอเวอร์โหลด ดังนั้นจึงให้ประสิทธิภาพการทำงานน้อยกว่าที่เหมาะสมสำหรับผู้ใช้ของคุณ

สิ่งที่เกิดขึ้นของแต่ละ*การใช้ประโยชน์ที่มากกว่า 80%* ควรถูกพิจารณาเป็นกรณีที่มีศักยภาพในการลดประสิทธิภาพการทำงาน กรณีที่มากเกินไปเป็นตัวบ่งชี้ดีของปัญหาประสิทธิภาพการทำงานที่สำคัญสำหรับผู้ใช้
...
## <a name="power-bi-report-server-product-key"></a>คีย์ผลิตภัณฑ์เซิร์ฟเวอร์รายงาน Power BI Report
