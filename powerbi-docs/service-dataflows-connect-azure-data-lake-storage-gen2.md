...
* ไฟล์ข้อมูลและข้อกำหนด Dataflow สามารถใช้ประโยชน์ โดยนักพัฒนาของแผนก IT ของคุณเพื่อใช้ประโยชน์จากข้อมูล Azure และบริการประดิษฐ์ (AI) ตามที่สาธิตใน[ตัวอย่าง GitHub จากบริการข้อมูล Azure](https://aka.ms/cdmadstutorial)
* ช่วยให้นักพัฒนาในองค์กรของคุณเพื่อรวมข้อมูล dataflow ลงในแอปพลิเคชันภายใน และโซลูชันสายงานธุรกิจ การใช้ทรัพยากรของนักพัฒนาสำหรับ dataflows และ Azure
...
* **บัญชีเก็บข้อมูล Azure เปิดใช้งานคุณลักษณะ Gen2 เก็บ Lake ข้อมูล** 

> [!TIP]
> ถ้าคุณยังไม่มีการสมัครใช้งาน Azure สร้าง[บัญชีฟรี](https://azure.microsoft.com/free/)ก่อนที่คุณจะเริ่ม

> [!WARNING]
> เมื่อมีการกำหนดค่าตำแหน่งที่เก็บกระแสข้อมูล จะไม่สามารถเปลี่ยนแปลงได้อีก ดู[ข้อควรพิจารณาและข้อจำกัด](#considerations-and-limitations)ส่วนใกล้ส่วนท้ายของบทความนี้สำหรับองค์ประกอบที่สำคัญอื่น ๆ ให้พิจารณา
...
> [!NOTE]
> อนุญาตให้อย่างน้อย 30 นาทีก่อนที่สิทธิ์สำหรับการเผยแพร่ไปยัง Power BI จากพอร์ทัล ทุกครั้งคุณเปลี่ยนแปลงสิทธิ์ในพอร์ทัล อนุญาต 30 นาทีก่อนที่สิทธิ์เหล่านั้นเพื่อให้มีผลใน Power BI 
...
5. เลือก และคัดลอก Id ของวัตถุสำหรับบริการ Power BI และ Power Query แบบออนไลน์ทั้งจากผลลัพธ์การค้นหาของคุณ เตรียมพร้อมที่จะวางค่าตัวเลขเหล่านั้นในขั้นตอนต่อไป
...
เมื่อคุณได้ตั้งค่าบัญชี Gen2 เก็บ Lake ข้อมูล Azure ของคุณในพอร์ทัล Azure คุณเชื่อมต่อกับ Power BI ในการ**พอร์ทัลผู้ดูแลระบบ Power BI** คุณยังจัดการที่เก็บข้อมูล dataflow Power BI ในการ**เก็บ Dataflow**ส่วนการตั้งค่าของพอร์ทัลผู้ดูแลระบบ Power BI สำหรับคำแนะนำอย่างละเอียดในการเปิดใช้งานเบื้องต้น ให้ดูที่[วิธีการเข้าถึงพอร์ทัลผู้ดูแล](service-admin-portal.md)

คุณสามารถเชื่อมต่อบัญชี **Azure Data Lake Storage Gen2** ของคุณตามขั้นตอนดังต่อไปนี้:

1. นำทางไป**ตั้งค่า Dataflow**แท็บ**พอร์ทัลผู้ดูแลระบบ Power BI**

    ![พอร์ทัลผู้ดูแลระบบของ power BI](media/service-dataflows-connect-azure-data-lake-storage-gen2/dataflows-connect-08b.png) 

2. เลือกคำ**เชื่อมต่อ Gen2 ของคุณจัดเก็บ Azure ข้อมูล Lake**ปุ่ม หน้าต่างต่อไปนี้จะปรากฏขึ้น
...
เมื่อต้องให้สิทธิ์ที่มอบหมายเก็บ ไป**ตั้งค่า Dataflow**แท็บในการ**พอร์ทัลผู้ดูแลระบบ Power BI** จะมีปุ่มตัวเลือกว่า*อนุญาตให้ผู้ดูแลพื้นที่ทำงานเป็นผู้กำหนดพื้นที่ทำงานให้กับบัญชีที่เก็บข้อมูลนี้*ซึ่งต้องตั้งค่าเป็น**อนุญาต** เมื่อคุณเปิดใช้งานแถบเลื่อน ให้กดปุ่ม**นำไปใช้**เพื่อให้เปลี่ยนแปลงมีผลบังคับใช้ 
...
3. Ben ได้รับข้อผิดพลาดที่คล้ายกันเนื่องจากพวกเขาถูกไม่ได้รับอนุญาตให้โฟลเดอร์ CDM ของ dataflow ใน lake
