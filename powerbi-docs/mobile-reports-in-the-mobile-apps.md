...
## <a name="use-slicers-to-filter-a-report-page"></a>ใช้ตัวแบ่งส่วนข้อมูลเพื่อกรองข้อมูลในหน้ารายงาน
...
## <a name="cross-filter-and-highlight-a-power-bi-report-page"></a>กรองแบบไขว้และเน้นหน้ารายงาน Power BI
...
## <a name="drill-down-and-up-in-a-visual-on-an-ipad-or-a-tablet"></a>เจาะดูข้อมูลลึกลงและขึ้นในการแสดงผลด้วยภาพบน iPad หรือแท็บเล็ต
ถ้าผู้สร้างรายงานได้เพิ่มความสามารถนี้ในการแสดงผลด้วยภาพบน iPad หรือแท็บเล็ต คุณสามารถเจาะดูข้อมูลลึกลงในการแสดงผลด้วยภาพเพื่อดูค่าที่รวมกันส่วนหนึ่งของงาน คุณ [เพิ่มการเจาะดูข้อมูลลึกลงในการแสดงผลด้วยภาพ](power-bi-visualization-drill-down.md) ใน Power BI Desktop หรือบริการ Power BI 
