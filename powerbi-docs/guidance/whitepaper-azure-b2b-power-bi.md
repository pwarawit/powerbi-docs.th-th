...
> [!NOTE]
> เมื่อต้องแก้ไข และจัดการเนื้อหาภายใน Power BI ขององค์กรของคุณ ผู้ใช้ต้องมีสิทธิ์การใช้งาน Power BI Pro ในพื้นที่ทำงานอื่นที่ไม่ใช่พื้นที่ทำงานของฉัน ผู้ใช้สามารถรับใบอนุญาต Pro ที่ครอบคลุมอยู่ในส่วน_สิทธิ์_การใช้งานของเอกสารนี้
...
| **ประเภทผู้ใช้ใน Azure AD** | **อนุญาตให้ผู้ใช้ที่เป็นผู้เยี่ยมชมภายนอกแก้ไขและจัดการการตั้งค่าเนื้อหา** | **ลักษณะการทำงาน** |
| --- | --- | --- |
...
- พื้นที่ทำงานคลาสสิกที่เชื่อมโยงกับกลุ่ม Office ๓๖๕: ผู้ใช้ที่เป็นผู้เยี่ยมชมไม่สามารถสร้างหรือเป็นผู้ดูแลระบบของพื้นที่ทำงานกลุ่มเหล่านี้ได้ พวกเขาสามารถเป็นสมาชิก
