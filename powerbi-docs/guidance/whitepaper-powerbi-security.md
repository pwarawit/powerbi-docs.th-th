...
|  |Import  |DirectQuery  |เชื่อมต่อแบบสด  |
|---------|---------|---------|---------|
|Schema     |     X    |    X     |         |
|แถวข้อมูล     |    X     |         |         |
...
* ไม่ ความรับผิดชอบของลูกค้าเพื่อตรวจสอบและกำหนดว่าควรจะควรใช้รหัสภาพที่กำหนดเองหรือไม่ โค้ดภาพแบบกำหนดเองทั้งหมดที่ให้บริการในสภาพแวดล้อมแบบ sandbox เพื่อให้รหัสผิดพลาดใด ๆ ในวิชวลแบบกำหนดเองไม่ส่งผลกระทบต่อส่วนเหลือของบริการ Power BI

**มีวิชวล Power BI อื่นๆที่ส่งข้อมูลภายนอกเครือข่ายของลูกค้า**

* ได้ Bing Maps และภาพ ESRI ส่งข้อมูลออกจากบริการ Power BI สำหรับวิชวลที่ใช้บริการเหล่านั้น
...
* ไม่ ผู้เผยแพร่แอปต้องรับผิดชอบต่อเนื้อหาในขณะที่รับผิดชอบของลูกค้าเพื่อตรวจสอบ และกำหนดว่าจะเชื่อถือผู้เผยแพร่แอปเทมเพลตได้หรือไม่ 

**มีแอปเทมเพลตอื่นๆ ที่ส่งข้อมูลภายนอกเครือข่ายของลูกค้าหรือไม่**
* ได้ ถือเป็นความรับผิดชอบของลูกค้าในตรวจสอบนโยบายความเป็นส่วนตัวของผู้เผยแพร่ และกำหนดว่าจะติดตั้งแอปเทมเพลตบนผู้เช่าได้หรือไม่ นอกจากนี้แล้วผู้เผยแพร่ยังมีหน้าที่รับผิดชอบในการแจ้งให้ทราบถึงพฤติกรรมและความสามารถของแอป
