...
โปรดดู [การรวม Azure Machine Learning ใน Power BI (ตัวอย่าง)](../transform-model/service-machine-learning-integration.md) สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการรวม Azure Machine Learning ใน Power BI
