...
ด้วยการสตรีมชุดข้อมูล **PubNub** ไคลเอ็นต์เว็บ Power BI ใช้ PubNub SDK ในการอ่านสตรีมข้อมูล PubNub ที่มีอยู่แล้ว และไม่มีการเก็บข้อมูลโดยบริการของ Power BI เนื่องจากการเรียกใช้นี้มากจากไคลเอ็นต์เว็บโดยตรง คุณอาจต้องจัดทำรายการที่ได้รับอนุญาตให้รับส่งข้อมูลไปยัง PubNub หากคุณอนุญาตการรับส่งข้อมูลเฉพาะขาออกจากเครือข่ายของคุณ โปรดดูคำแนะนำในบทความการสนับสนุนเกี่ยวกับ [การจัดทำรายการที่ได้รับอนุญาตในการรับส่งข้อมูลขาออกสำหรับ PubNub](https://support.pubnub.com/support/solutions/articles/14000043522-can-i-whitelist-ips-for-pubnub-traffic-)
