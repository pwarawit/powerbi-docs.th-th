...
เมื่อคุณส่งออกรูปแบบภาษาของคุณจาก Power BI Desktop เนื้อหาส่วนใหญ่ในไฟล์จะถูกสร้างขึ้นโดยโปรแกรม Q&A เอนทิตี คำ (คำพ้องความหมาย) ความสัมพันธ์ และการใช้ถ้อยคำที่ถูกสร้างขึ้นเหล่านี้จะถูกกำหนดไว้กับแท็ก **State: Generated** และจะรวมอยู่ในไฟล์เพื่อวัตถุประสงค์ด้านการให้ข้อมูล แต่สามารถใช้เป็นจุดเริ่มต้นสำหรับการเปลี่ยนแปลงของคุณเองได้ 
