...
> [!NOTE]
> **จัดการเกตเวย์**จะไม่แสดงจนกว่าคุณจะเป็นผู้ดูแลระบบของเกตเวย์อย่างน้อยหนึ่งเกตเวย์ ซึ่งเกิดขึ้นเมื่อคุณกำลังเพิ่มเป็นผู้ดูแลระบบเกตเวย์ หรือคุณติดตั้ง และกำหนดค่าเกตเวย์ด้วยตัวคุณเอง
> 
> 
