...
บทความนี้มีรายการของภาษาและประเทศ/ภูมิภาคที่สนับสนุนสำหรับบริการ Power BI, Power BI Desktop และเอกสารประกอบ Power BI
...
เมนู ปุ่ม ข้อความ และองค์ประกอบอื่น ๆ ของประสบการณ์การใช้งานจะถูกแปลเป็นภาษาของคุณ ทำให้ง่ายต่อการนำทางและโต้ตอบกับ Power BI

ในขณะนี้ คุณลักษณะบางอย่างจะพร้อมใช้งานในภาษาอังกฤษเท่านั้น:

* แดชบอร์ดและรายงานที่ Power BI สร้างขึ้นสำหรับคุณเมื่อคุณเชื่อมต่อกับบริการ เช่น Microsoft Dynamics CRM, Google Analytics, Salesforce และอื่น ๆ (คุณยังคงสามารถสร้างแดชบอร์ดและรายงานของคุณเองในภาษาของคุณ)
...
คุณมีสองวิธีในการรับ Power BI Desktop: คุณสามารถดาวน์โหลดหรือติดตั้งจาก Windows Store ได้
...
### <a name="choose-a-language-when-you-download-power-bi-desktop"></a>เลือกภาษาเมื่อคุณดาวน์โหลด Power BI Desktop
...
ไม่ว่าคุณจะดาวน์โหลด Power BI Desktop หรือติดตั้งจาก Windows Store คุณสามารถเลือกตำแหน่งที่ตั้งสำหรับรายงานเฉพาะให้เป็นตำแหน่งอื่นนอกเหนือจากตำแหน่งที่ตั้งใน Power BI Desktop เวอร์ชันของคุณได้ ขั้นตอนนี้จะเปลี่ยนวิธีการแปลข้อมูลเมื่อมีการนำเข้าจากแหล่งข้อมูลของคุณ ตัวอย่างเช่น "3/4/2017" อาจจะถูกแปลเป็นวันที่ 3 เมษายน หรือเป็นวันที่ 4 มีนาคม 

1. ใน Power BI Desktop ไปที่ตัวเลือก **แฟ้ม** > **และตัวเลือก** > **การตั้งค่า**
2. ใต้**แฟ้มปัจจุบัน** เลือก**การตั้งค่าภูมิภาค**
3. ในกล่อง**ตำแหน่งที่ตั้ง** เลือกตำแหน่งที่ตั้งอื่น 
   
   ![กล่องโต้ตอบตัวเลือก Power BI Desktop](media/supported-languages-countries-regions/pbi_supptdlangs_locale.png)
4. เลือก **ตกลง**

### <a name="choose-the-language-for-the-model-in-power-bi-desktop"></a>เลือกภาษาสำหรับแบบจำลองใน Power BI Desktop
...
## <a name="languages-for-the-help-documentation"></a>ภาษาสำหรับเอกสารให้ความช่วยเหลือ
...
* คุณกำลังใช้หนึ่งในแอปอุปกรณ์เคลื่อนที่ Power BI ใช่หรือไม่? สำหรับรายละเอียด ดู [ภาษาที่สนับสนุนในแอปอุปกรณ์เคลื่อนที่ Power BI](mobile-apps-supported-languages.md)
