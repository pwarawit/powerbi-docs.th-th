...
* ขณะดาวน์โหลด Power BI Desktop เป็นตัวติดตั้งแยก คุณจะต้องเลือกภาษาเริ่มต้นขณะเรียกใช้ตัวติดตั้ง และสามารถแก้ไขได้ในภายหลัง
...
1. ติดตั้ง Power BI Desktop [จาก Windows Store](http://aka.ms/pbidesktopstore)หรือเป็น[ตัวติดตั้งแยกเดี่ยว](http://aka.ms/pbiSingleInstaller)
