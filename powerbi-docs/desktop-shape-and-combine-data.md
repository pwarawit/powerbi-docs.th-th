...
1. เลือก**ขั้นตอนที่ใช้ล่าสุด แถวที่เรียงลำดับ. 
...
1. สุดท้ายนี้ เราต้องการเปลี่ยนชื่อของตารางนั้นให้สื่อความหมาย ในบานหน้าต่างการตั้งค่าคิวรีภายใต้**คุณสมบัติ** ให้ใส่ชื่อใหม่ของตารางแล้วเลือก Enter. ตั้งชื่อตารางนี้ *RetirementStats*
...
2. ใส่ที่อยู่ของเว็บไซต์สำหรับตัวย่อของรัฐ *http://en.wikipedia.org/wiki/List_of_U.S._state_abbreviations* จากนั้นเลือก **เชื่อมต่อ**
...
1. จากบานหน้าต่างด้านซ้ายของตัวแก้ไขคิวรี ให้เลือกคิวรี*ที*คุณต้องการผสานกับคิวรีอื่น ในกรณีนี้ จะเป็น **RetirementStats** 
