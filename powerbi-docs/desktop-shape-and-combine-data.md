---
title: จัดรูปร่างและรวมข้อมูลใน Power BI Desktop
description: จัดรูปร่างและรวมข้อมูลใน Power BI Desktop
services: powerbi
documentationcenter: ''
...
---
# <a name="shape-and-combine-data-in-power-bi-desktop"></a>จัดรูปร่างและรวมข้อมูลใน Power BI Desktop
ด้วย**Power BI Desktop**คุณสามารถเชื่อมต่อกับแหล่งข้อมูลหลายชนิด จาก นั้นจัดรูปแบบข้อมูลตามความต้องการของคุณได้ *การจัดรูป*ข้อมูลหมายถึงการแปลงข้อมูล เช่นการเปลี่ยนชื่อคอลัมน์หรือตาราง การเปลี่ยนแปลงข้อความเป็นตัวเลข ลบแถว การตั้งค่าแถวแรกเป็นหัวเรื่อง และอื่น ๆ *การรวม*ข้อมูลหมายถึงการเชื่อมข้อมูลของสองแหล่งข้อมูลหรือมากกว่า และจัดรูปร่างตามความจำเป็น หลังจากนั้นจึงรวมเป็นคิวรี่ที่เพื่อใช้ประโยชน์

บทความนแสดงวิธีการจัดรูปแบบคิวรี่โดยใช้ Power BI Desktop โดยเน้นงานทั่วไปบางงาน คิวรี่ที่ใช้นั้นได้ถูกอธิบายในรายละเอียด รวมทั้งมีวิธีการสร้างคิวรี่ตั้งแต่เริ่มต้น ที่[เริ่มต้นใช้งาน Power BI Desktop](desktop-getting-started.md)
...
ข้อมูลเกี่ยวกับสถานะต่าง ๆ นั้นน่าสนใจเป็น และจะเป็นประโยชน์สำหรับการสร้างกำลังการวิเคราะห์และคิวรี่เพิ่มเติม แต่มีปัญหาหนึ่ง ข้อมูลส่วนใหญ่นั้นใชตัวอักษรย่อสองตัวสำหรับรัฐ ไม่ได้ใช่ชื่อเต็มของรัฐ เราต้องทำการเชื่อมโยงชื่อรัฐกับคำอักษรย่อของมัน

เราโชคดีที่ยังมีแหล่งข้อมูลสาธารณะอื่นเป็นเช่นนี้ แต่จำเป็นต้องมีการปรับรูปใช้สมควรก่อนที่เราสามารถเชื่อมต่อมันกับตารางข้อมูลตัดจำหน่ายของเรา นี่แหล่งข้อมูลเว็บเกี่ยวกับตัวอักษรย่อของรัฐ
...
เมื่อคุณมีหนึ่งหรือสองคอลัมน์ที่คุณต้องการเพิ่มลงในคิวรี่อื่น คุณนั้นทำการ**ผสาน**คิวรี่ เมื่อคุณมีแถวของข้อมูลเพิ่มเติมที่คุณต้องการเพิ่มลงในคิวรี่ที่มีอยู่ คุณนั้นทำการ**ผนวก**คิวรี่
...
**NewColumn**ถูกสร้างขึ้นที่ส่วนท้ายของคิวรี่ ซึ่งเป็นเนื้อหาของตาราง (คิวรี่) ที่ถูกผสานเข้ากับแคิวรี่ที่มีอยู่ คอลัมน์ทั้งหมดจากแบบคิวรี่ที่ผสานนั้นย่อลงในการ**NewColumn**แต่คุณสามารถเลือกตาราง**ขยาย** และรวมถึงคอลัมน์ใดก็ตามที่คุณต้องการ
...
>[!NOTE]
>ต้องการลองว่าจะการนำเข้าตาราง**NewColumn**ได้อย่างไรหรือไม่ คุณสามารถลองได้นิดหน่อย และถ้าคุณไม่ชอบผลลัพธ์ ก็แค่ลบขั้นตอนนั้นจาก**ขั้นตอนที่ใช้**ซึ่งเรียงเป็นรายการอยู่ทีช่อง**การตั้งค่าคิวร่ี** คิวรี่ของคุณไปเปลี่ยนสถานะเป็นสถานะก่อนที่ใช้ขั้นตอน**ขยาย**นั้น มันเหมือนการแก้ไขฟรี ซึ่งคุณสามารถทำได้หลายครั้ง ตามที่คุณต้องการจนกว่ากระบวนการขยายมีลักษณะตามคุณต้องการ

ในตอนนี้เรามีคิวรี่(ตาราง)เด่ียว ที่รวมแหล่งข้อมูลสองแหล่ง ซึ่งแต่ละแหล่งถูกปรับให้เป็นตามความต้องการของเรา คิวรี่นี้สามารถทำหน้าที่เป็นฐานสำหรับการเชื่อมต่อข้อมูลเพิ่มเติมและข้อมูลที่น่าสนใจเป็นจำนวนมาก เช่นสถิตค่าใช้จ่ายครัวเรือน ข้อมูลประชากร หรือโอกาสการทำงานในทุกๆรัฐ
...
มีหลากหลายสิ่งที่คุณสามารถทำได้ด้วย Power BI Desktop สำหรับข้อมูลเพิ่มเติมเกี่ยวกับความความสามารถของมัน กรุณาเข้าดูแหล่งที่มาต่อไปนี้
