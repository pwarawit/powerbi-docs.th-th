...
4. บนหน้า**เลือกตำแหน่งที่ตั้งแฟ้ม** เลือกโฟลเดอร์ที่คุณต้องการติดตั้งไฟล์ของ Office Online Server (ตัวอย่างเช่น *C:\Program Files\Microsoft Office Web Apps*) และเลือก**ติดตั้งเดี๋ยวนี้** ถ้าโฟลเดอร์ที่คุณระบุไม่มีอยู่จริง โปรแกรมติดตั้งจะสร้างให้คุณ
...
เฉพาะผู้ใช้ที่มีบทบาท**ผู้ดูแลระบบ**เท่านั้น ที่จะเห็นค่าของ url ของการค้นพบ Office Online Server
...
* ความสามารถในการดูเวิร์กบุ๊ก Excel ภายในเซิร์ฟเวอร์รายงาน Power BI ในขณะนี้ยังเป็นแค่ตัวอย่าง
