    ...
    - *เวอร์ชัน 1.5.7074.36177 (รุ่น 15.0.1102.371), เผยแพร่: 21 พฤษภาคม 2019*
        - แก้ไขข้อบกพร่อง
            - รายงานที่มีการแบ่งหน้า
                - แก้ไขการเสมอเปิดใช้งาน pdf-ฝังฟอนต์
                - แก้ไขการตั้งค่าคุกกี้ที่ส่งผ่านทาง https เป็น Secure
                - แก้ไขปัญหากับ pop เหตุเนื่องจากข้อผิดพลาดสคริปต์
                - แก้ไขปัญหาการแสดงด้วยแอป Mobile บนโทรศัพท์ Android
                - แก้ไขสำหรับนำทางเวลารายงานมือถือเพื่อแสดงจำนวนสัปดาห์ที่ถูกต้องโดยไม่คำนึงถึงจุดเริ่มต้นของปีงบประมาณ
                - ชนิด mime เพิ่ม 'RestrictedResourceMimeTypeForUpload' ห้ามคุณสมบัติสามารถกำหนดค่าสำหรับผู้ดูแลระบบในการระบุ
         - คุณลักษณะ
            - เพิ่มการสนับสนุนสำหรับวิชวลที่เชื่อถือได้เพื่อ PBIRS

- **Power BI Desktop (ที่ปรับให้เหมาะสำหรับเซิร์ฟเวอร์รายงาน Power BI)**
    - *เวอร์ชัน: 2.69.5467.1801 (2019 พฤษภาคม), เผยแพร่: 21 พฤษภาคม 2019*
        - แก้ไขข้อบกพร่อง
            - แก้ไขเพื่อหลีกเลี่ยง re-entry ของข้อมูลประจำตัวในระหว่างการอัปโหลด PBIX ไป PBIRS
            - แก้ไขปัญหาที่เปิดเอกสาร ด้วย#ในชื่อไฟล์
            - เพิ่มลิงก์ได้ง่ายขึ้นสำหรับการนำทางบนหน้าต่างการเลือก PBIRS ย้อนกลับ
            - แก้ไขไปยังโหมดความคมชัดสูงใน PBIRS จะแสดงปุ่มย้อนกลับ แสดงคำเตือนภาพข้อความ
            - แก้ไข UI ไปยังบานหน้าต่างส่วนที่เลือก พื้นที่มาตราส่วน
