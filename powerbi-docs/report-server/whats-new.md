...
ค้นหารายละเอียดและตัวอย่างในส่วน [ใช้ไฟล์ .pbids เพื่อรับข้อมูล](../desktop-data-sources.md#using-pbids-files-to-get-data) ของบทความ "แหล่งข้อมูลใน Power BI Desktop"
...
หากรายงานของคุณทำงานช้ากว่าที่คาด ให้ลองใช้ตัววิเคราะห์ประสิทธิภาพจาก Power BI Desktop เมื่อเริ่มดำเนินการ จะมีการจัดทำไฟล์บันทึกประวัติพร้อมข้อมูลเกี่ยวกับการดำเนินการต่าง ๆ ในรายงานของคุณ อ่านรายละเอียดเพิ่มเติมเกี่ยวกับ [ตัววิเคราะห์ประสิทธิภาพ](../desktop-performance-analyzer.md)

#### <a name="new-modeling-view"></a>มุมมองโมเดลใหม่

จากมุมมองโมเดลใหม่ใน Power BI Desktop คุณสามารถดูและทำงานกับชุดข้อมูลที่ซับซ้อนที่มีตารางเป็นจำนวนมาก ส่วนประกอบที่น่าสนใจได้แก่ เค้าโครงแผนผังต่าง ๆ และการแก้ไขคอลัมน์ หน่วยวัดและตารางได้อย่างครอบคลุม อ่านรายละเอียดเพิ่มเติมเกี่ยวกับ [มุมมองโมเดล](../desktop-modeling-view.md)
