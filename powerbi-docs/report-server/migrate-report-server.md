...
![ย้ายจากโหมดเนทิฟของ SSRS ไปยังเซิร์ฟเวอร์รายงาน Power BI](media/migrate-report-server/migrate-from-ssrs-native.png "ย้ายจากโหมดเนทิฟของ SSRS ไปยังเซิร์ฟเวอร์รายงาน Power BI")
...
![ย้ายจากโหมดรวม SharePoint ของ SSRS ไปยังเซิร์ฟเวอร์รายงาน Power BI](media/migrate-report-server/migrate-from-ssrs-sharepoint.png "ย้ายจากโหมดรวม SharePoint ของ SSRS ไปยังเซิร์ฟเวอร์รายงาน Power BI")
...
![ย้ายจากเซิร์ฟเวอร์รายงาน Power BI ไปยังเซิร์ฟเวอร์รายงาน Power BI](media/migrate-report-server/migrate-from-pbirs.png "ย้ายจากเซิร์ฟเวอร์รายงาน Power BI ไปยังเซิร์ฟเวอร์รายงาน Power BI")
