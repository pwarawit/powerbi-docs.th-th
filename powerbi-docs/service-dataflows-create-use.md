...
**กระแสข้อมูล** คือคอลเลกชันของ*เอนทิตี* (เอนทิตีนั้นคล้ายกับตาราง) ซึ่งสร้างและจัดการได้ในพื้นที่ทำงานของแอปในบริการของ Power BI คุณสามารถเพิ่มและแก้ไขเอนทิตีในกระแสข้อมูลได้ และสามารถจัดการกำหนดการรีเฟรชข้อมูลได้โดยตรงจากพื้นที่ทำงานที่ใช้สร้างกระแสข้อมูล
...
เมื่อคุณอยู่ในพื้นที่ **พื้นที่ทำงานของแอป** ซึ่งคุณสามารถสร้างกระแสข้อมูลได้ จะมีปุ่ม **+ Create** ปรากฏขึ้นที่มุมบนขวาของพื้นที่ทำงาน เลือกปุ่ม **+ Create** จากนั้นเลือก**กระแสข้อมูล** จากรายการดรอปดาวน์ 

สิ่งสำคัญคือต้องทราบว่ามีเพียงเจ้าของกระแสข้อมูลเพียง*ผู้เดียว* ซึ่งก็คือผู้สร้างกระแสข้อมูลนั้น เจ้าของเท่านั้นที่สามารถแก้ไขกระแสข้อมูลได้ สมาชิกทั้งหมดของ **พื้นที่ทำงานของแอป** ที่อ่านหรือเขียนสิทธิ์อนุญาตใช้พื้นที่ทำงานที่มีการสร้างกระแสข้อมูล จะสามารถเชื่อมต่อกับกระแสข้อมูลได้จากภายใน **Power BI Desktop** ตามที่จะอธิบายไว้ต่อไปในบทความนี้
...
กระแสข้อมูล Power BI จะใช้ข้อมูลขั้นตอนการรีเฟรชข้อมูล Power BI เพื่อปรับปรุงให้ข้อมูลของคุณทันปัจจุบัน ใน**บริการของ Power BI** ในส่วน**พื้นที่ทำงานของแอป** จะมีคอลเลกชันพื้นที่ซึ่งสามารถทำรายการข้อมูลและกระแสข้อมูลของคุณได้ ดังที่แสดงในภาพต่อไปนี้
...
จากจุดนั้น ให้คุณไปยัง **พื้นที่ทำงานของแอป** ที่ซึ่งคุณได้บันทึกกระแสข้อมูลไว้ เลือกกระแสข้อมูลนั้นแล้วเลือกเอนทิตีที่คุณสร้างไว้จากในรายการ
