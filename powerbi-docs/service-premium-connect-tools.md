...
Power BI Desktop สามารถเชื่อมต่อกับชุดข้อมูล Power BI Premium ได้ราวกับว่าเป็นฐานข้อมูลแบบจำลองที่ปรับใช้กับ Azure Analysis Services หรือ SQL Server Analysis Services ในกรณีนี้ Power BI Desktop ใช้ตำแหน่งข้อมูล XMLA อย่างไรก็ตาม ขอแนะนำให้ผู้ใช้ Power BI Desktop ใช้คุณลักษณะการเชื่อมต่อแบบสดที่สร้างขึ้นโดยเฉพาะสำหรับชุดข้อมูล Power BI การใช้การเชื่อมต่อแบบสด มอบประสบการณ์การค้นพบที่ได้รับการปรับปรุง ที่จะแสดงระดับของชุดข้อมูล และผู้ใช้ไม่จำเป็นต้องติดตาม URL พื้นที่ทำงาน พวกเขาสามารถพิมพ์ชื่อของชุดข้อมูลได้อย่างง่ายดาย หากต้องการเรียนรู้เพิ่มเติม โปรดดู [เชื่อมต่อชุดข้อมูลในบริการ Power BI จาก Power BI Desktop](desktop-report-lifecycle-datasets.md)
