...
* ผู้ใช้สามารถเชื่อมต่อกับชุดข้อมูลผ่านการวิเคราะห์ใน Excel หากผู้ใช้ได้อ่านสิทธิ์บนชุดข้อมูลที่แฝงอยู่  ผู้ใช้อาจมีหลายวิธี เช่น การเป็นสมาชิกของพื้นที่ทำงานที่ประกอบด้วยชุดข้อมูล มีรายงานหรือแดชบอร์ดแชร์กับพวกเขาที่ใช้ชุดข้อมูล หรือมีสิทธิ์ไปยังแอปที่ประกอบด้วยชุดข้อมูล
