...
* **ตัวกรองข้อความขั้นสูง ("ประกอบด้วย" และคล้ายกัน):** เมื่อกรองข้อมูลในคอลัมน์ข้อความ การกรองขั้นสูงจะอนุญาตตัวกรองเช่น "ประกอบด้วย" และ "เริ่มต้นด้วย" และอื่น ๆ ตัวกรองเหล่านี้อาจทำให้ประสิทธิภาพการทำงานลดลงสำหรับแหล่งข้อมูลบางแหล่ง และไม่ควรใช้ตัวกรอง 'ประกอบด้วย' ตามค่าเริ่มต้นหากสิ่งที่ต้องการจริง ๆ คือการจับคู่แบบตรงทั้งหมด ('ใช่' หรือ 'ไม่ใช่') แม้ว่าผลลัพธ์อาจจะเหมือนกัน โดยขึ้นอยู่กับข้อมูลจริง ประสิทธิภาพการทำงานอาจแตกต่างกันอย่างมากเนื่องจากการใช้ดัชนี
...
จำนวนสูงสุดเริ่มต้นของการเชื่อมต่อพร้อมกัน DirectQuery เปิดอยู่แล้ว คุณสามารถเปลี่ยนข้อมูลนี้สำหรับไฟล์ปัจจุบันใน**Power BI Desktop**ไปยัง**ไฟล์ > ตัวเลือกและการตั้งค่า > ตัวเลือก**จากนั้นในการ**ไฟล์ปัจจุบัน**ส่วนในบานหน้าต่างด้านซ้าย เลือก**DirectQuery** 
