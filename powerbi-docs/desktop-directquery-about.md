...
* **วันที่/เวลารองรับเฉพาะความแม่นยำในระดับวินาทีเท่านั้น:** ขณะใช้คอลัมน์เวลาในชุดข้อมูลองคุณ Power BI จะออกรายการสืบค้นไปยังต้นทางที่เกี่ยวข้องในระดับรายละอียดระดับวินาที ส่วนการสืบค้นจะไม่ถูกส่งไปยังต้นทาง DirectQuery สำหรับมิลลิวินาที ดังนั้นคุณจะต้องลบส่วนนี้ของเวลาออกจากคอลัมน์ต้นทางของคุณ
...
* **ตัวกรองความสัมพันธ์:** การใช้ตัวกรองสองทิศทางจะอธิบาย[ไว้ในเอกสารทางเทคนิคโดยละเอียดนี้](https://download.microsoft.com/download/2/7/8/2782DF95-3E0D-40CD-BFC8-749A2882E109/Bidirectional%20cross-filtering%20in%20Analysis%20Services%202016%20and%20Power%20BI.docx)(กระดาษจะแสดงตัวอย่างในบริบทของ SQL Server Analysis Services แต่จะมีการใช้จุดพื้นฐานเช่นเดียวกับ Power BI)
