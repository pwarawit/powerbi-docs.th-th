...
ในชุดข้อมูลที่โหลดในปัจจุบันต้องมีรูปแบบข้อมูล เพื่อให้ใช้**การวัดผลด่วน**ได้ ด้วยเหตุนี้ การเชื่อมต่อสด (เช่นการเชื่อมต่อไปยังชุดข้อมูลในบริการของ Power BI) จะแสดงไม่ในรายการเมนู**การวัดผลด่วน** เมื่อคลิกขวาที่รายการ**เขตข้อมูล** ยกเว้นการเชื่อมต่อสดของ SSAS 
...
* **การวัดผลด่วน**มีให้เฉพาะเมื่อคุณสามารถปรับเปลี่ยนรูปแบบเท่านั้น ซึ่งไม่ใช่อย่างนั้นเมื่อคุณกำลังทำงานกับ DirectQuery หรือการเชื่อมต่อสดส่วนใหญ่ (ยกเว้นการเชื่อมต่อสดกับ SSAS ที่ได้รับการสนับสนุน ตามที่ได้อธิบายไปก่อนหน้านี้)
...
เริ่มตั้งแต่การปรับปรุง ตุลาคม 2017 ของ **Power BI Desktop** คุณสามารถใช้ตารางวันที่แบบกำหนดเองของคุณ กับ**การวัดผลด่วน**ตัวแสดงเวลาได้ ถ้ารูปแบบข้อมูลของคุณมีตารางวันที่แบบกำหนดเอง คุณสามารถใช้คอลัมน์วันที่หลักในตาราง สำหรับการวัดผลด่วนประเภทตัวแสดงเวลา คุณ*ต้อง*แน่ใจว่า เมื่อรูปแบบถูกสร้างขึ้น คอลัมน์วันที่หลักในตาราง ต้องถูกทำเครื่องหมายว่าเป็นตารางวันที่ ตามที่อธิบายไว้ใน[บทความนี้](https://docs.microsoft.com/sql/analysis-services/tabular-models/specify-mark-as-date-table-for-use-with-time-intelligence-ssas-tabular)
