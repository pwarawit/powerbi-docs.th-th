...
> [!NOTE]
> ตอนนี้ผู้ดูแลระบบเกตเวย์สามารถสร้างแหล่งข้อมูลหลายแหล่งที่เชื่อมต่อกับแหล่งเดียวด้วยข้อมูลประจำตัวที่แตกต่างกัน และเพิ่มผู้ใช้ไปยังแหล่งข้อมูลเหล่านี้แต่ละแหล่งตามระดับการเข้าถึงของพวกเขา
...
1. ถ้าแหล่งข้อมูลนี้ไม่พร้อมใช้งานในขณะนี้ หรือทำงานช้า ให้เลือก**ข้ามการเชื่อมต่อการทดสอบ** มิฉะนั้น การสร้างแหล่งข้อมูลอาจล้มเหลวได้
    ...
    > [!NOTE]
    > การข้ามการทดสอบการเชื่อมต่อไม่ได้รับการสนับสนุนสำหรับ Analysis Services
...
บนแท็บ**ผู้ใช้**สำหรับแหล่งข้อมูล คุณสามารถเอาผู้ใช้และกลุ่มความปลอดภัยที่เปิดใช้งานอีเมลที่ใช้แหล่งข้อมูลนี้ออกได้
...
บนแท็บ**ผู้ดูแลระบบ**สำหรับเกตเวย์ เพิ่มและลบผู้ใช้ (หรือกลุ่มความปลอดภัยที่เปิดใช้งานอีเมล) ที่สามารถดูแลระบบเกตเวย์ได้
