...
สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการเปิดใช้งานความจุของที่เก็บปริมาณกระแสข้อมูลแบบพรีเมียม ให้ไปดูที่บทความ[การกำหนดค่าปริมาณงาน](service-admin-premium-manage.md#configure-workloads)สำหรับ Power BI พรีเมียม
