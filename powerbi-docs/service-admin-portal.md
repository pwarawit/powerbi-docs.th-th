...
ผู้ใช้ในองค์กรสามารถเผยแพร่รายงานไปยังเว็บได้ [เรียนรู้เพิ่มเติม](service-publish-to-web.md) การดำเนินการนี้จะทำให้รายงานและข้อมูลที่มีอยู่นั้นพร้อมใช้งานสำหรับทุกคนบนเว็บ

> [!NOTE]
> ผู้ดูแลระบบ Power BI ต้องอนุญาตให้สร้างการเผยแพร่ใหม่ไปยังโค้ดฝังตัวของเว็บ องค์กรอาจมีโค้ดฝังตัวอยู่แล้ว ให้ใช้หน้า [โค้ดฝังตัว](service-admin-portal.md#embed-codes) ในการตรวจสอบรายงานที่เพิ่งมีการเผยแพร่ไป

รูปต่อไปนี้แสดงให้เห็น **ไฟล์** เมนูสำหรับการรายงานเมื่อเปิดการตั้งค่า **เผยแพร่ไปยังเว็บ**

![เผยแพร่ไปยังเว็บในเมนูไฟล์](media/service-admin-portal/powerbi-admin-publish-to-web.png)
...
ผู้ใช้จะได้รับการขอให้ติดต่อผู้ดูแลระบบ Power BI เพื่ออนุญาตให้พวกเขาสร้างโค้ดฝังตัวเมื่อตัวเลือก **เลือกวิธีการทำงานของโค้ดฝังตัว** ได้รับการกำหนดเป็น **อนุญาตเฉพาะโค้ดฝังตัวที่มีอยู่เท่านั้น** และการตั้งค่า **การเผยแพร่ไปยังเว็บ** ได้รับการ **เปิดใช้งาน**
...
ผู้ใช้ในองค์กรสามารถส่งออกข้อมูลจากไทล์หรือการแสดงวิชวล [ศึกษาเพิ่มเติม](visuals/power-bi-visualization-export-data.md)
...
ผู้ใช้ในองค์กรสามารถโต้ตอบ และแชร์วิชวลแบบกำหนดเองได้ [ศึกษาเพิ่มเติม](developer/power-bi-custom-visuals.md)
...
ผู้ใช้ในองค์กรสามารถฝังแดชบอร์ดและรายงาน Power BI ในแอปพลิเคชัน Software as a Service (SaaS) ได้ ปิดใช้งานการตั้งค่านี้ป้องกันไม่ให้ผู้ใช้ใช้ REST Api ฝังเนื้อหา Power BI ภายในแอปพลิเคชันของพวกเขา [ศึกษาเพิ่มเติม](developer/embedding.md)
...
แท็บ **วิชวลองค์กร** ช่วยให้คุณสามารถปรับใช้ และจัดการวิชวลแบบกำหนดเองภายในองค์กรของคุณ ด้วยวิชวลด้านองค์กร คุณสามารถปรับใช้วิชวลที่เป็นกรรมสิทธิ์ในองค์กรของคุณ ซึ่งผู้เขียนรายงานสามารถค้นพบ และนำเข้าลงในรายงานของพวกเขาจาก Power BI Desktop [ศึกษาเพิ่มเติม](developer/power-bi-custom-visuals-organization.md)
...
สำหรับข้อมูลเพิ่มเติม โปรดเยี่ยมชม[คำถามที่ถามบ่อยเกี่ยวกับวิชวลแบบกำหนดเองขององค์กร](/power-bi/developer/power-bi-custom-visuals-faq#organizational-power-bi-visuals)
