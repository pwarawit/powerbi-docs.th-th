...
มีแท็บเก้าในพอร์ทัล รายละเอียดที่เหลือของบทความนี้เป็นข้อมูลเกี่ยวกับแต่ละแท็บ
...
* [เก็บข้อมูล Dataflow (ตัวอย่าง)](#dataflowStorage)
...
## <a name="help-and-support-settings"></a>วิธีใช้ และสนับสนุนการตั้งค่า

### <a name="publish-get-help-information"></a>เผยแพร่ข้อมูล "รับความช่วยเหลือ"

ผู้ใช้ในองค์กรสามารถไปที่วิธีใช้ภายใน และสนับสนุนแหล่งข้อมูลจากเมนูวิธีใช้ Power BI โดยเฉพาะ พารามิเตอร์เหล่านี้เปลี่ยนลักษณะการทำงานของการเรียนรู้ ชุมชน และรับวิธีใช้รายการเมนู

คุณจะสามารถระบุ URL เพื่อนำผู้ใช้โซลูชันแบบกำหนดเองสำหรับคำขอสิทธิ์การใช้งาน พารามิเตอร์นี้กำหนด URL เป้าหมายของปุ่มอัปเกรดบัญชีที่ผู้ใช้ไม่ มีสิทธิ์การใช้งาน Power BI Pro สามารถค้นหา ในการปรับปรุงไปยังกล่องโต้ตอบ Power BI Pro และ ในหน้าจัดการเก็บข้อมูลส่วนบุคคล

## <a name="workspace-settings"></a>ตั้งค่าพื้นที่ทำงาน

### <a name="create-workspaces"></a>สร้างพื้นที่ทำงาน

ผู้ดูแลระบบใช้**สร้างพื้นที่ทำงาน**ตั้งค่าเพื่อระบุผู้ใช้ในองค์กรสามารถสร้างพื้นที่ทำงานแอทำงานร่วมกันบนแดชบอร์ด รายงาน และอื่น ๆ เนื้อหา เรียนรู้เพิ่มเติมเกี่ยวกับ[พื้นที่ทำงานแอ](service-create-the-new-workspaces.md)

พอร์ทัลผู้ดูแลมีส่วนอื่นของการตั้งค่าเกี่ยวกับพื้นที่ทำงานในผู้เช่าของคุณ ในส่วนนั้น คุณสามารถเรียงลำดับ และกรองรายการของพื้นที่ทำงาน และแสดงรายละเอียดสำหรับแต่ละพื้นที่ทำงาน ดู[พื้นที่ทำงาน](#workspaces)สำหรับรายละเอียด

ในพอร์ทัลผู้ดูแล คุณยังควบคุมว่าผู้ใช้มีสิทธิ์ในการแจกจ่ายแอองค์กร ดู[เผยแพร่ชุดเนื้อหาและแอกับทั้งองค์กร](#publish-content-packs-and-apps-to-the-entire-organization)ในบทความนี้สำหรับรายละเอียด
...
ผู้ดูแลระบบใช้การตั้งค่านี้จะตัดสินใจว่า ผู้ใช้สามารถเผยแพร่ชุดเนื้อหาและแอไปยังทั้งองค์กร แทนที่ระบุเฉพาะกลุ่ม เรียนรู้เพิ่มเติมเกี่ยวกับ[เผยแพร่แอ](service-create-distribute-apps.md)
...
### <a name="create-template-apps-and-organizational-content-packs"></a>สร้างเทมเพลแอปและชุดเนื้อหาองค์กร

ผู้ใช้ในองค์กรสามารถสร้างเทมเพลแอปและชุดเนื้อหาระดับองค์กรที่ใช้ชุดข้อมูลที่สร้างขึ้นบนแหล่งข้อมูลเดียวใน Power BI Desktop เรียนรู้เพิ่มเติมเกี่ยวกับ[เทมเพลแอ](template-content-pack-authoring.md)

### <a name="push-apps-to-end-users"></a>ส่งแอปให้กับผู้ใช้ปลายทาง

ผู้สร้างรายงานสามารถแชร์แอปกับผู้ใช้ปลายทางโดยตรงโดยไม่ต้องติดตั้งจาก[AppSource](https://appsource.microsoft.com)ได้ เรียนรู้เพิ่มเติมเกี่ยวกับ[ติดตั้งแอปโดยอัตโนมัติสำหรับผู้ใช้ปลายทาง](service-create-distribute-apps.md#automatically-install-apps-for-end-users)
...
แอปบนเว็บลงทะเบียนใน Azure Active Directory (Azure AD) จะใช้ข้อกำหนดบริการหลักเพื่อเข้าถึง Api ที่ Power BI โดยไม่มีผู้ใช้ลงชื่อเข้าใช้ เมื่อต้องการอนุญาตให้แอปเพื่อใช้บริการรับรองความถูกต้องหลักของบริการหลักต้องอยู่ในกลุ่มการรักษาความปลอดภัยที่ได้รับอนุญาต [เรียนรู้เพิ่มเติม](developer/embed-service-principal.md)
...
ผู้ใช้ในองค์กรสามารถสร้างและใช้กระแสข้อมูลได้ สำหรับภาพรวมของ dataflows ดู[เตรียมข้อมูลด้วยตนเองใน Power BI](service-dataflows-overview.md) เมื่อต้องการเปิดใช้งานกระแสข้อมูลในความจุแบบ Premium ให้ดู[การกำหนดค่าปริมาณงาน](service-admin-premium-workloads.md)
...
### <a name="create-template-apps-preview"></a>สร้างแอปเทมเพลต (ตัวอย่าง)

ผู้ใช้ในองค์กรสามารถสร้างแอเทมเพลต ผู้สร้างแอปเทมเพลสามารถแล้วกระจายไปยังไคลเอ็นต์ภายนอกองค์กรของคุณโดยวิธีของ[AppSource](https://appsource.microsoft.com)หรือวิธีการแจกจ่ายอื่น ๆ ได้
...
### <a name="install-template-apps-preview"></a>ติดตั้งแอปเทมเพลต (ตัวอย่าง)

ผู้ใช้ในองค์กรสามารถดาวน์โหลด และติดตั้งแอปเทมเพลจาก[AppSource](https://appsource.microsoft.com)หรือแหล่งข้อมูลอื่นได้

> [!NOTE]
> ตั้งค่านี้กำหนดว่าผู้ใช้สามารถติดตั้งแอปเทมเพลบนบัญชีผู้ใช้ Power BI
...
แท็บ **Power BI Embedded** ช่วยให้คุณสามารถดูความจุ Power BI Embedded (A SKU) ของคุณที่ซื้อให้ลูกค้าของคุณ เนื่องจากคุณสามารถซื้อ A Sku เท่านั้นจาก Azure คุณ[จัดการความจุแบบฝังตัวใน Azure](developer/azure-pbie-create-capacity.md)จาก**พอร์ทัล Azure**
...
## <a name="dataflowStorage">เก็บข้อมูล Dataflow (ตัวอย่าง)</a>
...
ในฐานะที่เป็นผู้ดูแลระบบ คุณสามารถดูพื้นที่ทำงานที่มีอยู่ในผู้เช่าของคุณได้ คุณสามารถเรียงลำดับและกรองรายการของพื้นที่ทำงานและแสดงรายละเอียดสำหรับแต่ละพื้นที่ทำงานได้ คอลัมน์ตารางสอดคล้องกับคุณสมบัติส่งกลับโดยตัว[ผู้ดูแลระบบ Power BI Rest API](/rest/api/power-bi/admin)สำหรับพื้นที่ทำงาน พื้นที่ทำงานส่วนบุคคลเป็นชนิด**PersonalGroup**พื้นที่ทำงานแบบคลาสสิกไม่ชนิด**กลุ่ม**และพื้นที่ทำงานประสบการณ์การใช้งานพื้นที่ทำงานใหม่มีชนิด**พื้นที่ทำงาน** สำหรับข้อมูลเพิ่มเติม ดู[สร้างพื้นที่ทำงานใหม่ใน Power BI](service-create-the-new-workspaces.md)
