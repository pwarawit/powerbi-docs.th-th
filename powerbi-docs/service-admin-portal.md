...
คุณยังสามารถระบุ URL ที่จะนำทางผู้ใช้ไปยังโซลูชันแบบกำหนดเองสำหรับคำขอสิทธิ์การใช้งาน พารามิเตอร์นี้กำหนด URL เป้าหมายของปุ่มอัปเกรดบัญชีที่ผู้ใช้ที่ไม่ มีสิทธิ์การใช้งาน Power BI Pro สามารถพบได้ในกล่องโต้ตอบการอัปเดตเป็น Power BI Pro เช่นเดียวกับในหน้าการจัดการสถานที่เก็บข้อมูลส่วนบุคคล

### <a name="receive-email-notifications-for-service-outages-or-incidents"></a>รับการแจ้งเตือนทางอีเมลสำหรับการหยุดทำงานหรือเหตุการณ์ของบริการ
...
ผู้ดูแลระบบใช้การตั้งค่า **การสร้างพื้นที่ทำงาน** เพื่อระบุว่าผู้ใช้คนใดในองค์กรที่สามารถสร้างพื้นที่ทำงานแอปเพื่อทำงานร่วมกันบนแดชบอร์ด รายงาน และเนื้อหาอื่นๆ เรียนรู้เพิ่มเติมเกี่ยวกับ [พื้นที่ทำงานแอปฯ](service-create-the-new-workspaces.md)
