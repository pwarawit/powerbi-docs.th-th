...
ms.locfileid: "54277376"
---
# <a name="tutorial-how-to-use-qa-to-create-visualizations-and-build-reports"></a>บทช่วยสอน: วิธีใช้การถามตอบเพื่อสร้างการแสดงข้อมูล และสร้างรายงาน
...
## <a name="part-1-use-qa-on-a-dashboard-in-power-bi-service-apppowerbicom"></a>ส่วนที่ 1: ใช้ Q&A บนแดชบอร์ดในบริการของ Power BI (app.powerbi.com)
...
[บทช่วยสอน: ใช้ Q&A ด้วยตัวอย่างการขายปลีก](power-bi-visualization-introduction-to-q-and-a.md)   
