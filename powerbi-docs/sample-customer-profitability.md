...
4. สำรวจต่อไป ถ้าคุณพบอะไรบางอย่างที่สนใจ เลือก**ปักหมุด** ![](media/sample-customer-profitability/power-bi-excel-pin.png)จากมุมขวาบนเพื่อ[ปักหมุดไปยังแดชบอร์ด](service-dashboard-pin-tile-from-excel.md)
...
3. พิมพ์**ผลรวมรายได้ตามอุตสาหกรรมสำหรับ Valery** สังเกตว่าการแสดงผลจะเปลี่ยนตามคำถามที่คุณกำลังพิมพ์
