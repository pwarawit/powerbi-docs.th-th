...
พื้นที่ทำงานเป็นคอนเทนเนอร์สำหรับแดชบอร์ด รายงาน เวิร์กบุ๊ก และชุดข้อมูลใน Power BI มีพื้นที่ทำงานสองชนิด: *พื้นที่ทำงานของฉัน*และ*พื้นที่ทำงาน* *แอปฯ*คืออะไร? *แอป* Power BI คือคอลเลกชันของแดชบอร์ดและรายงานที่สร้างขึ้นเพื่อส่งมอบเมตริกหลักแก่ผู้ใช้ปลายทาง Power BI สำหรับองค์กรของคุณ แม้แอปเป็นแบบโต้ตอบได้แต่ผู้ใช้ปลายทางจะไม่สามารถแก้ไขได้
...
-  *พื้นที่ทำงาน*จะนำมาใช้เพื่อการทำงานและการแชร์เนื้อหาร่วมกันกับเพื่อนร่วมงาน นอกจากนี้ยังเป็นสถานที่คุณสร้าง เผยแพร่ และจัดการแอปฯสำหรับองค์กรของคุณด้วย ให้คุณคิดว่านี่เป็นเหมือนพื้นที่จัดเตรียมและเป็นคอนเทนเนอร์สำหรับเนื้อหาที่จะประกอบเป็นแอปฯ Power BI คุณสามารถเพิ่มเพื่อนร่วมงานลงในพื้นที่ทำงานของคุณและทำงานร่วมกันบนแดชบอร์ด รายงาน เวิร์กบุ๊ก และชุดข้อมูล สมาชิกพื้นที่ทำงานจำเป็นต้องมีสิทธิ์การใช้งาน Power BI Pro แต่ผู้บริโภคแอปฯ (ผู้ร่วมงานที่มีสิทธิ์เข้าถึงแอปฯ) ไม่จำเป็นต้องมีสิทธิ์การใช้งาน Pro อ่านเพิ่มเติมเกี่ยวกับ[พื้นที่ทำงานใหม่](service-create-the-new-workspaces.md)  
