...
-  *พื้นที่ทำงานของฉแอปฯ*จะใช้เพื่อทำงานและแชร์เนื้อหาร่วมกันกับเพื่อนร่วมงาน นอกจากนี้ยังเป็นสถานที่คุณสร้าง เผยแพร่ และจัดการแอปฯสำหรับองค์กรของคุณด้วย ให้คุณคิดว่านี่เป็นเหมือนพื้นที่จัดเตรียมและเป็นคอนเทนเนอร์สำหรับเนื้อหาที่จะประกอบเป็นแอปฯ Power BI คุณสามารถเพิ่มเพื่อนร่วมงานลงในพื้นที่ทำงานแอปฯของคุณและทำงานร่วมกันบนแดชบอร์ด รายงาน เวิร์กบุ๊ก และชุดข้อมูล สมาชิกพื้นที่ทำงานแอทั้งหมดจำเป็นต้องใช้สิทธิ์การใช้งาน Power BI Pro ผู้บริโภคแอ ผู้ร่วมงานที่มีสิทธิ์เข้าถึงแอ ไม่จำเป็นต้องมีสิทธิ์การใช้งาน Pro อ่านเพิ่มเติมเกี่ยวกับการ[พื้นที่ทำงานใหม่](service-create-the-new-workspaces.md)  

เมื่อต้องการเรียนรู้เพิ่มเติมเกี่ยวกับการแชร์โดยทั่วไป เริ่มต้นด้วย[วิธีการแชร์แดชบอร์ดของคุณทำงาน](service-how-to-collaborate-distribute-dashboards-reports.md)
...
ชุดข้อมูลที่เพิ่ม โดยสมาชิกพื้นที่ทำงานหนึ่งพร้อมใช้งานกับสมาชิกอื่น ๆ พื้นที่ทำงานกับแอ*ผู้ดูแลระบบ*, *สมาชิก*หรือ*สนับสนุน*บทบาท
...
รายงาน Power BI คือหน้าเพจที่แสดงภาพอย่างน้อยหนึ่งหน้า เช่น แผนภูมิเส้น แผนที่ และทรีแมป นอกจากนี้ การแสดงภาพยังเรียกว่า **_วิชวล_** การแสดงภาพทั้งหมดในรายงานมาจากชุดข้อมูลเดียว คุณสามารถสร้างรายงานตั้งแต่เริ่มต้นภายใน Power BI นำเข้ากับแดชบอร์ดที่เพื่อนร่วมงานแชร์กับคุณ หรือ Power BI สามารถสร้างได้เมื่อคุณเชื่อมต่อกับชุดข้อมูลจาก Excel, Power BI Desktop ฐานข้อมูล และแอปพลิเคชัน SaaS  ตัวอย่างเช่น เมื่อคุณเชื่อมต่อกับเวิร์กบุ๊ก Excel ที่ประกอบด้วยแผ่นงาน Power View, Power BI สร้างรายงานที่ยึดตามแผ่นงานเหล่านั้น และเมื่อคุณเชื่อมต่อกับแอปพลิเคชัน SaaS, Power BI จะนำเข้ารายงานที่สร้างไว้ล่วงหน้า

มีสองโหมดสำหรับการดูและการโต้ตอบกับรายงาน: *มุมมองการอ่าน*และ*มุมมองการแก้ไข* เมื่อคุณเปิดรายงาน จะเปิดขึ้นในมุมมองการอ่าน ถ้าคุณมีสิทธิ์แก้ไข จาก นั้นคุณเห็น**แก้ไขรายงาน**ที่มุมบนซ้าย และคุณสามารถดูรายงานในมุมมองการแก้ไข  ถ้ารายงานอยู่ในพื้นที่ทำงาน ทุกคนที่มีแอ*ผู้ดูแลระบบ*, *สมาชิก*หรือ*สนับสนุน*บทบาทสามารถแก้ไขได้ พวกเขาสามารถเข้าถึงทั้งหมดสำรวจ ออกแบบ สร้าง และแชร์ความสามารถในการแก้ไขมุมมองรายงาน บุคคลที่พวกเขาแชร์รายงานด้วยสามารถสำรวจ และโต้ตอบกับรายงานในมุมมองการอ่าน   
...
เมื่อคุณเปิดแอป คุณจะเห็นแดชบอร์ด  หากต้องการเข้าถึงรายงานเบื้องต้น เลือกไทล์แดชบอร์ด (เราจะเรียนรู้เพิ่มเติมเกี่ยวกับไทล์ในภายหลัง) ที่ถูกปักหมุดจากรายงาน โปรดทราบว่า ไทล์ทั้งหมดไม่ได้ถูกปักหมุดจากรายงาน ดังนั้น คุณอาจจำเป็นต้องคลิกที่สองถึงสามไทล์เพื่อค้นหารายงาน
...
ในตัวอย่างด้านล่าง ฉันเลือกพื้นที่ทำงานแอป "ยอดขาย และการตลาด" และคลิกที่แท็บแผ่นงาน**รายงาน**
...
* สามารถเชื่อมโยงกับหลายแดชบอร์ดภายในพื้นที่ทำงานนั้น ไทล์ปักหมุดจากว่า รายงานหนึ่งสามารถปรากฏบนหลายแดชบอร์ด
* สามารถสร้างโดยใช้ข้อมูลจากชุดเดียว Power BI Desktop สามารถรวมแหล่งข้อมูลมากกว่าหนึ่งชุดข้อมูลเดียวในรายงาน และรายงานที่สามารถนำเข้าลงใน Power BI

  ![ไดอะแกรมรายงาน](media/service-basic-concepts/drawing3new.png)

### <a name="dig-deeper"></a>เจาะลึกมากขึ้น
- [สร้างรายงานในบริการ Power BI โดยการนำเข้าชุดข้อมูล](service-report-create-new.md)
- [รายงานสำหรับแอป mobile Power BI ที่ปรับให้เหมาะสม](desktop-create-phone-report.md)
...
### <a name="dig-deeper"></a>เจาะลึกมากขึ้น
* [สร้างแดชบอร์ดเปล่า และรับข้อมูลบางอย่างแล้ว](service-dashboard-create.md)
...
### <a name="5-dashboard-title-navigation-path-or-breadcrumbs"></a>5. **ชื่อแดชบอร์ด**(เส้นทางนำทาง หรือ breadcrumbs)
