...
- **อนุญาตให้ผู้ใช้สามารถส่งออกข้อมูล**: ผู้ใช้ที่มีบทบาทผู้ชมสามารถส่งออกข้อมูลได้หากพวกเขามีสิทธิ์ในการสร้างบนชุดข้อมูลในพื้นที่ทำงาน อ่านเพิ่มเติมเกี่ยวกับ[สิทธิในการสร้างสำหรับชุดข้อมูล](service-datasets-build-permissions.md)
...
ในขณะนี้การจัดการสำหรับพื้นที่ทำงานของประสบการณ์การใช้พื้นที่ทำงานใหม่อยู่ในพอร์ทัลผู้ดูแลระบบ Power BI ผู้ดูแลระบบ Power BI จะตัดสินใจว่าใครในองค์กรสามารถสร้างพื้นที่ทำงานและเผยแพร่แอปได้ ผู้ดูแลระบบสามารถดูสถานะของพื้นที่ทำงานทั้งหมดในองค์กรของพวกเขาได้ ผู้ควบคุมระบบสามารถจัดการ และกู้คืนพื้นที่ทำงาน อ่านเพิ่มเติมเกี่ยวกับ [การสร้างพื้นที่ทำงานใหม่](service-admin-portal.md#create-the-new-workspaces) ในบทความพอร์ทัลผู้ดูแลระบบ
