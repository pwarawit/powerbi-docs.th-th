...
นี่คือขีดความสามารถของสี่บทบาทได้แก่ ผู้ดูแลระบบ สมาชิก ผู้ช่วยเหลือ และผู้ชม
...
| ดูรายการ |  X | X  | X  | X  |
| สร้างรายงานในพื้นที่ทำงานอื่นโดยยึดตามชุดข้อมูลในพื้นที่ทำงานนี้ |  X | X  | X  | X <sup>1</sup>  |
| คัดลอกรายงาน | X | X | X | X <sup>1</sup> |

**1**ต้องมีสิทธิ์การใช้งาน Power BI Pro และ[สร้างสิทธิ์สำหรับชุดข้อมูล](service-datasets-build-permissions.md#build-permissions-for-shared-datasets) 
