...
> [!NOTE]
> เมื่อต้องเสริมความปลอดภัยระดับแถว (RLS) สำหรับผู้ใช้ที่เรียกดูเนื้อหาในพื้นที่ทำงาน ให้เข้าใช้ในฐานะผู้ชม ถ้าบทบาทผู้ชมยังไม่สามารถใช้งานในระบบผู้เช่าของคุณ ให้ใช้[พื้นที่ทำงานแบบคลาสสิก](service-create-workspaces.md)ไปก่อนและเลือกตัวเลือก**สมาชิกสามารถดูเนื้อหา Power BI** หรืออีกวิธีหนึ่งคือ เผยแพร่แอป Power BI ของผู้ใช้เหล่านั้น หรือใช้การแชร์หรือการแจกจ่ายเนื้อหา
...
การควบคุมดูแลระบบพื้นที่ทำงานใหม่และการใช้งานพื้นที่ทำงานใหม่อยู่ใน Power BI แล้ว ผู้ดูแลระบบ BI ที่มีอำนาจจะตัดสินใจว่าใครในองค์กรสามารถสร้างพื้นที่ทำงานได้ ผู้ควบคุมระบบสามารถจัดการ และกู้คืนพื้นที่ทำงาน การทำเช่นนี้ พวกเขาจำเป็นต้องใช้พอร์ทัลผู้ดูแลระบบ Power BI หรือ CmdLets ของ PowerShell สำหรับพื้นที่ทำงานแบบคลาสสิกตามกลุ่ม Office 365 การดูแลยังคงเกิดขึ้นในพอร์ทัลผู้ดูแลระบบ Office 365 และ Azure Active Directory
...
เมื่อต้องการให้สิทธิ์เข้าถึงพื้นที่ทำงานใหม่ เพิ่มบทบาทต่อไปนี้ให้บุคคลหรือกลุ่มผู้ใช้พื้นที่ทำงาน: ผู้ชม สมาชิก ผู้สนับสนุน หรือผู้ดูแลระบบ ทุกคนในกลุ่มผู้ใช้มีบทบาทตามที่คุณกำหนด ถ้าบุคคลอยู่ในกลุ่มผู้ใช้หลายกลุ่ม กลุ่มเหล่านั้นมีสิทธิ์ระดับสูงสุดที่กำหนดโดยบทบาทที่พวกเขาได้รับมอบหมาย
...
พื้นที่ทำงานใหม่ให้สี่บทบาท: ผู้ดูแลระบบ สมาชิก ผู้ชมและผู้สนับสนุน
...
เมื่อพื้นที่ทำงานอยู่ในความจุ Power BI Premium ผู้ใช้ที่ มีบทบาทเป็นผู้ชมสามารถเข้าถึงพื้นที่ทำงานได้แม้ว่าพวกเขาไม่มีสิทธิ์การใช้งาน Power BI Pro อย่างไรก็ตาม ถ้าคุณกำหนดให้ผู้ใช้เหล่านี้มีตำแหน่งสูงกว่าบทบาทอย่างเช่นผู้ดูแลระบบ สมาชิก หรือผู้สนับสนุน พวกเขาจะไม่สามารถเข้าถึงพื้นที่ทำงานได้ พวกเขาจะได้รับการเสนอให้เริ่มทดลองใช้ Pro เมื่อพวกเขาพยายามเข้าถึงพื้นที่ทำงาน หากต้องการช่วยให้ผู้ใช้สามารถรับบทบาทเป็นผู้ชมโดยไม่ต้องมีสิทธิ์การใช้งาน Pro ต้องมั่นใจว่าผู้ชมคนนั้นๆ ไม่ได้อยู่ในบทบาทอื่นในพื้นที่ทำงานอื่น ไม่ว่าจะเป็นกลุ่มหรือเป็นผู้ใช้งานเดี่ยว 

> [!NOTE]
> การเผยแพร่รายงานไปยังประสบการณ์การใช้งานพื้นที่ทำงานใหม่มีบังคับใช้กฎสิทธิ์การใช้งานที่มีอยู่อย่างเข้มงวด ผู้ใช้ที่พยายามเผยแพร่จาก Power BI Desktop หรือเครื่องมือไคลเอ็นต์อื่นๆ โดยไม่มีสิทธิ์การใช้งาน Pro พวกเขาจะเห็นข้อความที่แสดงความผิดพลาดโดยกล่าวว่า "เฉพาะผู้ใช้ที่ มีสิทธิ์การใช้งาน Power BI Pro เท่าที่สามารถเผยแพร่ไปยังพื้นที่ทำงานนี้"
...
ด้วยพื้นที่ทำงานใหม่ เรากำลังออกแบบฟีเจอร์บางอย่างใหม่ นี่คือการเปลี่ยนแปลงที่คุณคาดว่าจะเป็นแบบถาวร 

* สร้างพื้นที่ทำงานเหล่านี้จะไม่สร้างกลุ่ม Office 365 เหมือนอย่างที่พื้นที่ทำงานแบบคลาสสิกเคยทำ อย่างไรก็ตาม คุณสามารถใช้กลุ่ม Office 365 เพื่อให้ผู้ใช้สามารถเข้าถึงพื้นที่ทำงานของคุณด้วยการกำหนดบทบาท 
...
- ผลบังคับใช้สิทธิ์ของการใช้งาน: การเผยแพร่รายงานไปยังการใช้งานพื้นที่ทำงานใหม่เป็นการบังคับใช้กฎสิทธิ์การใช้งานที่มีอยู่ที่จำเป็นต้องมีสิทธิ์การใช้งาน Power BI Pro สำหรับผู้ใช้ที่ทำงานร่วมกันในพื้นที่ทำงาน หรือแชร์เนื้อหากับผู้อื่นในบริการ Power BI ผู้ใช้ที่ไม่มีสิทธิ์การใช้งาน Pro จะเห็นข้อความแสดงความผิดพลาดที่ระบุว่า "เฉพาะผู้ใช้ที่มีสิทธิ์การใช้งาน Powre BI Pro เท่านั้นที่สามารถเผยแพร่ไปยังพื้นที่ทำงานนี้"
...
- หากต้องการอนุญาตให้ผู้ชมสามารถส่งออกข้อมูลได้ ต้องมั่นใจว่าผู้ชมคนนั้นๆ ได้รับอนุญาตอย่างถูกต้องในฐานข้อมูลซึ่งอยู่ในพื้นที่ทำงาน อ่านเพิ่มเติมเกี่ยวกับ[สิทธิในการสร้างสำหรับชุดข้อมูล](service-datasets-build-permissions.md#build-permissions-for-shared-datasets)
