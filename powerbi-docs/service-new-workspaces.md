...
> [!NOTE]
>หากต้องการคัดลอกรายงานและสร้างรายงานในพื้นที่ทำงานอื่นโดยยึดตามชุดข้อมูลในพื้นที่ทำงานนี้ ผู้ใช้จำเป็นต้องปฏิบัติตามเกณฑ์ที่กำหนดเพิ่มเติม:
>- ผู้ใช้ต้องมสิทธิ์การใช้งาน Power BI Pro ดูรายละเอียดเกี่ยวกับ[การอนุญาต](#licensing)ได้ในส่วนถัดไป
