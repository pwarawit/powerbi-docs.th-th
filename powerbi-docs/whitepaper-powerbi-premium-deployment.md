...
คุณสามารถกำหนดพื้นที่ทำงานสำหรับความจุแบบพรีเมียมใ**นพอร์ทัล** **ผู้ดูแลระบบ Power BI** หรือสำหรับพื้นที่ทำงานของแอปในบานหน้าต่างของ**พื้นที่ทำงาน**
...
ถ้าคุณมีความจุและรายงานที่คุณต้องการ load test ให้ใช้[เครื่องมือสร้างการโหลดของ PowerShell](https://aka.ms/PowerBILoadTestingTool)เพื่อสร้าง load test ได้อย่างรวดเร็ว เครื่องมือนี้ช่วยให้คุณสามารถประมาณจำนวนอินสแตนซ์ของแต่ละรายงานความจุของคุณสามารถทำงานในหนึ่งชั่วโมง คุณสามารถใช้เครื่องมือเพื่อประเมินความสามารถของความจุของคุณสำหรับการแสดงรายงานแต่ละครั้งหรือสำหรับการแสดงรายงานที่แตกต่างกันหลายรายการควบคู่ไป สำหรับข้อมูลเพิ่มเติมให้ดูวิดีโอ[Microsoft Power BI: ความจุ](https://www.youtube.com/watch?time_continue=1860&v=C6vk6wk9dcw)พรีเมียม

หากต้องการสร้างการทดสอบที่ซับซ้อนยิ่งขึ้นให้พิจารณาการพัฒนาแอปพลิเคชันการทดสอบการโหลดที่จำลองปริมาณงานจริง สำหรับข้อมูลเพิ่มเติมดูการ[ทดสอบการใช้งานการสัมมนาผ่านเว็บแอปพลิเคชัน POWER BI ที่มีการทดสอบการโหลด Visual Studio](https://blogs.msdn.microsoft.com/charles_sterling/2018/04/04/webinar-load-testing-power-bi-applications-with-visual-studio-load-test/)
