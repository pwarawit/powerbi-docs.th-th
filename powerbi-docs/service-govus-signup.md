...
การ**บริการ Power BI**มีเวอร์ชันพร้อมใช้งานสำหรับลูกค้าส่วนราชการสหรัฐอเมริกา ซึ่งเป็นส่วนหนึ่งของการของการสมัครใช้งาน**ชุมชน Office 365 สำหรับส่วนราชการสหรัฐ** การ**บริการ Power BI**เวอร์ชันที่อธิบายไว้ในบทความนี้ถูกออกแบบมาสำหรับลูกค้าส่วนราชการ และแยกต่างหากแตกต่างจากเวอร์ชันเชิงพาณิชย์**บริการ Power BI**
...
1. ลงชื่อเข้าใช้บัญชี Office Government Cloud ที่มีอยู่ แล้วไปที่พอร์ทัลผู้ดูแล
...
7. ลงชื่อเข้าใช้**บริการ Power BI**สำหรับลูกค้าส่วนราชการที่ [https://app.powerbigov.us](https://app.powerbigov.us)
...
* ลงชื่อเข้าใช้ [https://app.powerbigov.us](https://app.powerbigov.us)
...
เมื่อต้องการให้ผู้เช่าของคุณ*อนุญาตพิเศษ*สำหรับ US Government cloud ติดต่อทีมบัญชี Microsoft สำหรับความช่วยเหลือเกี่ยวกับการอนุญาตพิเศษ เฉพาะผู้ดูแลระบบเท่านั้นที่สามารถร้องขอ ขั้นตอนสำหรับ*รายการอนุญาตของ*ใช้เวลาประมาณ 3 สัปดาห์ ระหว่างที่ทีมวิศวกรรมของ Power BI ทำการเปลี่ยนแปลงที่เหมาะสมเพื่อให้แน่ใจว่า ผู้เช่าของคุณทำงานได้อย่างถูกต้องใน US Government cloud
...
* ผู้ใช้สิทธิ์การใช้งานฟรีจะไม่สามารถลงชื่อเข้าใช้โดยใช้ Power BI **Power BI Desktop**และจะประสบช่องว่างฟังก์ชันการทำงานที่อธิบายไว้ในส่วนต่อไปนี้
