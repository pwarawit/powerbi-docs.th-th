...
1. คุณอาจได้รับหนึ่งในกล่องโต้ตอบเหล่านี้ 
    ...
    - หากคุณได้รับข้อความเช่นนี้ ให้เห็นด้วยกับข้อตกลงและเงื่อนไข
...
1. ในขั้นตอนนี้ คุณอาจต้องรอหาก Microsoft [กำลังตั้งค่าผู้เช่ารายใหม่](service-admin-signing-up-for-power-bi-with-a-new-office-365-trial.md) มิฉะนั้น บริการของ Power BI จะเปิดขึ้นในเบราว์เซอร์ของคุณ
...
<sup>2</sup> ในบางองค์กร บัญชี Power BI เริ่มต้นของคุณอาจเป็นสิทธิ์การใช้งาน Power BI **Pro** ตัวอย่างเช่น Office 365 บางรุ่นมีสิทธิ์การใช้งาน Power BI Pro หากต้องการเรียนรู้วิธีการค้นหาสิทธิ์การใช้งานใบอนุญาตของผู้ใช้ของคุณ โปรดดู [สิทธิ์การใช้งานใดบ้างที่ฉันมี](consumer/end-user-license.md)
