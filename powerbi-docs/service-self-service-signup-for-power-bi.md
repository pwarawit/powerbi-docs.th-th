...
> [!NOTE]
> ถ้าคุณอยู่ในองค์กร ลงชื่อเข้าใช้รายบุคคลอาจถูกปิดใช้งาน ดู[ลงทะเบียนรายบุคคลถูกปิด](#individual-sign-up-has-been-turned-off)สำหรับข้อมูลเพิ่มเติมถ้าคุณได้รับข้อผิดพลาดบ่งชี้ที่ดังกล่าวได้ถูกปิดใช้งาน
>
...
> [!NOTE]
> ถ้าคุณได้รับข้อความกล่าวว่าเรารู้จักคุณแล้ว ให้ลองไปยัง https://app.powerbi.com และลงชื่อเข้าใช้
> 
> 
...
7. คุณจะนั้นถูกนำไป https://app.powerbi.com และคุณสามารถเริ่มต้นใช้ Power BI เป็นผู้ใช้ฟรี
...
หลังจากที่คุณได้ลงทะเบียนสำหรับบัญชีฟรีของคุณ นอกจากนี้คุณสามารถเลือกเพื่อทดลองใช้งาน Pro ฟรี 60 วัน คุณจะสามารถเข้าถึงคุณลักษณะ Pro ทั้งหมดสำหรับระยะเวลาการทดลองใช้ Power BI Pro มีคุณลักษณะทั้งหมดของเวอร์ชันฟรียัง Power BI และการใช้งานร่วมกันเพิ่มเติมและฟีเจอร์ทำงานร่วมกัน สำหรับข้อมูลเพิ่มเติม ให้ดู [ข้อมูลราคา](https://powerbi.microsoft.com/pricing) เมื่อต้องลองทดลองใช้ฟรี 60 วันของ Power BI Pro ลงชื่อเข้า Power BI ใช้ และลองใช้คุณลักษณะ Power BI Pro เหล่านี้:
