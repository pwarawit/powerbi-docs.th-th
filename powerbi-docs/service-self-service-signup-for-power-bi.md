...
บทความนี้จะแนะนำคุณผ่านตัวเลือกของคุณเกี่ยวกับวิธีการลงทะเบียน และเริ่มต้นใช้บริการ Power BI เมื่อต้องการเรียนรู้เพิ่มเติมเกี่ยวกับความแตกต่างในฟังก์ชันการทำงานระหว่างสิทธิ์ในการใช้ Power BI แบบต่างๆ ดูที่ [คุณลักษณะ Power BI ตามประเภทสิทธิ์](service-features-license-type.md)
...
> [!NOTE]
> คุณสามารถลงทะเบียนสำหรับ Power BI ด้วยที่อยู่ .gov หรือ .mil ดูรายละเอียดได้ที่ [สมัครองค์กรรัฐบาลสหรัฐฯ ในบริการ Power BI](https://docs.microsoft.com/power-bi/service-govus-signup)
>

> [!NOTE]
> หลังจากที่คุณลงทะเบียนคุณสามารถ[เชิญผู้ใช้เป็นผู้เยี่ยมชม](https://docs.microsoft.com/azure/active-directory/active-directory-b2b-what-is-azure-ad-b2b)เพื่อดูเนื้อหาในผู้เช่า Power BI ของคุณ มีที่อยู่อีเมลใด ๆ รวมทั้งบัญชีส่วนบุคคล
>
