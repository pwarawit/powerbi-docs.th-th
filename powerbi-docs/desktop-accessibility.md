...
ในขณะที่คุณนำทางระหว่างภาพ คุณสามารถกด **Alt+Shift+F10** เพื่อย้ายโฟกัสไปยังหัวข้อภาพ ซึ่งมีตัวเลือกต่างๆ รวมถึงการเรียงลำดับ การส่งออกข้อมูลที่อยู่เบื้องหลังแผนภูมิ และโหมดโฟกัส 

![กด Alt+Shift+F10 ใน Power BI Desktop เพื่อย้ายโฟกัสไปยังหัวข้อภาพ](media/desktop-accessibility/accessibility_08.png)

คุณสามารถกด **Alt+Shift+F11** เพื่อแสดงเวอร์ชันที่สามารถเข้าถึงได้ของหน้าต่าง *แสดงข้อมูล* ซึ่งช่วยให้คุณสำรวจข้อมูลที่ใช้ในภาพในตาราง HTML โดยใช้แป้นพิมพ์ลัดเดียวกันกับที่คุณใช้กับโปรแกรมอ่านหน้าจอของคุณตามปกติ 
...
| เลือกหรือยกเลิกการเลือกจุดข้อมูล | ป้อนหรือเว้นวรรค |
| เลือกหลายรายการ | Ctrl + Enter หรือ Ctrl + Space |
...
| ล้างการเลือก | Ctrl + Shift + L |

### <a name="table--matrix-navigation"></a>ตารางและเมทริกซ์นำทาง
| ในการทำขั้นตอนนี้           | กดปุ่ม                |
| :------------------- | :------------------- |
| ย้ายโฟกัสขึ้น/ ลงหนึ่งเซลล์ (ข้ามทุกเซลล์ในพื้นที่ทั้งหมด)  | ลูกศรแป้น/ ลงแป้นลูกศรขึ้น |
| ย้ายโฟกัสไปทางซ้าย / ขวาหนึ่งเซลล์ (ข้ามทุกเซลล์ในพื้นที่ทั้งหมด)  | แป้นลูกศรซ้าย / ขวาลูกศร |

### <a name="pane-navigation"></a>การนำทางของบานหน้าต่าง
| ในการทำขั้นตอนนี้           | กดปุ่ม                |
| :------------------- | :------------------- |
| เลือกหลายรายการ | Ctrl + Space |
