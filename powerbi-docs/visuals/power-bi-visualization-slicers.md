...
บทความนี้จะแสดงข้อมูลการสร้างและจัดรูปแบบตัวแบ่งส่วนข้อมูลพื้นฐาน โดยใช้ [ตัวอย่างการวิเคราะห์การค้าปลีก](../sample-retail-analysis.md) ฟรี นอกจากนี้ ยังแสดงให้เห็นถึงวิธีการที่คุณสามารถใช้เพื่อควบคุมการแสดงภาพที่ได้รับผลกระทบจากตัวแบ่งส่วนข้อมูล และวิธีการซิงค์กับตัวแบ่งส่วนข้อมูลในหน้าอื่น ๆ ต่อไปนี้คือบทความอื่น ๆ ที่อธิบายถึงวิธีการทำให้แบ่งส่วนข้อมูลชนิดเฉพาะ:

- [ตัวแบ่งส่วนข้อมูลช่วงตัวเลข](../desktop-slicer-numeric-range.md)
- [ตัวแบ่งส่วนข้อมูลวันที่สัมพัทธ์](desktop-slicer-filter-date-range.md)
- [ตัวแบ่งส่วนข้อมูลที่ปรับขนาด](../power-bi-slicer-filter-responsive.md)และตอบสนองได้
...
โปรดดู [ชนิดตัวกรอง](../power-bi-report-filter-types.md) สำหรับข้อมูลเพิ่มเติมเกี่ยวกับตัวกรองระดับวิชวล
