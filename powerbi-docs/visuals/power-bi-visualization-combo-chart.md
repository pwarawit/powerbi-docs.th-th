...
1. สร้างแผนภูมิเส้นใหม่ที่ติดตาม **%กำไรในปีที่แล้ว**โดย**เดือนงบประมาณ** เลือกจุดไข่ปลาการเรียงลำดับตาม**เดือน** และ **จากน้อยไปหามาก**  
...
3. สำหรับ**แกน y (คอลัมน์)** ตั้งค่า**ตำแหน่ง**เพื่อ**ซ้าย**ตั้งค่า**ชื่อเรื่อง**เพื่อ**บน**,  **สไตล์**เมื่อต้องการ**แสดงเฉพาะหัว**และ**แสดงหน่วย**เป็น**ล้าน**

   ![](media/power-bi-visualization-combo-chart/power-bi-open-y.png)
4. ภายใต้**แกน y (คอลัมน์)** เลื่อนลงจนกว่าคุณเห็น**แสดงรายการสำรอง** เนื่องจากมีตัวเลือกมากมายสำหรับแกน Y คุณอาจจำเป็นต้องใช้แถบเลื่อนทั้งสอง ส่วนแสดงรองแสดงตัวเลือกการจัดรูปแบบส่วนของแผนภูมิผสมแผนภูมิเส้น
