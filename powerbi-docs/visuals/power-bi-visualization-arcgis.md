...
### <a name="enable-the-arcgis-map-in-power-bi-desktop-apppowerbicom"></a>เปิดใช้งานแผนที่ ArcGIS ***ใน Power BI Desktop (app.powerbi.com)***
บทช่วยสอนนี้ใช้ไฟล์ PBIX [Retail Analysis sample .PBIX ตัวอย่าง](http://download.microsoft.com/download/9/6/D/96DDC2FF-2568-491D-AAFA-AFDD6F763AE3/Retail%20Analysis%20Sample%20PBIX.pbix
) เพื่อเปิดใช้งาน **ArcGIS Maps for Power BI**:
...
3. เลือกไอคอน ArcGIS Maps for Power BI จากบานหน้าต่าง การจัดรูปแบบการแสดงข้อมูล
   
    ![แถบคำสั่งการแสดงผลสำหรับแผนที่ arcgis](media/power-bi-visualization-arcgis/power-bi-viz-pane.png)
4. Power BI เพิ่มเแม่แบบแผนที่ ArcGIS ที่ว่างเปล่าไปยังพื้นที่ของรายงาน
   
   ![ตัวกำหนดตำแหน่งส่วนการแสดงผล arcgis](media/power-bi-visualization-arcgis/power-bi-esri-placeholder2new.png)

<br/>

## <a name="create-an-arcgis-map-visual"></a>สร้างวิชวลแผนที่ ArcGIS
ดู Will สร้างการแสดงภาพแผนที่ ArcGIS ที่แตกต่างกันสองสามภาพ จากนั้น ใช้ขั้นตอนด้านล่าง เพื่อลองทำด้วยตนเองโดยใช้[ตัวอย่างการวิเคราะห์การค้าปลีก ไฟล์ .PBIX](../sample-datasets.md)
   > [!NOTE]
...
1. จากบานหน้าต่าง**เขตข้อมูล** ลากเขตข้อมูลไปยังบักเก็ต**สถานที่ตั้ง** หรือ**ละติจูด** และ/หรือ**ลองจิจูด** ในตัวอย่างนี้ เรากำลังใช้**ร้าน > เมือง**
   ...
   > 
    ...
    ![แถบคำสั่งเขตข้อมูล arcgis](media/power-bi-visualization-arcgis/power-bi-fields-pane3new.png)
...
3. จากบานหน้าต่าง**เขตข้อมูล** ลากเป็นหน่วยวัดไปบักเก็ต**ขนาด**เพื่อปรับปรุงวิธีแสดงข้อมูล ในตัวอย่างนี้ เรากำลังใช้**ยอดขาย > ยอดขายปีที่แล้ว**
    ...
    ![ส่วนการแสดงแผนที่คะแนน esri](media/power-bi-visualization-arcgis/power-bi-esri-point-map-size2new.png)
...
1. ใช้งานคุณสมบัติการทำงานเพิ่มเติมโดยเลือกจุดไข่ปลาที่มุมขวาบนของส่วนการแสดงผลแล้วเลือก **แก้ไข**
   
   ![แถบคำสั่งแก้ไข arcgis](media/power-bi-visualization-arcgis/power-bi-edit2.png)
   ...
   ![แถบคำสั่งคุณสมบัติการทำงานของ esri](media/power-bi-visualization-arcgis/power-bi-esri-features-new.png)
...
![ส่วนการแสดงผลแผนที่พื้นฐาน esri](media/power-bi-visualization-arcgis/power-bi-esri-base-maps-new.png)
...
![ตัวอย่างประเภทตำแหน่ง esri](media/power-bi-visualization-arcgis/power-bi-esri-location-types-new.png)
...
มีธีมแผนที่ให้สี่แบบ ธีมเฉพาะสถานที่ตั้ง และธีมขนาด ถูกเลือกให้โดยอัตโนมัติจากเขตข้อมูลที่คุณกำหนดให้กับสถานที่ตั้ง และที่เพิ่มลงในบักเก็ต**ขนาด** ในบานหน้าต่างเขตข้อมูบ Power BI ตอนนี้เราจะใช้ **ขนาด** โดยจะทำการปรับเปลี่ยน **แผนที่คลื่นความร้อน** อย่าลืมปิด **แผนที่คลื่นความร้อน** ก่อนเข้าสู่ขั้นตอนถัดไป  
...
สไตล์ของสัญลักษณ์ ให้คุณสามารถปรับการแสดงข้อมูลบนแผนที่ สไตล์ของสัญลักษณ์ จะขึ้นกับ ชนิดของสถานที่ตั้ง และ ธีมแผนที่ ที่เลือก ตัวอย่างต่อไปนี้แสดงประเภท แผนที่ ที่กำหนด **ขนาด** และส่วนการปรับแต่งต่าง ๆ ทั้งความโปร่งใส รูปแบบและขนาด 

![ตัวอย่างรูปแบบสัญลักษณ์ esri](media/power-bi-visualization-arcgis/power-bi-esri-symbol-style-new.png)
...
2. พิมพ์คำสำคัญ (เช่น ที่อยู่ สถานที่ และจุดสนใจ) ในกล่องค้นหา และเลือกจากรายการดรอปดาวน์ สัญลักษณ์จะปรากฏขึ้นบนแผนที่ และแผนที่ขยายไปยังตำแหน่งที่ตั้งให้โดยอัตโนมัติ ผลลัพธ์การค้นหาจะถูกบันทึกเป็นการ์ดที่ตั้ง ในบานหน้าต่างการปักหมุด คุณสามารถบันทึกการ์ดได้สูงสุด 10 สถานที่
   ...
   ![ตัวอย่างหมุดแผนที่ arcgis](media/power-bi-visualization-arcgis/power-bi-pin-arcgis-newer.png)
3. Power BI เพิ่มเข็มหมุดไปยังตำแหน่งที่ตั้ง และคุณสามารถเปลี่ยนสีของหมุดได้
   
   ![ตัวอย่างสีหมุด](media/power-bi-visualization-arcgis/power-bi-pin-color-new.png)
4. เพิ่มและลบหมุด
   
   ![ตัวอย่างการเพิ่มและลบหมุด](media/power-bi-visualization-arcgis/power-bi-pin3.png)

### <a name="drive-time"></a>เวลาของการขับขี่
บานหน้าต่างเวลาในการขับระ ให้คุณเลือกตำแหน่งที่ตั้ง และจากนั้นหาว่า จุดอื่น ๆ บนแผนที่อยู่ภายในระยะทาง หรือเวลาเดินทางที่กำหนดหรือไม่  
    ![ตัวอย่างเวลาขับขี่](media/power-bi-visualization-arcgis/power-bi-esri-drive-time.png)
...
1. เลือกแท็บ**เวลาในการขับรถ** และเลือกเครื่องมือ เลือกรายการเดียว หรือหลายรายการ เลือกครั้งเดียว ที่หมุดสำหรับ วอชิงตัน ดี.ซี.
   ...
   ![ตัวอย่างการเลือกหมุดเดียว](media/power-bi-visualization-arcgis/power-bi-esri-single-select.png)
...
3. รัศมีจะแสดงเป็นสีม่วง เลือกตำแหน่งที่ตั้งใด ๆ เพื่อแสดงรายละเอียด คุณอาจจัดรูปแบบของรัศมี โดยการเปลี่ยนสีและเค้าร่างได้
    ...
    ![รูปแบบรัศมีพร้อมสีและตัวอย่างเส้นกรอบ](media/power-bi-visualization-arcgis/power-bi-esri-drive-time.png)
...
2. แต่ละเลเยอร์จะแสดงพร้อมกล่องกาเครื่องหมาย ทำเครื่องหมายถูกเพื่อเพิ่มเลเยอร์ไปยังแผนที่  ในตัวอย่างนี้ เราได้เพิ่มรายได้เฉลี่ยต่อครัวเรือน<br/>
    ...
    ![ตัวอย่างข้อมูลเฉพาะบุคคลเลเยอร์อ้างอิง](media/power-bi-visualization-arcgis/power-bi-esri-reference-layer-demographic.png)
3. แต่ละเลเยอร์สามารถโต้ตอบได้เช่นกัน เช่นเดียวกับที่คุณสามารถโฮเวอร์เมาส์เหนือแผนภูมิฟองเพื่อดูรายละเอียด คุณสามารถคลิกบนพื้นที่แรเงาบนแผนที่เพื่อดูรายละเอียด<br/>
    ...
    ![ตัวอย่างรายละเอียดเลเยอร์อ้างอิง](media/power-bi-visualization-arcgis/power-bi-esri-reference-layer-details.png)
...
2. ป้อนคำค้นหา จากนั้นเลือกเลเยอร์แผนที่ ในตัวอย่างนี้ เราได้เลือกเขตการเลือกตั้งสมาชิกสภาของสหรัฐอเมริกา
    ...
    ![ตัวอย่างข้อมูลเฉพาะบุคคล esri](media/power-bi-visualization-arcgis/power-bi-reference-details.png)
...
ปรับโหมดการเลือกโดยเลื่อนเคอร์เซอร์ไปที่ไอคอนเลือกรายการเดี่ยวที่ภาพด้านล่าง นี่จะเป็ฯการขยายแถบรายการที่ซ่อนอยู่ด้วยเพื่อแสดงเครื่องมือเพิ่มเติม:

![เครื่องมือเลือก esri](media/power-bi-visualization-arcgis/power-bi-esri-selection-tools2.png)

เครื่องมือแต่ละตัวจะมีบทบาทเฉพาะเพื่อให้คุณเลือกข้อมูลของคุณ: 

![เลือกรายการเดี่ยว esri](media/power-bi-visualization-arcgis/power-bi-esri-selection-single2.png) เลือกจุดข้อมูลเดี่ยว

![เครื่องมือเลือกของ esri](media/power-bi-visualization-arcgis/power-bi-esri-selection-marquee2.png) วาดสี่เหลี่ยมผืนผ้าบนแผนที่ และเลือกจุดข้อมูลที่อยู่ภายใน
...
![เลเยอร์บัฟเฟอร์เลือกรายการ esri](media/power-bi-visualization-arcgis/power-bi-esri-selection-reference-buffer.png) คุณสามารถเลือกข้อมูลโดยใช้เลเยอร์บัฟเฟอร์
...
Power BI ให้ผู้ใช้ ผู้ดูแลผู้เช่า และผู้ดูแลระบบ IT จัดการว่าจะใช้ ArcGIS Maps for Power BI หรือไม่ ต่อไปนี้คุณจะพบขั้นตอนสำหรับแต่ละบทบาทเพื่อจัดการการใช้แผนที่ ArcGis 

### <a name="user-options"></a>ตัวเลือกสำหรับผู้ใช้
จาก Power BI Desktop ผู้ใช้สามารถหยุดใช้แผนที่ ArcGIS สำหรับ Power BIโดยปิดใช้งานในแท็บการรักษาความปลอดภัยจาก **ไฟล์** > **ตัวเลือกและการตั้งค่า** จากนั้นเลือก **ตัวเลือก** > **ความปลอดภัย** เมื่อปิดใช้งาน ArcGIS Maps จะไม่โหลดตามค่าเริ่มต้น
...
จาก PowerBI.com ผู้ดูแลระบบผู้เช่าสามารถป้องกันผู้ใช้ที่เป็นผู้เช่าทั้งหมดจากการใช้ ArcGIS Maps for Power BI โดยการปิดตัวเลือกจาก **การตั้งค่า** > **ไซต์ผู้ดูแลระบบ** > **การตั้งค่าผู้เช่า** เมื่อเกิดกรณีนี้ Power BI จะไม่เห็นไอคอน ArcGIS Maps for Power BI ในบานหน้าต่างการจัดรูปแบบการแสดงข้อมูล
