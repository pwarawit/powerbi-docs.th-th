...
- เมื่ออยู่ในโหมดแบบกลุ่ม
    ...
    - เมื่ออยู่ในโหมดสเกลา (ซึ่งอาจใช้ขีดจำกัดแบบไดนามิกได้)
        - แต้มสูงสุด: 10,000
...
สามารถเพิ่มขึ้นได้ถึง 30,000 แต่จะขึ้นอยู่กับผู้เขียนภาพว่าต้องการให้ใช้กลยุทธ์ใด
...
- คำอธิบายแผนภูมิ ละติจูด ลองจิจูด ขนาด: คำอธิบายแผนภูมิยอดนิยม 233 คำ,  ละติจูดและลองจิจูด 15 ตำแหน่งสูงสุด (ซึ่งอาจใช้สถิติหรือขีดจำกัดแบบไดนามิก)
- ตำแหน่งที่ตั้ง คำอธิบายแผนภูมิ ละติจูดลองจิจูดแบบผลรวม (+/- ตามขนาด): ตำแหน่งที่ตั้งยอดนิยม 233 แห่ง,  คำอธิบายแผนภูมิยอดนิยม 15 คำ (ซึ่งอาจใช้สถิติหรือขีดจำกัดแบบไดนามิก)
...
### <a name="shape-map"></a>แผนที่รูปร่าง
แผนที่แถบสีสามารถใช้สถิติหรือขีดจำกัดแบบไดนามิก 
- แต้มสูงสุด: 10,000
- หมวดหมู่: 500 อันดับสูงสุด
- ชุดข้อมูล (เมื่อทั้ง X และ Y ปรากฏ): 20 อันดับสูงสุด
...
### <a name="tree-map-this-could-use-statistics-or-dynamic-limits"></a>แผนที่ต้นไม้ (ซึ่งอาจใช้สถิติหรือขีดจำกัดแบบไดนามิก)
- แต้มสูงสุด: 3,500
- กลุ่ม: 500 อันดับสูงสุด
- รายละเอียด: 20 อันดับสูงสุด
