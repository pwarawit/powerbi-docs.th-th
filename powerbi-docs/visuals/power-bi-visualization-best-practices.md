...
**รูปที่ 10a:    รูปแบบในบริการ Power BI**
...
* การ์ด: **ประเภทป้ายชื่อ**ตั้งค่าเป็นปิด **ชื่อเรื่อง**ตั้งเป็นเปิดใช้งาน และตั้งค่าให้อยู่กึ่งกลางของ 12pt สีดำ
* ชื่อเรื่องเป็นภาพ: ถ้าเปิดใช้งานอยู่ ตั้งค่าเป็น 12pt และชิดซ้าย
* ตัวแบ่งส่วนข้อมูล: **หัวข้อ**ตั้งค่าเป็นปิด **ชื่อเรื่อง**ตั้งเป็นเปิดใช้งาน ทิ้งให้**รายการ** > **ข้อความ**เป็นสีเทาและ 10pt
...
จากนั้นเลือกองค์ประกอบภาพเพื่อปรับปลี่ยน และตรวจสอบให้แน่ใจว่ามีการเปิดใช้งาน ตัวอย่างของภาพองค์ประกอบคือ: **แกน X**, **แกน Y**, **หัวข้อ**, **ป้ายชื่อข้อมูล**และ**คำอธิบายแผนภูมิ** ตัวอย่างด้านล่างแสดงองค์ประกอบ**ชื่อเรื่อง**
...
การเรียงลำดับแผนภูมิ เลือกจุดไข่ปลา (...) ที่ด้านบนขวาของแผนภูมิ เลือก**เรียงลำดับ**และเลือกช่องข้อมูลที่คุณต้องการเรียงลำดับและทิศทาง สำหรับข้อมูลเพิ่มเติม ดู[เปลี่ยนวิธีการเรียงลำดับภาพ](../consumer/end-user-change-sort.md)
...
จากนั้น สำหรับแต่ละภาพบนหน้ารายงาน ตัดสินใจว่าคุณต้องการให้ภาพที่เลือกทำการกรอง ทำไฮไลท์ หรือไม่ต้องทำอะไร ภาพทั้งหมดไม่สามารถทำไฮไลท์ได้ และสำหรับภาพที่ไฮไลท์เป็นตัวควบคุมจะไม่พร้อมใช้งาน สำหรับข้อมูลเพิ่มเติม ดู[โต้ตอบแบบภาพใน Power BI](../consumer/end-user-interactions.md)
...
6. แผนภูมิแท่งด้านล่าง: เรียงลำดับตามปีจากน้อยไปหามากเพื่อให้ตรงกับแผนภูมิด้านบน เปลี่ยนสีเพื่อให้ตรงกับระดับชั้น เปลี่ยนชื่อเรื่องแล้ว ปิดคำอธิบายแผนภูมิเพื่อให้มีช่องว่างเพิ่มเติมสำหรับข้อมูล เปิดใช้งานป้ายชื่อข้อมูลซึ่งจะไม่แสดงในรายงาน (เนื่องจากภาพมีขนาดเล็กเกินไปที่จะสามารถอ่านป้ายชื่อได้) แต่จะแสดงเมื่อเปิดภาพในโหมดโฟกัส [เรียนรู้เกี่ยวกับโหมดโฟกัส](../consumer/end-user-focus.md) เพิ่มจำนวนการจัดการแข่งขัน (แตกต่างกัน) ไปยัง**คำแนะนำเครื่องมือ** ดังนั้นในตอนนี้ เมื่อคุณเลื่อนไปเหนือคอลัมน์แบบเรียงซ้อน คำแนะนำเครื่องมือจะบอกให้คุณทราบจำนวนการจัดการแข่งขันที่มีการแข่งขันในปีนั้น ๆ
...
* แผนภูมิแท่ง/คอลัมน์สามารถเจาะลึกลงไป (และขึ้นมาอีกครั้ง) ได้  นี่คือวิธีที่ดีในการรวมข้อมูลเพิ่มเติมลงในภาพโดยไม่ต้องใช้พื้นที่เพิ่มเติม  ตัวอย่างด้านล่างมีลำดับชั้นสำหรับภูมิภาค > ประเทศ  ดับเบิ้้ลคลิกที่แถบภูมิภาคเพื่อเจาะลงไปประเทศที่ประกอบกันเป็นภูมิภาคนั้น  สำหรับข้อมูลเพิ่มเติมเกี่ยวกับการดูรายละเอียดแนวลึก ดู[การดูรายละเอียดแนวลึกในการแสดงภาพ](../consumer/end-user-drill.md)
...
ถ้าคุณเพิ่มแกนเคลื่อนไหว คุณแสร้งทำได้ว่าคุณเป็น Hans Rosling และบอกเล่าเรื่องราวเมื่อเวลาผ่านไป https://www.youtube.com/watch?v=PbaDBJWCeD4) เมื่อต้องเพิ่มมีแกนเคลื่อนไหว ลากช่องข้อมูลวันที่และเวลาลงในแอ่ง**แกนเคลื่อนไหว**
...
 
ตัวอย่างเช่น แผนผังต้นไม้แรกบ่งชี้ขนาด GDP แต่ยากที่จะระบุความแตกต่างเฉพาะระหว่างประเทศ โดยเฉพาะอย่างยิ่งในกล่องขนาดเล็กกว่าที่ไม่มีป้ายชื่อ สำหรับ ข้อมูลนี้ที่มีการเปรียบเทียบการจัดกลุ่มเดียว แผนภูมิแท่งหรือคอลัมน์อาจเป็นตัวเลือกที่ดีกว่า
...
* [แค็ตตาล็อกการแสดงภาพข้อมูล: แผนผังต้นไม้](http://www.datavizcatalogue.com/methods/treemap.html#.VYhylI3bL7Y)
