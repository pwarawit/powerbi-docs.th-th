...
ms.locfileid: "54295704"
---
# <a name="export-data-from-visualizations"></a>ส่งออกข้อมูลจากการแสดงภาพ
ถ้าคุณต้องการดูข้อมูลที่ใช้ในการสร้างการแสดงภาพ [คุณสามารถแสดงข้อมูลนั้นใน Power BI](service-reports-show-data.md) หรือส่งออกข้อมูลนั้นไปยัง Excel เป็นไฟล์ .xlsx หรือ .csv ได้ ตัวเลือกในการส่งออกข้อมูลต้องมีสิทธิ์การใช้งานระดับ Pro หรือ Premium และแก้ไขสิทธิ์ในชุดข้อมูลและรายงาน 
...
5. ใน Power BI ออนไลน์ ถ้าการแสดงภาพของคุณมีค่ารวม (ตัวอย่างหนึ่งที่ควรเป็นถ้าคุณเปลี่ยน**จำนวนนับ**เป็น*ค่าเฉลี่ย* *ผลรวม*หรือ*ค่าต่ำสุด*) คุณจะได้สองตัวเลือก: **ข้อมูลสรุป** และ **ข้อมูลพื้นฐาน** ใน Power BI Desktop คุณจะมีตัวเลือกสำหรับ**ข้อมูลสรุป**เท่านั้น สำหรับความช่วยเหลือในการทำความเข้าใจค่ารวม ดู[ค่ารวมใน Power BI](../service-aggregates.md)
...
- อนุญาตให้ส่งออกเฉพาะข้อมูลสรุป (เป็นค่าเริ่มต้นสำหรับรายงานใหม่) 
- อนุญาตให้มีการส่งออกข้อมูลสรุปและข้อมูลพื้นฐาน (เป็นค่าเริ่มต้นก่อนเดือนตุลาคม 2018) 
- ไม่อนุญาตให้ส่งออกข้อมูลใดๆ  

    > [!IMPORTANT]
    > เราขอแนะนำให้ผู้ออกแบบรายงานทบทวนรายงานเก่าและตั้งค่าตัวเลือกการส่งออกด้วยตนเองตามความจำเป็น

1. ตั้งค่าตัวเลือกเหล่านี้ โดยเริ่มทำงานใน Power BI Desktop

2. จากมุมบนซ้าย เลือก**แฟ้ม** > **ตัวเลือกและการตั้งค่า** > **ตัวเลือก** 

3. ภายใต้**แฟ้มปัจจุบัน**เลือก**ตั้งค่ารายงาน**

    ![ตั้งค่ารายงานบนเดสก์ท็อป](media/power-bi-visualization-export-data/desktop-report-settings.png)

4. เลือกรายการจากเมนูเลื่อนลง**ส่งออกข้อมูล**
