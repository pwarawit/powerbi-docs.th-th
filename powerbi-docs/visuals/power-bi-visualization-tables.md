...
![สกรีนช็อตของตารางที่แสดงการวัดที่แตกต่างกันห้าการวัดสำหรับประเภท](media/power-bi-visualization-tables/table.png)
...
1. จาก **My Workspace** เลือก **ชุดข้อมูล** > **สร้างรายงาน**
    ...
    ![สกรีนช็อตของชุดข้อมูล > สร้างรายงาน](media/power-bi-visualization-tables/power-bi-create-a-report.png)
...
1. ในบานหน้าต่าง **การแสดงผลด้วยภาพ** ค้นหาแอ่ง **ค่า** และการลาก ค่าจนกว่าลำดับของคอลัมน์แผนภูมิของคุณตรงกับรูปภาพแรกในหน้านี้ **ค่า**ของคุณด้วยจะมีลักษณะดังนี้

    ![ค่าที่ดี](media/power-bi-visualization-tables/power-bi-table2.png)

1. ปักหมุดตารางไปยังแดชบอร์ดโดยการเลือกไอคอนปักหมุด ![thumbtack](media/power-bi-visualization-tables/pbi_pintile.png) ในมุมขวาบนของรูปภาพ
...
*การจัดรูปแบบตามเงื่อนไข* คือการจัดรูปแบบชนิดหนึ่ง Power BI ใช้การจัดรูปแบบตามเงื่อนไขกับเขตข้อมูลในแอ่ง **ค่า** ของบานหน้าต่าง **การแสดงผลด้วยภาพ**
...
1. ในบานหน้าต่าง **การแสดงผลด้วยภาพ** เลือกไอคอน **เขตข้อมูล** ![fields icon](media/power-bi-visualization-tables/power-bi-fields-icon.png)

1. เลือกลูกศรชี้ลงข้าง ๆ ค่าในแอ่ง **ค่า** เดียวกับที่คุณต้องการจัดรูปแบบ (หรือคลิกขวาที่ช่องข้อมูล)

    > [!NOTE]
    > คุณสามารถจัดการการจัดรูปแบบตามเงื่อนไขสำหรับช่องข้อมูลในพื้นที่**ค่า**ของแอ่ง**ช่องข้อมูล**ได้เท่านั้น

    ![เส้นทางไปยังระดับสีพื้นหลัง](media/power-bi-visualization-tables/power-bi-conditional-formatting-background.png)

1. เลือก **สีพื้นหลัง**

1. ในกล่องโต้ตอบที่ปรากฏขึ้น คุณสามารถกำหนดค่าสี ค่า **ต่ำสุด** และค่า **สูงสุด** หากคุณเลือกตัวเลือก **แยกจากกัน** คุณสามารถกำหนดค่า **ศูนย์กลาง** ที่เป็นทางเลือกได้เช่นกัน
...
1. เพิ่มการจัดรูปแบบตามเงื่อนไขแถบข้อมูลโดยการเลือกลูกศรชี้ลงที่ข้าง ๆ**ผลต่างยอดขายรวม**และเลือก**จัดรูปแบบตามเงื่อนไข > แถบข้อมูล**
...
หากคุณต้องการลบการจัดรูปแบบตามเงื่อนไขออกจากการสร้างภาพ ให้คลิกขวาที่ช่องข้อมูลอีกครั้ง แล้วเลือก **ลบการจัดรูปแบบตามเงื่อนไข**

> [!TIP]
> การจัดรูปแบบตามเงื่อนไขจะพร้อมใช้งานจากบานหน้าต่าง **รูปแบบ** เช่นกัน เลือกค่าที่จะจัดรูปแบบ จากนั้นตั้งค่า**สเกลสี**หรือ**แถบข้อมูล**ให้เป็น**เปิด** เพื่อใช้ค่าเริ่มต้น หรือหากต้องการปรับแต่งการตั้งค่า ให้เลือก**การควบคุมขั้นสูง**
