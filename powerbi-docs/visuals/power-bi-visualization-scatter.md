...
แผนภูมิลงจุดนั้นเหมือนกันกับแผนภูมิฟองอากาศและแผนภูมิกระจาย ที่แตกต่างกันคือคุณยังสามารถลงข้อมูลเชิงตัวเลขหรือเชิงหมวดหมู่ตามแกน X ได้
...
1. เลือก ![สกรีนช็อตสีเหลืองพร้อมด้วยไอคอน](media/power-bi-visualization-scatter/power-bi-yellow-plus-icon.png) ในการสร้างหน้ารายงานเปล่า

1. จากช่อง**เขตข้อมูล** เลือกเขตข้อมูลเหล่านี้:
...
1. ในการตั้งค่าจำนวนของจุดข้อมูลที่จะแสดงในแผนภูมิฟองอากาศ ในหัวข้อ**รูปแบบ**ของพื้นที่การ**แสดงภาพ** ขยาย**ทั่วไป**และปรับ**ปริมาณข้อมูล**
    ...
    ![สกรีนช็อตของการเรียกใช้งานบานหน้าต่างการแสดงภาพด้วยไอคอนรูปแบบ เมนูดรอปดาวน์ทั่วไป และตัวเลือกไดรฟ์ข้อมูล](media/power-bi-visualization-scatter/pbi_scatter_data_volume.png)
...
1. คุณสามารถ[จัดรูปแบบสี ป้ายชื่อ ชื่อเรื่อง พื้นหลัง และอื่น ๆ ของการแสดงภาพ](service-getting-started-with-color-formatting-and-axis-properties.md)ได้
    ...
    ![สกรีนช็อตของการเรียกรูปร่างรายการดรอปดาวน์พร้อมกับตัวเลือกรูปร่างตัวทำเครื่องหมายออกมา](media/power-bi-visualization-scatter/pbi_scatter_marker.png)
...
![สกรีนช็อตของแผนภูมิกระจายที่มีข้อมูลจุดเพียงจุดเดียว](media/power-bi-visualization-scatter/pbi_scatter_tshoot1.png)
...
![สกรีนช็อตของแผนภูมิกระจาย มี RowNum ถูกเพิ่มไปยังรายละเอียดได้ดี](media/power-bi-visualization-scatter/pbi_scatter_tshoot.png)

ถ้าคุณไม่มีในข้อมูลของคุณ ให้สร้างช่องข้อมูลที่รวมค่า X และ Y เข้าด้วยกันลงในสิ่งที่ไม่ซ้ำกันสำหรับแต่ละจุด:

![สกรีนช็อตของแผนภูมิกระจาย มี TempTime ถูกเพิ่มไปยังรายละเอียดได้ดี](media/power-bi-visualization-scatter/pbi_scatter_tshoot2.png)
