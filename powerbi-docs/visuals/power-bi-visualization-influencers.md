...
เมตริกที่คุณวิเคราะห์จะต้องเป็นเขตข้อมูลตามประเภทหรือตัวเลข (ยังไม่สนับสนุนผลรวมและการวัด)
...
7. **เส้นเฉลี่ย**: ค่าเฉลี่ยถูกคำนวณสำหรับค่าอื่น ๆ ที่เป็นไปได้ทั้งหมดสำหรับ **ธีม** ยกเว้น **ความสามารถในการใช้งาน** ดังนั้นการคำนวณจึงใช้กับค่าทั้งหมดเป็นสีดำ ซึ่งบอกคุณว่าเปอร์เซ็นต์ของ **ธีม** อื่นให้คะแนนคุณต่ำแค่ไหน กล่าวอีกนัยหนึ่ง เมื่อลูกค้าให้คะแนนแล้ว ลูกค้าจะอธิบายถึงเหตุผลหรือธีมสำหรับการให้คะแนนด้วย ธีมบางอย่างสามารถใช้งานได้ มีความเร็วและปลอดภัย 

   **ธีมคือความสามารถในการใช้งาน**เป็นผู้มีอิทธิพลหลักสูงที่สุดอันดับสองสำหรับการให้คะแนนต่ำตามภาพวิชวลในบานหน้าต่างด้านซ้าย หากคุณเฉลี่ยธีมอื่น ๆ ทั้งหมดและการมีส่วนร่วมของธีมดังกล่าวในการให้คะแนน **ต่ำ** คุณจะได้ผลลัพธ์ที่เห็นเป็นสีแดง จากธีมอื่นๆ ที่ให้มาทั้งหมด มีเพียง 11.35% ที่มี**ความสามารถในการใช้งาน**สูงกว่า

8. **กล่องกาเครื่องหมาย**: **แสดงค่าที่เป็นผู้มีอิทธิพลเท่านั้น**

## <a name="create-a-key-influencers-visual"></a>สร้างภาพวิชวลของผู้มีอิทธิพลหลัก 
 
ดูวิดีโอนี้เพื่อเรียนรู้วิธีการสร้างภาพวิชวลของผู้มีอิทธิพลหลัก แล้วทำตามขั้นตอนเหล่านี้เพื่อสร้างภาพวิชวล 
...
2. ย้ายเมตริกที่คุณต้องการตรวจสอบไปที่เขตข้อมูล **การวิเคราะห์** เขตข้อมูล **การวิเคราะห์** สนับสนุนตัวแปรตามประเภทหรือไม่ต่อเนื่องเท่านั้น เมื่อต้องการดูสิ่งที่มีผลต่อการให้คะแนนการบริการของลูกค้าต่ำ เลือก **ตารางลูกค้า** > **การให้คะแนน** 
3. ย้ายเขตข้อมูลที่คุณคิดว่ามีผลต่อ **การให้คะแนน** เข้าไปที่เขตข้อมูล **อธิบายโดย** คุณสามารถย้ายเขตข้อมูลได้มากเท่าที่คุณต้องการ ในกรณีนี้ เริ่มต้นด้วย:
    ...
    - ขนาดบริษัท 
    - ธีม 
1. เมื่อต้องการเน้นการให้คแนนติดลบ เลือก**ต่ำ**ในกล่องดรอปดาวน์ **สิ่งที่มีผลต่อการให้คะแนนที่จะเป็น**  
...
ในตัวอย่างก่อนหน้านี้ ปัจจัยการอธิบายทั้งหมดมีความสัมพันธ์แบบหนึ่งต่อหนึ่งหรือกลุ่มต่อหนึ่งกับเมตริก ในกรณีนี้ แต่ละคะแนนมีธีมหนึ่งที่เชื่อมโยงด้วย ธีมนี้เป็นธีมหลักสำหรับการรีวิวของลูกค้า ในทำนองเดียวกัน ลูกค้ามาจากประเทศหนึ่ง มีประเภทสมาชิกประเภทหนึ่ง และดำเนินบทบาทหนึ่งในองค์กรของพวกเขา ปัจจัยการอธิบายนั้นเป็นแอตทริบิวต์ของลูกค้าอยู่แล้ว และไม่จำเป็นต้องมีการแปลง ภาพวิชวลทำให้ปัจจัยเหล่านี้สามารถใช้ได้ทันที 
...
องค์กรในตัวอย่างนี้มีสามบทบาทได้แก่ ลูกค้า ผู้ดูแลระบบ และผู้เผยแพร่ การเป็นลูกค้าเป็นปัจจัยอันดับต้น ๆ ที่ส่งผลให้เกิดการให้คะแนนต่ำ 
...
## <a name="working-with-numerical-data"></a>การทำงานกับข้อมูลที่เป็นตัวเลข

ถ้าคุณย้ายเขตข้อมูลตัวเลขไปยังเขตข้อมูล **การวิเคราะห์** คุณสามารถเลือกวิธีการจัดการสถานการณ์นั้น คุณสามารถเปลี่ยนลักษณะการทำงานของภาพวิชวลโดยการเข้าไปที่**บานหน้าต่างการจัดรูปแบบ**และการสลับไปมาระหว่าง**ประเภทการวิเคราะห์ตามประเภท**และ**ประเภทการวิเคราะห์แบบต่อเนื่อง**ได้
...
ภาพวิชวลของผู้มีอิทธิพลหลักจะอยู่ในการแสดงตัวอย่างสาธารณะและมีข้อจำกัดบางประการ ฟังก์ชั่นที่ไม่สามารถใช้งานได้ในปัจจุบันประกอบด้วย: 
- เมตริกการวิเคราะห์ที่เป็นผลรวมหรือการวัด
- การใช้ภาพวิชวลใน Power BI Embedded
- การใช้ภาพวิชวลในแอปมือถือ Power BI
- การสนับสนุน RLS
...
ในตัวอย่างนี้ หมุนข้อมูลเพื่อสร้างคอลัมน์ใหม่สำหรับเบราว์เซอร์ มือถือ และ แท็บเล็ต ตอนนี้คุณสามารถใช้อุปกรณ์เฉพาะเหล่านี้ใน**อธิบายโดย**ได้ อุปกรณ์ทั้งหมดกลายเป็นผู้มีอิทธิพล และเบราว์เซอร์มีผลกระทบต่อคะแนนของลูกค้ามากที่สุด
