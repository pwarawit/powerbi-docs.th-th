...
* ด้วยการแสดงภาพประเภทอื่น ผู้ใช้ของ Power BI **Pro** สามารถทำได้ทุกอย่างที่ผู้ใช้พรีเมียมทำได้ รวมทั้ง [ส่งออกข้อมูลที่จำเป็น](power-bi-visualization-export-data.md) [รับเมทริกซ์การใช้งาน](../service-usage-metrics.md) บันทึกสำเนาและ[เผยแพร่ไปยังเว็บ](../service-publish-to-web.md) และอื่นๆ
