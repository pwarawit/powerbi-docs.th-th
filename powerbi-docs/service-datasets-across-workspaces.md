...
ใน Power BI ผู้สร้างชุดข้อมูลสามารถควบคุมผู้ที่สามารถเข้าถึงข้อมูลได้โดยใช้[สิทธิ์ในการสร้าง](service-datasets-build-permissions.md#build-permissions-for-shared-datasets) ผู้สร้างชุดข้อมูลยังสามารถ*รับรอง*หรือ*เลื่อนระดับ*ชุดข้อมูลเพื่อให้ผู้อื่นสามารถค้นหาได้ ด้วยวิธีนั้น ผู้เขียนรายงานจะทราบว่าชุดข้อมูลใดที่มีคุณภาพสูงและเป็นทางการและพวกเขาสามารถใช้ชุดข้อมูลเหล่านั้นได้ทุกที่ที่พวกเขาเขียนใน Power BI ผู้ดูแลระบบผู้เช่ามีการตั้งค่าผู้เช่าใหมเป็น[ควบคุมการใช้ชุดข้อมูลทั้งพื้นที่ทำงาน](service-datasets-admin-across-workspaces.md)
...
ด้วยชนิดของสิทธิ์การสร้าง ถ้าคุณเป็นผู้สร้างชุดข้อมูล คุณสามารถกำหนดว่าใครในองค์กรของคุณสามารถสร้างเนื้อหาใหม่บนชุดข้อมูลของคุณได้ ผู้มีสิทธิ์ในการสร้างยังสามารถสร้างเนื้อหาใหม่บนชุดข้อมูลที่อยู่นอก Power BI เช่น แผ่นงาน Excel ที่ผ่านการวิเคราะห์ใน Excel, XMLA และส่งออก อ่านเพิ่มเติมเกี่ยวกับ[สิทธิในการสร้าง](service-datasets-build-permissions.md#build-permissions-for-shared-datasets)
...
- โดยทั่วไป การค้นพบและการเชื่อมต่อกับชุดข้อมูลที่ใช้ร่วมกันจะพร้อมใช้งานสำหรับทุกคน อย่างไรก็ตาม ผู้ใช้ที่ไม่มีสิทธิ์การใช้งานระดับ Pro เท่านั้นสามารถเชื่อมต่อกับชุดข้อมูลที่อยู่ในพื้นที่ทำงานของฉันส่วนบุคคล
- ผู้ใช้ที่ไม่มีสิทธิ์การใช้งาน Pro สามารถใช้รายงานและแดชบอร์ดที่สร้างขึ้นบนชุดข้อมูลที่ใช้ร่วมกันได้ถ้าทั้งสองพื้นที่ทำงาน (หนึ่งที่มีเนื้อหาและหนึ่งที่มีชุดข้อมูล) ที่อยู่ในความจุพรีเมียม
- ใน Power BI Desktop ผู้ใช้ที่ไม่มีสิทธิ์การใช้งานระดับ Pro สามารถดูได้เฉพาะชุดข้อมูลจากพื้นที่ดำเนินการของฉันเท่านั้น
...
- สมมติว่าคุณสร้างรายงานในพื้นที่ทำงาน A ที่ยึดตามชุดข้อมูลในพื้นที่ทำงาน B เมื่อคุณสร้างแอปสำหรับพื้นที่ทำงาน A คุณสามารถรวมรายงานนั้นในแอปพื้นที่ทำงาน A เท่านั้นถ้าคุณยังเป็นสมาชิกของพื้นที่ทำงาน B
