...
* SSO เป็นไปได้สำหรับ[แหล่งข้อมูลอื่น ๆ](desktop-directquery-data-sources.md#single-sign-on-sso-for-directquery-sources)โดยไม่ต้องใช้เกตเวย์ข้อมูล
