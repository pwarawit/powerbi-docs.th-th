...
ในบางครั้ง วิธีที่ดีที่สุดในการเรียนรู้เกี่ยวกับการรีเฟรชข้อมูลใน Power BI ก็คือการศึกษาจากตัวอย่าง ต่อไปนี้เป็นตัวอย่างของสถานการณ์สมมติในการรีเฟรชข้อมูลที่พบได้บ่อยกว่า:
...
ขออภัย การรีเฟรชไม่ได้รับการรองรับในสถานการณ์สมมตินี้ เมื่อต้องการรีเฟรชชุดข้อมูลสำหรับแดชบอร์ดของคุณ คุณจะต้องอัปโหลดสมุดงานใหม่ อย่างไรก็ตาม มีโซลูชันที่ยอดเยี่ยมจริง ๆ: วางไฟล์สมุดงานของคุณบน OneDrive หรือ SharePoint Online
