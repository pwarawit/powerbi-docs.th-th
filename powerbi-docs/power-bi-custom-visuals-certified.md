...
* ตรวจสอบให้แน่ใจว่าภาพที่สอดคล้องกับ [คู่มือการใช้งานสำหรับวิชวล Power BI](./developer/guidelines-powerbi-visuals.md#guidelines-for-power-bi-visuals-with-additional-purchases) **ไม่อนุญาตให้ใช้ลายน้ำ**
