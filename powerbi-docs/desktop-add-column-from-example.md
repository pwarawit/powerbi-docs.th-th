...
เริ่มตั้งแต่การเผยแพร่ เดือนเมษายน 2017 ของ **Power BI Desktop** คุณสามารถเพิ่มคอลัมน์ใหม่ของข้อมูลคุณด้วย**ตัวแก้ไขคิวรี** โดยการให้ค่าตัวอย่างหนึ่งหรือหลายค่า สำหรับคอลัมน์ใหม่ของคุณได้ คุณสามารถสร้างตัวอย่างคอลัมน์ใหม่ จากการเลือกปัจจุบัน หรือจากการป้อนค่า ที่มีค่าตามคอลัมน์ทั้งหมด (หรือที่ถูกเลือก) ในตารางที่ระบุได้

![](media/desktop-add-column-from-example/add-column-from-example_01.png)

วิธีนี้ช่วยให้คุณสร้างคอลัมน์ใหม่ได้อย่างรวดเร็ว และง่ายดาย และเหมาะกับสถานการณ์ต่อไปนี้:
...
ในบทความนี้ เราจะใช้ข้อมูลจากบทความวีกิพีเดียต่อไปนี้ (เป็นลิงก์ ดังนั้นคุณสามารถคลิกเพื่อรับข้อมูลสำหรับคุณเอง แล้วทำตาม):
...
3. ปุ่ม**ตกลง**และ**ยกเลิก** ให้คุณยอมรับการเปลี่ยนแปลงของคุณ และเพิ่มคอลัมน์ หรือยกเลิก
...
ขณะที่คุณพิมพ์ตัวอย่างของคุณในคอลัมน์ใหม่ Power BI ให้คุณเห็นตัวอย่าง ว่าคอลัมน์ที่จะสร้าง ปรากฏอย่างไรจากการแปลงที่ตรวจพบ ตัวอย่างเช่น เราพิมพ์ *Alabama* ในแถวแรก ที่สอดคล้องกับค่า *Alabama* ในคอลัมน์แรกของตาราง ทันทีที่เราเคาะ *Enter* Power BI กรอกข้อมูลในคอลัมน์ตามค่านั้น

แต่เราไปแถวที่มี *Massachusetts[E]* และลบ *[E]* ที่อยู่ตรงท้ายออก (เพราะเราไม่ได้ต้องการ) และ Power BI ได้ตรวจพบการเปลี่ยนแปลง และใช้ตัวอย่างนั้นสร้างการแปลง สังเกตคำอธิบายการแปลง ในบานหน้าต่างตรงกลางด้านบน
...
มีการแปลงมากมายที่มีให้ เมื่อใช้**การเพิ่มคอลัมน์จากตัวอย่าง** แต่ไม่ใช่ทุกการแปลงจะรวมอยู่ในนี้ รายการต่อไปคือการแปลงทั้งหมดที่*สนับสนุนแล้ว*
