...
หลังจากที่คุณสร้างโค้ดฝังตัวของ**การเผยแพร่บนเว็บ**ของคุณและแชร์ไฟล์ มีการอัปเดรายงานที่มีการเปลี่ยนแปลง และลิงก์โค้ดฝังตัวจะเปิดใช้งานทันที ทุกคนที่เปิดลิงก์สามารถดูได้ หลังจากการดำเนินการนี้เริ่มต้น อย่างไรก็ตาม การปรับปรุงการรายงานหรือภาพอาจใช้เวลาประมาณหนึ่งชั่วโมงก่อนที่ผู้ใช้จะมองเห็นได้ ถ้าคุณต้องการอัปเดตความสามารถใช้งานแบบทันทีของคุณ คุณสามารถลบโค้ดแบบฝังตัวและสร้างขึ้นใหม่ เมื่อต้องการเรียนรู้เพิ่มเติม ให้ดูหัวข้อ[**วิธีการทำงาน**](#howitworks)ในภายหลังในบทความนี้ 
