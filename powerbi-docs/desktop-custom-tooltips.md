...
เมื่อมีการสร้างภาพ คำแนะนำเครื่องมือเริ่มต้นจะแสดงค่าและประเภทของจุดข้อมูล มีหลายอินสแตนซ์เมื่อข้อมูลที่แนะนำเครื่องมือจะมีประโยชน์ และการกำหนดอาจมีบริบทเพิ่มเติมและข้อมูลสำหรับผู้ใช้ที่ดูภาพ คำแนะนำเครื่องมือแบบกำหนดเองช่วยให้คุณสามารถระบุจุดข้อมูลเพิ่มเติมที่แสดงเป็นส่วนหนึ่งของคำแนะนำดังกล่าว

## <a name="how-to-customize-tooltips"></a>วิธีการกำหนดคำแนะนำเครื่องมือด้วยตนเอง
เมื่อต้องสร้างคำแนะนำแบบกำหนดเอง ใน**เขตข้อมูล**ดีของการ**แสดงภาพ**บานหน้าต่างลากเขตข้อมูลลงใน**เคล็ดลับเครื่องมือ**บักเก็ต แสดงในรูปต่อไปนี้ ในรูปต่อไปนี้ มีสองเขตข้อมูลถูกใส่ไว้ในบักเก็ต**คำแนะนำเครื่องมือ**
...
มีหลายวิธีในการกำหนดเอง**แนะนำเครื่องมือ**ใช้เขตข้อมูลใด ๆ ในชุดข้อมูลของคุณ พร้อมใช้งานในการสื่อข้อมูลอย่างรวดเร็วและข้อมูลเชิงลึกกับผู้ใช้ที่ดูแดชบอร์ดหรือรายงานของคุณ
