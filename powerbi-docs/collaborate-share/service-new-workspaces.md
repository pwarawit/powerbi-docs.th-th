...
พื้นที่ทำงานใหม่ที่ได้รับการอัปเกรดแล้วสามารถใช้งานร่วมกันกับพื้นที่ทำงานแบบคลาสสิกที่มีอยู่ได้ ประสบการณ์การใช้งานพื้นที่ทำงานใหม่เป็นค่าเริ่มต้นของประเภทพื้นที่ทำงาน คุณยังสามารถสร้างและใช้ [พื้นที่ทำงานแบบคลาสสิก](service-create-workspaces.md) ตามกลุ่ม Microsoft 365 ได้ถ้าคุณต้องการ พร้อมที่จะโยกย้ายจากพื้นที่ทำงานแบบคลาสสิกของคุณหรือยัง ดู [อัปเกรดพื้นที่ทำงานแบบคลาสสิกเป็นพื้นที่งานใหม่ใน Power BI](service-upgrade-workspaces.md) สำหรับรายละเอียด

ด้วยตัวอย่างพื้นที่ทำงานใหม่ ตอนนี้คุณสามารถ:

- กำหนดบทบาทพื้นที่ทำงานให้กับกลุ่มผู้ใช้: กลุ่มความปลอดภัย รายการการแจกจ่าย กลุ่ม Microsoft 365 และบุคคลต่างๆ
- สร้างพื้นที่ทำงานใน Power BI โดยไม่ต้องสร้างกลุ่ม Microsoft 365 พื้นฐานที่เกี่ยวข้อง การดูแลระบบพื้นที่ทำงานทั้งหมดอยู่ใน Power BI ไม่ได้อยู่ใน Microsoft 365
- จัดการการเข้าถึงเนื้อหาของผู้ใช้ผ่านกลุ่ม Microsoft 365 ต่อไปหากคุณต้องการ คุณเพิ่งเพิ่มกลุ่ม Microsoft 365 ในรายการการเข้าถึงพื้นที่ทำงาน
...
- การสร้างพื้นที่ทำงานเหล่านี้จะไม่สร้างกลุ่ม Microsoft 365 เหมือนอย่างที่พื้นที่ทำงานแบบคลาสสิกเคยทำ อย่างไรก็ตาม ตอนนี้คุณสามารถใช้กลุ่ม Microsoft 365 เพื่อให้ผู้ใช้สามารถเข้าถึงพื้นที่ทำงานของคุณด้วยการกำหนดบทบาท
- ในพื้นที่ทำงานคลาสสิก คุณสามารถเพิ่มบุคคลให้กับรายการสมาชิกและรายการผู้ดูแลระบบ ในพื้นที่ทำงานใหม่ คุณสามารถเพิ่มกลุ่มความปลอดภัย Active Directory รายการการแจกจ่าย หรือกลุ่ม Microsoft 365 หลายๆ กลุ่ม ไปยังรายการเหล่านี้เพื่อการจัดการผู้ใช้ที่ง่ายขึ้น
...
- **ผู้ใช้ที่ไม่มีสิทธิ์การใช้งาน Pro** สามารถเข้าถึงพื้นที่ทำงานได้ถ้าพื้นที่ทำงานอยู่ในความจุ Power BI Premium แต่เฉพาะเมื่อผู้ใช้มีบทบาทเป็นเพียงผู้ชมเท่านั้น
...
ฟีเจอร์ของพื้นที่ทำงาน OneDrive ช่วยให้คุณสามารถกำหนดค่าการเก็บไฟล์ SharePoint Document Library ในกลุ่ม Microsoft 365 และจะพร้อมใช้งานให้ผู้ใช้พื้นที่ทำงาน คุณได้สร้างกลุ่มภายนอก Power BI

Power BI จะไม่เชื่อมสิทธิ์ของผู้ใช้หรือกลุ่มผู้ใช้ที่มีการกำหนดค่าการเข้าถึงพื้นที่ทำงานด้วยการเป็นสมาชิกกลุ่ม Microsoft 365 วิธีที่ดีที่สุดคือการจัดการการเข้าถึงพื้นที่ทำงานผ่านทางเดียวกับกลุ่ม Microsoft 365 ที่คุณกำหนดค่าจัดเก็บไฟล์ในการตั้งค่านี้
...
บทบาทช่วยให้คุณจัดการว่าใครสามารถทำอะไรในพื้นที่ทำงาน เพื่อให้ทีมสามารถทำงานร่วมกัน พื้นที่ทำงานใหม่ช่วยให้คุณสามารถกำหนดบทบาทให้กับบุคคล และกลุ่มผู้ใช้: กลุ่มความปลอดภัย กลุ่ม Microsoft 365 และรายการการแจกจ่าย
...
หมายเลข GA ของประสบการณ์การใช้งานพื้นที่ทำงานใหม่จะเปลี่ยนชนิดของพื้นที่ทำงานเริ่มต้นเป็นประสบการณ์การใช้งานพื้นที่ทำงานใหม่เท่านั้น พื้นที่ทำงานแบบคลาสสิกที่มีอยู่ยังจะยึดตามกลุ่ม Microsoft 365 เหมือนเดิม

**พื้นที่ทำงานยังคงสร้างขึ้นสำหรับกลุ่ม Microsoft 365 โดยอัตโนมัติหรือไม่**

ใช่ เนื่องจากเรารองรับการทำงานร่วมกันของพื้นที่ทำงานทั้งสองแบบ เราจึงยังคงแสดงรายการกลุ่ม Microsoft 365 ทั้งหมดที่คุณสามารถเข้าถึงได้ในรายการพื้นที่ทำงาน
