...
หลังจากที่คุณสร้างโค้ดฝังตัวของ**การเผยแพร่บนเว็บ**ของคุณและแชร์ไฟล์ มีการอัปเดรายงานที่มีการเปลี่ยนแปลง และลิงก์โค้ดฝังตัวจะเปิดใช้งานทันที ทุกคนที่เปิดลิงก์สามารถดูได้ หลังจากการสร้างครั้งแรก การอัปเดตรายงานหรือภาพอาจใช้เวลาถึงสองชั่วโมงก่อนที่ผู้ใช้จะเห็น ข้อมูลถูกแคชในหนึ่งชั่วโมงจากเวลาที่จะถูกเรียกใช้ เราไม่แนะนำให้ใช้การเผยแพร่ไปยังเว็บสำหรับข้อมูลที่จำเป็นต้องรีเฟรชบ่อยครั้ง เมื่อต้องการเรียนรู้เพิ่มเติม ให้ดูหัวข้อ[**วิธีการทำงาน**](#howitworks)ในภายหลังในบทความนี้ 

### <a name="data-refresh"></a>การรีเฟรชข้อมูล

รีเฟรชข้อมูลเป็นภาพสะท้อนในรายงานแบบฝังตัวหรือแบบรูปภาพอัตโนมัติของคุณ อาจใช้เวลานานถึงสองชั่วโมงสำหรับการรีเฟรชข้อมูลเพื่อให้สามารถมองเห็นได้จากโค้ดแบบฝังตัว หากต้องการปิดการใช้งานรีเฟรชโดยอัตโนมัติ เลือก**อย่ารีเฟรช**ตามกำหนดการสำหรับชุดข้อมูลที่รายงานใช้  
