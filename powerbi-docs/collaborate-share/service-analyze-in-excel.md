...
## <a name="two-ways-to-get-started"></a>มีวิธีการเริ่มต้นสองวิธี
มีวิธีการที่แตกต่างกันสองวิธีในการสำรวจชุดข้อมูล Power BI ของคุณใน Excel - หากคุณกำลังเริ่มต้นจาก Power BI คุณจะต้องทำตามขั้นตอนที่ระบุไว้ในเอกสารนี้  นอกจากนี้ยังมีความสามารถสำหรับผู้ใช้ที่มีคุณสมบัติ Office SKU บางอย่างในการเข้าถึงชุดข้อมูลของตนเองโดยตรงจากประสบการณ์การรับข้อมูลใน Excel Workbook  พวกเขาสามารถเรียกดูชุดข้อมูลที่ตนเองมีสิทธิในการ์เข้าถึง เพื่อดูว่าชุดข้อมูลนั้นผ่านการรับรองหรือการเลื่อนระดับหรือไม่ และมีการใช้ป้ายกำกับการปกป้องข้อมูลแล้วหรือไม่  หากต้องการเรียนรู้เพิ่มเติมเกี่ยวกับประสบการณ์การใช้งานนี้ โปรดดูที่ [สร้าง PivotTable จากชุดข้อมูล Power BI](https://support.office.com/article/31444a04-9c38-4dd7-9a45-22848c666884) ในเอกสาร Excel
...
* ผู้ใช้ที่เป็นผู้เยี่ยมชมไม่สามารถใช้ **การวิเคราะห์ใน Excel** สำหรับชุดข้อมูลที่ส่งมาจากผู้เช่าอื่น 
...
## <a name="get-started-with-analyze-in-excel-in-power-bi"></a>เริ่มต้นใช้งานด้วยการวิเคราะห์ใน Excel ใน Power BI
