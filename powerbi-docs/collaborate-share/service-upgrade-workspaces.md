...
หลังจากอัปเกรด **OneDrive** ของพื้นที่ทำงานจะเชื่อมต่อกับไลบรารีเอกสาร SharePoint ของกลุ่ม Microsoft 365 ไลบรารีเอกสารจะแสดงเป็นตัวเลือก **OneDrive** ใน**รับข้อมูล > ไฟล์** โปรดทราบว่าผู้ใช้พื้นที่ทำงานบางรายอาจไม่ได้รับสิทธิ์การเช้าถึงไลบรารีเอกสารนั้น หากพวกเขาไม่ได้อยู่ในกลุ่ม Microsoft 365
...
1. ในรายการเนื้อหาพื้นที่ทำงาน ให้เลือก**ตัวเลือกเพิ่มเติม** ( **…** )  > **การตั้งค่าพื้นที่ทำงาน**
    ...
    ![การตั้งค่าพื้นที่ทำงาน](media/service-upgrade-workspaces/power-bi-workspace-settings-more-options.png)
...
2. ทำงานร่วมกับเจ้าของกลุ่ม Microsoft 365 แต่ละคน หรือกับผู้ดูแลระบบ Microsoft 365 ของคุณเพื่อให้พวกเขาอัปเกรดพื้นที่ทำงาน ถ้าคุณต้องการอัปเกรดพื้นที่ทำงาน คุณจะต้องเป็นเจ้าของกลุ่ม

ความสามารถในการอัปเกรดพื้นที่ทำงานจะไม่มีเครื่องมือสำหรับการอัปเกรดเป็นกลุ่มหรือทางโปรแกรม นอกจากนี้กลุ่ม Microsoft 365 ใหม่ที่สร้างขึ้นในองค์กรของคุณจะยังคงปรากฏใน Power BI
