...
| เปลี่ยนผู้ใช้แหล่งข้อมูลเกตเวย์ Power IB แล้ว |ระบบจะบันทึกกิจกรรมนี้ทุกครั้งที่มีการเปลี่ยนผู้ใช้ของเกตเวย์ (เพิ่ม/ลบ) |ชื่อเกตเวย์ เพิ่มผู้ใช้แล้ว ลบผู้ใช้แล้ว |
