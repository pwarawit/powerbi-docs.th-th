...
> [!NOTE]
> ดู[บทความนี้](https://docs.microsoft.com/power-bi/developer/api-rest-api-limitations) สำหรับข้อมูลขีดจำกัดของ **พุช** ว่าสามารถผลักข้อมูลได้มากเท่าใด
> 
> 
