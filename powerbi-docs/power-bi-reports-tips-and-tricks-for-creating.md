...
ถ้าเราโหลดชุดข้อมูลจากคำขอการสนับสนุนลูกค้าที่ใช้งานอยู่ และอีกชุดข้อมูลของรายการงานที่มี schema ดังต่อไปนี้:
...
เพื่อสร้างความสัมพันธ์ในกรณีนี้ เราจำเป็นต้องสร้างชุดข้อมูลตรรกะของ CustomerNames ทั้งหมดในชุดข้อมูลทั้งสองชุดนี้  ในแท็บคิวรี คุณสามารถใช้ลำดับต่อไปนี้ เพื่อสร้างชุดข้อมูลแบบตรรกะ:
