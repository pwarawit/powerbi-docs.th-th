...
คำถาม:  เหตุใดจึงไม่สามารถรวมเขตข้อมูลข้อความสำหรับแหล่งข้อมูล SSAS ได้?

คำตอบ:  ไม่อนุญาตให้ทำการเชื่อมต่อ SSAS MD แบบสดสำหรับการรวมฝั่งไคลเอ็นต์ใด ๆ ซึ่งรวมถึง ก่อน ล่าสุด ค่าเฉลี่ย ค่าต่ำสุด ค่าสูงสุด และผลรวม

คำถาม:  ฉันมีแผนภูมิกระจาย และฉันต้องการให้เขตข้อมูลของฉัน*ไม่*รวม  ฉันต้องทำอย่างไร?

คำตอบ:  เพิ่มเขตข้อมูลไปยังบักเก็ต**รายละเอียด** และไม่ใส่ในบักเก็ตแกน X หรือ Y
