...
![โหมดที่เก็บข้อมูลใน Power BI Desktop](media/desktop-storage-mode/storage-mode-01.png)
...
โหมดที่เก็บข้อมูล คือ คุณสมบัติที่คุณสามารถตั้งค่าแต่ละตารางในโมเดลของคุณได้ ตั้งค่าโหมดการจัดเก็บหรือดูค่าในปัจจุบันจากมุมมอง **โมเดล** โดยเลือกตารางที่มีคุณสมบัติที่คุณต้องการดูหรือกำหนด จากนั้นเลือกแถบคำสั่ง **คุณสมบัติ** แล้วขยายหัวข้อ **ขั้นสูง** แล้วขยายส่วนแสดงรายการ **โหมดการจัดเก็บ**

![คำสั่งคุณสมบัติในเมนูรายการตามบริบท](media/desktop-storage-mode/storage-mode-02.png)
