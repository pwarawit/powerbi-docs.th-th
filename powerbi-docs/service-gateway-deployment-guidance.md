...
เราแนะนำให้คุณเพิ่มที่อยู่ IP ในรายการที่อนุญาตสำหรับเขตข้อมูลของคุณไว้ในไฟร์วอลล์ คุณสามารถดาวน์โหลดรายการที่อยู่ IP ซึ่งพบได้ใน [ รายการ Microsoft Azure Datacenter IP ](https://www.microsoft.com/download/details.aspx?id=41653) รายการดังกล่าวได้รับการอัปเดตทุกสัปดาห์ เกตเวย์จะสื่อสารกับ **Azure Service Bus** โดยใช้ที่อยู่ IP ที่ระบุพร้อมกับชื่อโดเมนที่มีคุณสมบัติครบถ้วน (FQDN) ถ้าคุณกำลังบังคับให้เกตเวย์สื่อสารโดยใช้ HTTPS เกตเวย์จะใช้ FQDN อย่างเคร่งครัดเท่านั้นและจะไม่มีการสื่อสารโดยใช้ที่อยู่ IP เกิดขึ้น
