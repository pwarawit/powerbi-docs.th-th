...
* ใช้[พอร์ทัลผู้ดูแลระบบ Power BI](../service-admin-portal.md#power-bi-embedded-settings)
...
## <a name="embedding-setup-tool-for-embedding"></a>เครื่องมือตั้งค่าการฝังตัวสำหรับการฝังตัว
