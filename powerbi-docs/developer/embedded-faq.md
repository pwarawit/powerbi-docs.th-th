...
[Microsoft Power BI Embedded (PBIE)](azure-pbie-what-is-power-bi-embedded.md)อนุญาตให้นักพัฒนาแอปพลิเคชันฝังรายงานที่โต้ตอบได้อย่างน่าทึ่งลงในแอปพลิเคชัน โดยไม่ต้องเสียเวลาและค่าใช้จ่ายพัฒนาการแสดงภาพและการควบคุมของตัวเองใหม่ทั้งหมด

### <a name="who-is-the-target-audience-for-power-bi-embedded"></a>ใครคือกลุ่มเป้าหมายสำหรับ Power BI Embedded?

นักพัฒนาและบริษัทซอฟต์แวร์ที่สร้างแอปพลิเคชันของตนเองที่เรียกกันว่า ผู้จัดจำหน่ายซอฟต์แวร์อิสระ (ISV)
...
Microsoft แนะนำว่าองค์กรควรซื้อ Power BI Premium ซึ่งเป็นโซลูชัน BI บนระบบคลาวด์ ระดับองค์กร แบบบริการตนเอง และ ISV ควรซื้อ Power BI Embedded ซึ่งเป็นคอมโพเนนต์การวิเคราะห์แบบฝังตัวที่ทำงานด้วยคลาวด์ อย่างไรก็ตาม ไม่มีข้อจำกัดว่าลูกค้าสามารถซื้อผลิตภัณฑ์ใดได้บ้าง
...
โทเค็นแบบฝังตัวที่มีใบอนุญาต PRO มีไว้สำหรับทดสอบการพัฒนา ดังนั้น บัญชีหลัก Power BI หรือ[บริการหลัก](embed-service-principal.md) จึงสามารถสร้างจำนวนโทเค็นฝังตัวได้อย่างจำกัด [ซื้อความจุ](#technical)สำหรับการฝังตัวในสภาพแวดล้อมการทำงานจริง ไม่มีข้อจำกัดเกี่ยวกับจำนวนโทเค็นฝังตัวที่คุณสามารถสร้างขึ้นเมื่อซื้อความจุแล้ว ไปยัง[คุณลักษณะที่มี](https://docs.microsoft.com/rest/api/power-bi/availablefeatures) เพื่อตรวจสอบค่าการใช้งาน ที่สามารถบอกได้ว่าปัจจุบันมีการใช้งานฝังตัวแล้วกี่เปอร์เซ็นต์
...
PowerBI.com เป็นโซลูชันระดับองค์กรที่มีความสามารถมากมายเช่น การทำงานร่วมกันทางสังคม การสมัครใช้งานอีเมล และคุณสมบัติอื่น ๆ ในข้อเสนอของ Software as a Service
...
* ลงชื่อเข้าใช้ไดเรกทอรีขององค์กรของคุณ (บัญชีผู้ใช้ MSA จะไม่ได้รับการสนับสนุน)
...
### <a name="can-my-capacity-scale-automatically-to-adjust-to-the-consumption-of-my-app"></a>ความจุของฉันสามารถปรับตามปริมาณการใช้แอปของฉันได้ตามอัตโนมัติหรือไม่
...
### <a name="what-is-supported-by-the-cloud-solution-provider-csp-channel"></a>สิ่งที่ได้รับการสนับสนุนจาก Cloud Solution Provide (CSP) คืออะไร
...
หากต้องการ [เลื่อนระดับโซลูชันของคุณเป็นการผลิต](embed-sample-for-customers.md#move-to-production) คุณต้องมีเนื้อหา Power BI (พื้นที่ทำงานแอป) ที่กำลังใช้ในแอปพลิเคชันของคุณเพื่อมอบหมายความจุ Power BI Embedded (A SKU)
...
การรับรองความถูกต้องและการอนุญาตของผู้ใช้แอปพลิเคชัน จะพัฒนาโดย ISV โดยที่ ISV สามารถสร้างการรับรองความถูกต้องสำหรับแอปพลิเคชันของพวกเขา
...
ถือเป็นโฟลว์ในนามของผู้ใช้ OAuth มาตรฐาน (<https://docs.microsoft.com/azure/active-directory/develop/web-api>) แอปพลิเคชันจำเป็นต้องกำหนดค่าเพื่อรับสิทธิ์ในบริการของ Power BI (ตามขอบเขตที่ต้องการ) เมื่อมีโทเค็นผู้ใช้ในแอปแล้ว คุณเพียงแค่ใช้โทเค็นการเข้าใช้ของผู้ใช้เรียกไปยัง API AcquireTokenAsync ADAL และระบุ URL ทรัพยากร Power BI เป็น ทรัพยากร ID  ดูส่วนย่อยโค้ดที่แสดงวิธีดำเนินการต่อไปนี้:
...
ISV/นักพัฒนาต้องมีบัญชี Power BI ก่อนที่จะซื้อ Power BI Embedded ใน Azure ภูมิภาคการปรับใช้งาน Power BI Embedded ของคุณจะกำหนดบัญชี Power BI ของคุณ จัดการทรัพยากร Power BI Embedded ของคุณใน Azure เพื่อ:
...
เมื่อคุณเปิดใช้งาน[บริการหลัก](embed-service-principal.md)ที่จะใช้กับ Power BI สิทธิ์ AD ของแอปพลิเคชันไม่มีผลบังคับใช้อีกต่อไป มีจัดการสิทธิ์ของแอปพลิเคชันแล้วผ่านทางพอร์ทัลผู้ดูแลระบบ Power BI
...
นักพัฒนาใด ๆ ที่จำเป็นต้องใช้ REST API ต้องมีใบอนุญาต Power BI Pro หรือ[บริการหลัก](embed-service-principal.md) นักวิเคราะห์ใด ๆ ที่จำเป็นต้องเพิ่มรายงานไปยังพื้นที่ทำงาน Power BI จำเป็นต้องมีใบอนุญาต Power BI Pro หรือใช้บริการหลัก ผู้ดูแลระบบผู้เช่าใด ๆ ที่จำเป็นต้องจัดการผู้เช่า Power BI และความจุจำเป็นต้องมีสิทธิ์การใช้งาน Power BI Pro

เนื่องจาก Power BI Embedded อนุญาตให้ใช้พอร์ทัล Power BI สำหรับการจัดการ และตรวจสอบเนื้อหาแบบฝังตัว ใบอนุญาต Power BI Pro เป็นสิ่งจำเป็นเพื่อรับรองความถูกต้องแอปภายใน PowerBI.com เพื่อเข้าถึงรายงานในที่เก็บข้อมูลที่ถูกต้อง
...
แต่นั่นหมายความว่า คุณสมบัติใหม่จะไม่ถูกเพิ่มไปยังโซลูชัน**คอลเลกชันพื้นที่ทำงานของ Power BI** และลูกค้าจะได้รับการแนะนำให้วางแผนการย้ายไปยังโซลูชัน **Power BI Embedded** ใหม่
...
มีการแนะนำคุณสมบัติใหม่บางอย่างและความจุในโซลูชัน **Power BI Embedded** ที่คุณไม่สามารถทำได้ด้วย**คอลเลกชันพื้นที่ทำงานของ Power BI**
