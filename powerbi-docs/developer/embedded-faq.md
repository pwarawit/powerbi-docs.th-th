...
หากต้องการ [โปรโมตโซลูชันของคุณไปยังการผลิต](https://docs.microsoft.com/power-bi/developer/embedding-content#step-3-promote-your-solution-to-production) คุณต้องมีเนื้อหา Power BI (พื้นที่ทำงานแอปที่คุณใช้ในแอปพลิเคชันของคุณเพื่อกำหนดความจุ Power BI Embedded (A SKU)
...
เมื่อต้องการอ้างอิงบริการหลักสำหรับการดำเนินการ หรือทำการเปลี่ยนแปลงที่คุณใช้**[ID ออบเจ็กต์ของบริการหลัก](embed-service-principal.md#how-to-get-the-service-principal-object-id)** — เช่น การใช้บริการหลักเป็นผู้ดูแลระบบในพื้นที่ทำงาน
