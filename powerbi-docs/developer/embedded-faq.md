...
| อาร์ทิแฟกต์แบบฝังตัวจากพื้นที่ทำงานแอป Power BI | ใช่ | ใช่ | ใช่ |
| ใช้รายงาน Power BI ในแอปพลิเคชันแบบฝังตัว - SaaS | ไม่ใช่ | ใช่ | ใช่ |
| ใช้รายงาน Power BI ในแอปพลิเคชันแบบฝังตัว - PaaS | ใช่ | ใช่ | ใช่ |
