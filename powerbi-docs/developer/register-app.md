...
5. ทำตามพร้อมท์และสร้างแอปพลิเคชัน์ใหม่
   ...
   * สำหรับแอปพลิเคชันบนเว็บ ให้ใส่ URL ลงชื่อเข้าระบบ ซึ่งเป็น URL พื้นฐานของแอปของคุณที่ผู้ใช้สามารถลงชื่อเข้าใช้ เช่น http://localhost:13526
   * สำหรับแอปพลิเคชันดั้งเดิม ให้ใส่ URL ที่เปลี่ยนเส้นทางซึ่ง Azure AD ใช้เพื่อส่งกลับการตอบสนองโทเค็น ใส่ค่าเฉพาะเจาะจงกับแอปพลิเคชัน เช่น http://myapplication/redirect
