...
5. ถ้าคุณเลือก**แอปพลิเคชันเว็บฝั่งเซิร์ฟเวอร์**สำหรับชนิดแอปพลิเคชัน จากนั้นดำเนินการต่อเนื่องโดยการใส่ค่าสำหรับ **URL โฮมเพจ** และ **URL เปลี่ยนเส้นทาง** การ**URL เปลี่ยนเส้นทาง**ทำงานกับ URL ถูกต้อง และควรตรงกับแอปพลิเคชันที่คุณสร้าง ถ้าคุณเลือก**ดั้งเดิม**ดำเนินการต่อในขั้นตอนที่ 6
...
7. ถ้าคุณเลือก**ดั้งเดิม**สำหรับชนิดแอปพลิเคชัน แล้วคุณจะได้แอ**ID แอปพลิเคชัน** ถ้าคุณเลือก**แอปเว็บฝั่งเซิร์ฟเวอร์**สำหรับชนิดของแอปพลิเคชัน แล้วคุณได้รับ**ID แอปพลิเคชัน**และ**ข้อมูลลับของแอปพลิเคชัน**
...
4. ในบานหน้าต่างนำทางด้านซ้าย ไป**บริการทั้งหมด**เลือก**ลงทะเบียนแอป**แล้ว เลือก**ลงทะเบียนใหม่**

5. ทำตามพร้อมท์และสร้างแอปพลิเคชัน์ใหม่

   สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการลงทะเบียนแอปพลิเคชันใน Azure Active Directory ดู[ลงทะเบียนแอ ด้วย Azure Active Directory](https://docs.microsoft.com/azure/active-directory/develop/quickstart-v2-register-an-app)
...
2. เลือก**สิทธิ์ API**ภายใต้**จัดการ**

3. ภายใน**สิทธิ์ API**เลือก**เพิ่มสิทธิ์**แล้วเลือก**บริการ Power BI**

    ![การอนุญาตของแอป 03](media/register-app/powerbi-embedded-azuread-app-permissions03.png)

4. เลือกสิทธิ์เฉพาะที่คุณต้องการภายใต้**มอบหมายสิทธิ์** เลือกทีละตัวเลือกเพื่อบันทึกการเลือก เลือก**บันทึก**เมื่อทำเสร็จแล้ว

5. เลือก**อนุญาตการยินยอม**

    การ**อนุญาตการยินยอม**การดำเนินการที่จำเป็นสำหรับการ*บัญชีหลัก*เพื่อหลีกเลี่ยงการถูกพร้อมท์สำหรับการยินยอม โดย Azure AD ถ้าบัญชีที่ดำเนินการนี้เป็นผู้ดูแลระบบส่วนกลาง คุณมอบสิทธิ์ให้แก่ผู้ใช้ทั้งหมดภายในองค์กรของคุณสำหรับแอปพลิเคชันนี้ ถ้าบัญชีที่ดำเนินการนี้เป็น*บัญชีผู้ใช้หลัก* และไม่ใช่ผู้ดูแลระบบส่วนกลาง คุณจะให้สิทธิ์*บัญชีหลัก*สำหรับแอปพลิเคชันนี้เท่านั้น
...
4. ให้สิทธิ์แอปไปยัง Power BI API
   ...
   * **Principal** จะใช้เพื่อให้สิทธิ์ในนามของผู้ใช้ที่ระบุ ในกรณีนี้ ควรเพิ่มอีกคุณสมบัติหนึ่งลงในเนื้อความของการร้องขอ - *principalId={User_ObjectId}*
    ...
    **resourceId** *c78a3685-1ce7-52cd-95f7-dc5aea8ec98e* ไม่ใช่สากล แต่จะขึ้นอยู่กับผู้เช่า ค่านี้คือ objectId ของแอปพลิเคชัน "บริการของ Power BI" ในผู้เช่า Azure Active Directory (AAD)
...
5. ให้สิทธิ์แอปกับ Azure Active Directory (AAD)
   ...
   * **AllPrincipals**สามารถใช้ได้เฉพาะ โดยผู้ดูแลผู้เช่าการให้สิทธิ์สำหรับผู้ใช้ทั้งหมดในผู้เช่าได้
