...
4. ในบานหน้าต่างนำทางด้านซ้าย **บริการทั้งหมด**, **Azure Active Directory** เลือก**ลงทะเบียนแอป**แล้ว เลือก**ลงทะเบียนแอปพลิเคชันใหม่**

    ![ลงทะเบียนแอปใหม่](media/register-app/azuread-new-app-registration.png)

5. ทำตามพร้อมท์และสร้างแอปพลิเคชัน์ใหม่

   * สำหรับแอปพลิเคชันเว็บ ให้ใส่ URL ลงชื่อเข้าระบบ ซึ่งเป็น URL พื้นฐานของแอปคุณที่ผู้ใช้สามารถลงชื่อเข้าใช้ (เช่น `http://localhost:13526`).
