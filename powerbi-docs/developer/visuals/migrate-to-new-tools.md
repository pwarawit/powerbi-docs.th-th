...
* ลบขนาดแพ็คเกจ Webpack ใช้ [Tree Shaking](https://webpack.js.org/guides/tree-shaking/) เพื่อลบโค้ดที่ไม่ใช่ออก ซึ่งจะลดโค้ดของ JS และทำให้คุณจะโหลดวิชวลได้อย่างมีประสิทธิภาพมากขึ้น
...
ปละคุณยังเปลี่ยนตัวเลือก `target` เป็น `ES6` ได้หากต้องการใช้ JavaScript ที่ทันสมัยเป็นเอาท์พุต [ไม่บังคับ](https://github.com/Microsoft/PowerBI-visuals-sampleBarChart/blob/sample-next/tsconfig.json#L6)
...
`npm install --save d3@5` สำหรับติดตั้ง D3.js ใหม่

`npm install --save-dev @types/d3@5` สำหรับติดตั้งการกำหนดประเภทใหม่ของ D3.js
...
เริ่มจากเครื่องมือเวอร์ชัน 3.1 ใช้ Babel เพื่อรวบรวมโค้ด JS ที่สมัยแบบใหม่เป็น ES5 เก่าเพื่อรองรับเบราว์เซอร์ที่หลากหลาย
...
สุดท้ายให้เรียกใช้ [webpack-visualizer](https://github.com/chrisbateman/webpack-visualizer) เพื่อแสดงฐานโค้ดของวิชวล  
