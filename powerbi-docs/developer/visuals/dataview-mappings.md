...
มีอัลกอริธึมการลดมิติข้อมูลยอดนิยมที่ใช้กับ *count* ซึ่งตั้งค่าเป็นจุดข้อมูล 1,000 จุด ซึ่งเหมือนกับการตั้งค่าคุณสมบัติต่อไปนี้ในไฟล์ *capabilities.json*:
...
คุณสามารถแก้ไขค่า *count* เป็นค่าจำนวนเต็มใดก็ตามได้สูงถึง 30000 วิชวลแบบกำหนดเองที่ใช้ภาษา R สามารถรองรับได้ถึง 150000 แถว
