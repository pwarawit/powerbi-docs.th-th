...
> [!NOTE]
> ถ้าการรับรองความถูกต้องโทเค็น App-Only เป็นข้อกำหนดสำหรับแอปพลิเคชันของคุณ โปรดคลิก[ที่นี่](mailto:pbieci@microsoft.com?Subject=App-only%20token%20requirement)เพื่อติดต่อเรา
>
