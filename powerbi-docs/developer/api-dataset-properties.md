...
ชนิดข้อมูล     |  สตริง       |  [ชนิดข้อมูล EDM](https://msdn.microsoft.com/library/ee382832.aspx)ที่ได้รับการสนับสนุนและข้อจำกัด ดู[ข้อจำกัดชนิดของข้อมูล](#DataTypeRestrictions)      |  เป็นเท็จ       | จริง        
