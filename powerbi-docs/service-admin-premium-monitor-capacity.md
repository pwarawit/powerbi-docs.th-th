...
แอปถูกอัปเดตตามปกติด้วยคุณสมบัติและฟังก์ชันการทำงานใหม่ ๆ ตรวจสอบให้แน่ใจว่า คุณกำลังใช้เวอร์ชันล่าสุด ถ้าคุณได้ติดตั้งแอปเวอร์ชันก่อนหน้าแล้ว แนะนำให้ลบออกจากแอปของคุณแล้ว กด CTRL + F5 เพื่อรีเฟรช 
...
#### <a name="ai-summary"></a>สรุป AI

| เมตริก | คำอธิบาย |
| --- | --- |
| การรีเฟรชทั้งหมด | จำนวนทั้งหมดของการรีเฟรชในช่วง 7 วันที่ผ่านมา |
| ความน่าเชื่อถือของการรีเฟรช (%) | จำนวนครั้งที่รีเฟรชสำเร็จหารด้วยจำนวนทั้งหมดของการรีเฟรชใน 7 วันที่ผ่านมา |
| CPU สูงสุด (%)| ปริมาณการใช้ CPU สูงสุดตามปริมาณงาน AI ใน 7 วันที่ผ่านมา |
| หน่วยความจำสูงสุด (GB) | สูงสุดหน่วยความจำปริมาณการใช้ โดยปริมาณงาน AI ใน 7 วันที่ผ่านมา|
| รีเฟรชเวลารอสูงสุด (MS) | ระยะเวลาก่อนที่เริ่มการรีเฟรชสูงสุด |
| เวลารอเฉลี่ยรีเฟรช (MS)| ระยะเวลาก่อนที่เริ่มการรีเฟรชโดยเฉลี่ย |
| รีเฟรชระยะเวลาสูงสุด (MS) | ระยะเวลาการรีเฟรชเสร็จสมบูรณ์สูงสุด |
| รีเฟรชระยะเวลาเฉลี่ย (MS)| ระยะเวลาการรีเฟรชเสร็จสมบูรณ์โดยเฉลี่ย |
| | |
...
| **ส่วนรายงาน** | **การวัด** |
| --- | --- |
| การใช้งานโดยรวม | จำนวนทั้งหมด: จำนวนของฟังก์ชัน AI ในพื้นที่ทำงานหรือ dataflow <br> ความน่าเชื่อถือ: เปอร์เซ็นต์ของการรีเฟรชที่เสร็จสมบูรณ์<br> ค่าเฉลี่ย เวลารอ: ช่วงห่างเฉลี่ยระหว่างเวลาที่กำหนดไว้และเริ่มต้นของการรีเฟรช มิลลิวินาที<br> เวลารอสูงสุด: สูงสุดรอเวลา มิลลิวินาที<br> ค่าเฉลี่ย ระยะเวลา: ระยะเวลาเฉลี่ยของการรีเฟรช มิลลิวินาที<br> ระยะเวลาสูงสุด: ระยะเวลาของการรีเฟรชรันนานที่สุด มิลลิวินาที<br> ขนาดของข้อมูลป้อนเข้าโดยเฉลี่ย: ค่าเฉลี่ยป้อนขนาด ไบต์ สำหรับฟังก์ชัน AI ดำเนินการ โดยการรีเฟรช dataflow<br> ขนาดโดยเฉลี่ยผลลัพธ์: ค่าเฉลี่ยผลลัพธ์ขนาด ไบต์ สำหรับฟังก์ชัน AI ดำเนินการ โดยการรีเฟรช dataflow |
| ฟังก์ชัน AI 5 อันดับสูงสุดตามระยะเวลาเฉลี่ย | ฟังก์ชันห้า มีระยะเวลานานที่สุดโดยเฉลี่ยรีเฟรช มิลลิวินาที |
| ฟังก์ชัน AI 5 อันดับสูงสุดตามขนาดที่ป้อนโดยเฉลี่ย | ฟังก์ชันห้า ด้วยข้อมูลมากที่สุดโดยเฉลี่ยป้อนขนาด เป็นไบต์ |
| จำนวนการรีเฟรชรายชั่วโมงและการใช้หน่วยความจำ | ความสำเร็จ ความล้มเหลว และปริมาณการใช้หน่วยความจำ ซึ่งแยกเป็นบักเก็ตหนึ่งชั่วโมงรายงานตามเวลา UTC |
| เวลาระยะเวลาเฉลี่ยต่อชั่วโมง | ระยะเวลาเฉลี่ยของการรีเฟรช แยกเป็นกลุ่มหนึ่งชั่วโมง รายงานในเวลา UTC |
| | |
...
1. คลิก**ควบคุมการเข้าถึง (IAM)** และจากนั้นเพิ่มแอป **"Power BI Premium"** ให้กับบทบาทผู้อ่าน ถ้าคุณไม่สามารถค้นหาแอตามชื่อ คุณยังสามารถเพิ่มได้ โดยระบุไคลเอ็นต์:`cb4dc29f-0bf4-402a-8b30-7511498ed654`ได้
