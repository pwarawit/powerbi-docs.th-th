...
รายงานมี 3 แท็บ ดังจะอธิบายรายละเอียดเพิ่มเติมในส่วนด้านล่าง

* **ตัวกรองที่นำไปใช้กับทุกหน้า**: ช่วยให้คุณกรองหน้าอื่นๆ ในรายงานไปยังความจุเฉพาะได้
* **ชุดข้อมูล**: แสดงรายละเอียดการวัดสถานภาพของชุดข้อมูลภายในความจุของคุณ
* **ระบบ**: มอบการวัดความจุโดยรวม ซึ่งรวมถึงหน่วยความจำและการใช้ CPU แบบสูง 

### <a name="filters-applied-to-all-pages-tab"></a>ตัวกรองที่นำไปใช้กับทุกหน้า

แท็บ**ตัวกรองที่นำไปใช้กับทุกหน้า** ช่วยให้คุณสามารถเลือกความจุ, ชุดข้อมูล และช่วงวันภายใน 7 วันที่ผ่านมา จากนั้นตัวกรองจะถูกนำไปใช้กับหน้าและไทล์ที่เกี่ยวข้องในรายงาน หากไม่ได้เลือกตัวกรอง รายงานเริ่มต้นจะแสดงผลการวัดของสัปดาห์ที่ผ่านมาบนความจุทุกอันที่คุณเป็นเจ้าของ

![แท็บตัวกรอง](media/service-admin-premium-monitor-capacity/filters-tab.png)

### <a name="datasets-tab"></a>แท็บชุดข้อมูล

แท็บ **ชุดข้อมูล** ให้ความจุของการวัดในแอป ใช้ปุ่มทั้งสี่ที่ด้านบนของแท็บเพื่อนำทางไปยังส่วนต่างๆ: **สรุป**, **รีเฟรช**, **คิวรี** และ **ชุดข้อมูล**

![แท็บชุดข้อมูล](media/service-admin-premium-monitor-capacity/datasets-tab.png)

#### <a name="summary-area"></a>ส่วนสรุป

![ปุ่มสรุป](media/service-admin-premium-monitor-capacity/summary-button.png)

ส่วน **สรุป** จะแสดงมุมมองความจุของคุณโดยยึดตามเอนทิตี, ทรัพยากรระบบ และปริมาณงานชุดข้อมูล
...
![ปุ่มรีเฟรช](media/service-admin-premium-monitor-capacity/refreshes-button.png)

ส่วน **รีเฟรช** จะแสดงรายการรีเฟรชที่เสร็จสมบูรณ์, การวัดความสำเร็จ, เวลารอรีเฟรชเฉลี่ย /สูงสุด และระยะเวลารีเฟรชเฉลี่ย/สูงสุดที่ถูกแบ่งออกเป็นส่วนๆ โดยชุดข้อมูลใน 7 วันที่ผ่านมา สองแผนภูมิด้านล่างแสดงการรีเฟรชเทียบกับปริมาณการใช้หน่วยความจำเป็น GB และเวลารอเฉลี่ยที่ถูกแยกเป็นบักเก็ตหนึ่งชั่วโมง โดยรายงานในเวลาท้องถิ่น แผนภูมิแท่งด้านบนแสดงชุดข้อมูลห้าชุดแรกที่ใช้เวลารีเฟรชเสร็จสมบูรณ์เฉลี่ย (ระยะเวลารีเฟรช) และเวลารอรีเฟรชเฉลี่ย เวลารอการรีเฟรชสูงหลายๆครั้งแสดงว่าความจุกำลังถูกเรียกใช้งานอย่างมาก

#### <a name="queries-area"></a>ส่วนคิวรี

![ปุ่มคิวรี](media/service-admin-premium-monitor-capacity/queries-button.png)

ส่วน **คิวรี** จะแสดงจำนวนทั้งหมดที่เรียกใช้คิวรี, จำนวนทั้งหมดของคิวรีที่รอนับสำหรับคิวรีสด/โดยตรง, ระยะเวลาเฉลี่ย/สูงสุด, เวลารอเฉลี่ย/สูงสุดในมิลลิวินาทีที่ถูกแบ่งออกเป็นส่วนๆโดยชุดข้อมูล, พื้นที่ทำงาน และชั่วโมงบักเก็ตในช่วง 7 วันที่ผ่านมา แผนภูมิด้านล่างแสดงการนับคิวรี, ระยะเวลาเฉลี่ย (ในมิลลิวินาที) และเวลารอเฉลี่ย (ในมิลลิวินาที) เทียบกับปริมาณการใช้หน่วยความจำเป็น GB ที่ถูกแยกเป็นบักเก็ตหนึ่งชั่วโมงซึ่งแสดงในเวลาท้องถิ่น สองแผนภูมิในส่วนบนด้านขวาจะแสดง 5 ชุดข้อมูลแรกตามระยะเวลาคิวรีเฉลี่ย และเวลารอเสร็จสิ้นการดำเนินการคิวรี ระยะเวลาคิวรีและเวลารอที่ยาวนานบ่งชี้ความจุที่ถูกเรียกใช้อย่างมาก ซึ่งอาจหมายความถึงชุดข้อมูลเดียว กำลังก่อปัญหาและต้องได้รับการตรวจสอบ

#### <a name="datasets-area"></a>ส่วนชุดข้อมูล

![ปุ่มชุดข้อมูล](media/service-admin-premium-monitor-capacity/datasets-button.png)

ส่วน **ชุดข้อมูล** จะแสดงชุดข้อมูลทั้งหมดที่ลดลงเนื่องจากแรงกดดันต่อหน่วยความจำที่คิดเป็นชั่วโมง

### <a name="system-tab"></a>แท็บระบบ

แท็บ **ระบบ** จะแสดงจำนวนครั้งการใช้ CPU (จำนวนครั้งที่เกิน 80%), การเชื่อมต่อสด/คิว รีโดยตรง และปริมาณการใช้หน่วยความจำสูง

![รายงานระบบ premium](media/service-admin-premium-monitor-capacity/system-tab.png)
