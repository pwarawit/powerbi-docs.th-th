...
**เวอร์ชันล่าสุดของแอปคือ 1.10.1.2 (22 กุมภาพันธ์ 2019)**   
...
หลังจากที่คุณติดตั้งแอป คุณสามารถดูการวัดความจุในองค์กรของคุณ แอปมีการให้[แดชบอร์ด](#Dashboard)ที่สรุปเป็นเมตริกและ[รายงาน](#Reports)เมตริกโดยละเอียด
...
| คิวรีโดยตรง/เวลาที่เกิดขึ้นสูงสุดแบบไลฟ์สด | เวลาท้องถิ่นที่มีคิวรีโดยตรง/การเชื่อมต่อแบบไลฟ์สดเกิน 80% มากที่สุดในหนึ่งชั่วโมง |
...
| จำนวนการรีเฟรชรายชั่วโมงและปริมาณการใช้หน่วยความจำ (GB) |  ความสำเร็จ ความล้มเหลว และปริมาณการใช้หน่วยความจำ แยกเป็นกลุ่มหนึ่งชั่วโมง รายงานตามเวลาท้องถิ่น |
| เวลารอการรีเฟรชเฉลี่ยรายชั่วโมง (นาที) |  เวลารอการรีเฟรชเฉลี่ย แยกเป็นกลุ่มหนึ่งชั่วโมง รายงานตามเวลาท้องถิ่น เวลารอการรีเฟรชสูงหลายๆ ครั้งแสดงว่าความจุกำลังทำงานอย่างหนัก |
|  |  |
...
| คิวรีตรง / การเชื่อมต่อแบบไลฟ์สด (การใช้งาน > 80%) |  เวลาที่คิวรีตรงหรือการเชื่อมต่อแบบสดใช้เกิน 80% ของการใช้งาน CPU แยกเป็นกลุ่มหนึ่งชั่วโมง รายงานตามเวลาท้องถิ่น |
|  |  |
...
| การกระจายเวลารอคิวรีรายชั่วโมง |  จำนวนการรอคิวรีและเวลารอเฉลี่ย (หน่วยเป็นมิลลิวินาที) ต่อปริมาณการใช้หน่วยความจำในหน่วย GB แยกเป็นกลุ่มหนึ่งชั่วโมง รายงานตามเวลาท้องถิ่น |
|  |  |
...
| ระยะเวลารายชั่วโมง |  การค้นคืนข้อมูลกับเวลาการประมวลผลและการแสดง แยกเป็นกลุ่มหนึ่งชั่วโมง รายงานตามเวลาท้องถิ่น |
|  |  |
...
| เวลารอการรีเฟรชโดยเฉลี่ยรายชั่วโมง |  เวลารอการรีเฟรชเฉลี่ย แยกเป็นกลุ่มหนึ่งชั่วโมง รายงานตามเวลาท้องถิ่น เวลารอการรีเฟรชสูงหลายๆ ครั้งแสดงว่าความจุกำลังทำงานอย่างหนัก |
| จำนวนการรีเฟรชรายชั่วโมงและการใช้หน่วยความจำ |  ความสำเร็จ ความล้มเหลว และปริมาณการใช้หน่วยความจำ แยกเป็นกลุ่มหนึ่งชั่วโมง รายงานตามเวลาท้องถิ่น |
|  |  |
...
| การใช้หน่วยความจำ |  ปริมาณการใช้หน่วยความจำในหน่วย GB ตามปริมาณงาน (เส้นทึบ) ซ้อนทับกับขีดจำกัดปริมาณงาน (เส้นประ) แสดงเป็นรายชั่วโมงสำหรับช่วงเจ็ดวันก่อนหน้า |
|  |  |
...
1. คลิก**ควบคุมการเข้าถึง (IAM)** และจากนั้นเพิ่มแอป **"Power BI Premium"** ให้กับบทบาทผู้อ่าน ถ้าคุณไม่สามารถค้นพบแอปด้วยชื่อ คุณยังสามารถเพิ่มแอปได้ด้วย ID ของไคลเอ็นต์:`cb4dc29f-0bf4-402a-8b30-7511498ed654`
