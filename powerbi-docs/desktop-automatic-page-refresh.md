...
ms.locfileid: "72307995"
---
# <a name="automatic-page-refresh-in-power-bi-desktop-preview"></a>การรีเฟรชหน้าอัตโนมัติใน Power BI Desktop (ตัวอย่าง)

เป็นสิ่งสำคัญสำหรับข้อมูลที่จะได้รับการรีเฟรชทันทีที่แหล่งข้อมูลได้รับการอัปเดตเมื่อตรวจสอบเหตุการณ์ที่สำคัญ ตัวอย่างเช่นในอุตสาหกรรมการผลิตเป็นสิ่งสำคัญที่ต้องทราบเมื่อเครื่องชำรุดหรือใกล้ถึงเวลาสำหรับซ่อมบำรุง
...
สำหรับช่วงเวลาการรีเฟรชต่ำเช่นหนึ่งวินาที คุณควรพิจารณาชนิดของแหล่งข้อมูลแบบสอบถามโดยตรงเช่นการโหลดคิวรีของคุณสร้างขึ้นบนระยะห่างของผู้ชมรายงานของคุณจากศูนย์ข้อมูลของความจุและอื่นๆ 
...
ลองพิจารณาคุณลักษณะอื่นๆเกี่ยวกับแหล่งข้อมูลนี้ 
...
ตารางด้านล่างจะอธิบายรายละเอียดเพิ่มเติมที่คุณลักษณะนี้พร้อมใช้งานและขีดจำกัดสำหรับแต่ละชนิดความจุและ [โหมดการจัดเก็บข้อมูล](whitepaper-powerbi-premium-deployment.md#model-storage-modes)
