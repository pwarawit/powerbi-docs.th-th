...
และคุณยังสามารถเปลี่ยน หรือ*แปลง*คอลัมน์เหล่านั้นจากข้อความเป็นหัวข้อโดยใช้ Ribbon **แปลง** ได้ นี่คือ Ribbon การแปลง** ที่มีลูกศรชี้ไปยังปุ่มชนิดข้อมูล ซึ่งช่วยให้คุณแปลงชนิดข้อมูลปัจจุบันให้เป็นชนิดอื่นได้
...
ในกรณีนี้ เราต้องการผสานคิวรี่ เมื่อต้องการเริ่มต้นใช้งาน เราเลือกแบบคิวรี่ที่เราต้องการให้ผสานรวมกับแบบสอบถามอื่น จากนั้นลือกผสานคิวรี่จากแท็บ**หน้าแรกบน Ribbon
...
ในกรณีนี้ เราเพียงแค่ต้องการคอลัมน์*รหัสรัฐ* ดังนั้นเราจึงเลือกเพียงคอลัมน์นั้น แล้วจึงเลือกตกลง เรายกเลิกการเลือกกล่องข้อความจาก **ใช้ชื่อคอลัมน์เดิมเป็นคำนำหน้า** เนื่องจากเราไม่จำเป็นต้องมีหรือไม่ต้องการ ถ้าเรายังเลือกกล่องข้อความนั้นอยู่ คอลัมน์ที่ผสานแล้วจะมีชื่อว่า *NewColumn.State Code* (ชื่อคอลัมน์เดิมหรือ *NewColumn* แล้วจุด จากนั้นเป็นชื่อของคอลัมน์ที่นำเข้ามายังคิวรี่)
