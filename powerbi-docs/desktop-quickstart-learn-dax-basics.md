...
3. หลังจากเครื่องหมายเท่ากับ พิมพ์ตัวอักษรแรก 2-3 **CAL**แล้ว คลิกสองครั้งที่ฟังก์ชันที่คุณต้องการใช้ ในสูตรนี้ คุณต้องการใช้ฟังก์ชัน**CALCULATE**
...
4. หลังจากวงเล็บเปิด **(** สำหรับฟังก์ชัน**CALCULATE** พิมพ์**SUM**ตามด้วยวงเล็บเปิดอื่น **(** ตอนนี้ เราจำเป็นต้องส่งผ่านอาร์กิวเมนต์ไปยังฟังก์ชัน SUM

5. เริ่มพิมพ์**Sal** แล้วเลือก**ขาย [SalesAmount]** ตาม ด้วยวงเล็บปิด **)** นี่เป็นอาร์กิวเมนต์นิพจน์แรกสำหรับฟังก์ชัน CALCULATE ของเรา
    
6. พิมพ์เครื่องหมายจุลภาค (**,**) ตามด้วยช่องว่างเพื่อระบุตัวกรองแรก จากนั้นพิมพ์ **PREVIOUSQUARTER** ซึ่งจะเป็นตัวกรองของเรา
    
   คุณจะใช้ฟังก์ชันตัวแสดงเวลา PREVIOUSQUARTER เพื่อกรองผลลัพธ์ SUM ของเราตามไตรมาสก่อนหน้า
    
7. หลังวงเล็บเปิด **(** สำหรับฟังก์ชัน PREVIOUSQUARTER พิมพ์ **Calendar[DateKey]**
