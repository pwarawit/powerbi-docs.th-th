...
* **โมเดลแบบรวม**: อนุญาตให้รายงานมีการเชื่อมต่อข้อมูลหลายแบบ รวมถึงการเชื่อมต่อ DirectQuery หรือการนำเข้า ในรูปแบบใดๆ ก็ตาม บทความนี้จะอธิบายโมเดลแบบรวมโดยละเอียด
...
เมื่อใช้ DirectQuery *โมเดลแบบรวม* คุณสามารถสร้างโมเดลของ Power BI model (เช่นไฟล์ Power BI Desktop *.pbix* เดี่ยวๆ) ที่สามารถทำได้หนึ่งหรือทั้งสองอย่างดังนี้:
...
> [!NOTE]
> เริ่มตั้งแต่การเผยแพร่ เดือนตุลาคม 2018 ของ Power BI Desktop คุณ *สามารถ* เผยแพร่โมเดลแบบรวมไปยังบริการของ Power BI สำหรับกำหนดการรีเฟรชและแดชบอร์ดการรีเฟรชแดชบอร์ดไทล์ โมเดลแบบรวมในบริการของ Power BI service ทำงานแบบเดียวกับโมเดลนำเข้า 

คุณสามารถสร้างความสัมพันธ์ระหว่างตารางได้เช่นเคย แม้ว่าตารางนั้นจะมาจากคนละแหล่งที่มากัน โดยมีข้อจำกัดต่อไปนี้: ความสัมพันธ์ใดที่ข้ามแหล่งที่มาจะต้องกำหนดให้เป็นคาร์ดินาลลิตี้ของ *กลุ่ม-ต่อ-กลุ่ม* โดยไม่คำนึงคาร์ดินาลลิตี้จริงของตาราง การทำงานของความสัมพันธ์เช่นนี้เหมือนกับความสัมพันธ์แบบ *กลุ่ม-ต่อ-กลุ่ม* ดังที่อธิบายไว้ใน [ความสัมพันธ์แบบกลุ่ม-ต่อ-กลุ่มใน Power BI Desktop (ตัวอย่าง)](desktop-many-to-many-relationships.md) 
...
เราต้องการเชื่อมตารางเหล่านี้ไปยังตารางอื่นๆ ในโมเดล เช่นเคย เราสร้างความสัมพันธ์ระหว่างตาราง **จักรยาน** จาก SQL Server และตารางนำเข้า **ProductManagers** กล่าวคือ จะเป็นความสัมพันธ์ระหว่าง *จักรยาน[ProductName]* และ *ProductManagers[ProductName]* ดังที่อภิปรายข้างต้น ความสัมพันธ์ทั้งหมดที่เชื่อมแหล่งข้อมูลจะต้องมีคาร์ดินาลลิตี้ *กลุ่ม-ต่อ-กลุ่ม* เริ่มต้น 
...
การใช้โมเดลแบบรวมเพิ่มข้อควรพิจารณาด้านสมรรถภาพเพิ่มเติม วิชวลเดี่ยวสามารถส่งผลให้เกิดการส่งคิวรีไปยังหลายแหล่งข้อมูลได้ ซึ่งมักจะส่งผ่านผลลัพธ์จากหนึ่งคิวรีไปยังแหล่งที่สอง สถานการณ์นี้สามารถทำให้เกิดการดำเนินการต่อไปนี้:

* **คิวรี SQL ที่รวมถึงค่าคงที่จำนวนมาก**: เช่น วิชวลที่ต้องการ *จำนวนการขาย* ทั้งหมดสำหรับชุด *ผู้จัดการผลิตภัณฑ์* ที่เลือก จะต้องค้นหาว่า *ผลิตภัณฑ์* ใดที่ผู้จัดการผลิตภัณฑ์จัดการ ลำดับนี้จะต้องเกิดขึ้นก่อนที่วิชวลจะส่งคิวรี SQL ซึ่งรวมถึง ID ผลิตภัณฑ์ทั้งหมดในรายการ *WHERE*
...
รุ่นของโมเดลแบบรวมนี้มีข้อจำกัดเล็กน้อย
