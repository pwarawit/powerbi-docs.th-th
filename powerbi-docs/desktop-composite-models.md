...
ms.locfileid: "65533599"
---
# <a name="use-composite-models-in-power-bi-desktop"></a>ใช้แบบจำลองแบบรวมใน Power BI Desktop

ก่อนหน้านี้ ใน Power BI Desktop เมื่อคุณใช้ DirectQuery ที่ในรายงาน ไม่มีข้อมูลการเชื่อมต่ออื่น ๆ - ว่า DirectQuery หรือการนำเข้า - จะอนุญาตสำหรับรายงานนั้น ด้วยโมเดลแบบรวม ข้อกำจัดจะหายไป รายงานจะสามารถรวมการเชื่อมต่อข้อมูลจากการเชื่อมต่อข้อมูล DirectQuery หรือนำเข้าได้มากกว่าหนึ่งแห่ง ในแบบใด ๆ ที่คุณเลือก
...
เมื่อคุณใช้ DirectQuery, *โมเดลแบบรวม*ทำให้สามารถสร้างแบบจำลอง Power BI (เช่นเดียว *.pbix*ไฟล์ Power BI Desktop) ที่ไม่อย่างใดอย่างหนึ่งหรือทั้งสองอย่างต่อไปนี้:
...
ตัวอย่างต่อไปนี้แสดงเป็นกรณีทั่วไปของการ*มิติ*ตาราง - เช่น*ผลิตภัณฑ์*หรือ*ลูกค้า*-ที่ถูกขยาย มีข้อมูลบางอย่างเพิ่มเติมที่นำเข้าจากที่อื่น นอกจากนี้ยังสามารถมีตารางใช้ DirectQuery เพื่อเชื่อมต่อแหล่งข้อมูลหลากหลาย ในตัวอย่างเดียวกัน สมมติว่า *เป้าหมายการขาย* ต่อ *ประเทศ* และ *ช่วงเวลา* ถูกจัดเก็บไว้ในแผนกฐานข้อมูลที่แยกกัน อีกเช่นเคย คุณสามารถใช้ *GetData* เพื่อเชื่อมไปยังข้อมูลนั้นดังแสดงในภาพต่อไปนี้: 
...
การใช้โมเดลแบบรวมเพิ่มข้อควรพิจารณาด้านสมรรถภาพเพิ่มเติม ภาพเดียวสามารถทำการส่งคิวรีเป็นหลายแหล่งข้อมูล ซึ่งมักจะส่งผลลัพธ์จากแบบสอบถามข้ามไปแหล่งสอง สถานการณ์นี้สามารถทำให้เกิดการดำเนินการต่อไปนี้:
...
รุ่นนี้โมเดลแบบรวมแสดงข้อจำกัดบางอย่าง:

ในปัจจุบัน[รีเฟรชแบบเพิ่มหน่วย](service-premium-incremental-refresh.md)ได้รับการสนับสนุนสำหรับโมเดลแบบรวมที่เชื่อมต่อกับ SQL, Oracle และ Teradata แหล่งข้อมูลเท่านั้น
...
* [โหมดการจัดเก็บใน Power BI Desktop](desktop-storage-mode.md)
* [ใช้ DirectQuery ใน Power BI](desktop-directquery-about.md)
