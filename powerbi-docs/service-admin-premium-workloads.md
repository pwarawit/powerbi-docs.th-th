...
| **ขีดจำกัดหน่วยความจำคิวรี (%)** | เปอร์เซ็นต์สูงสุดของหน่วยความจำที่พร้อมใช้งานซึ่งสามารถใช้สำหรับผลลัพธ์ชั่วคราวในแบบสอบถามหรือการวัด DAX ได้ |
...
การตั้งค่านี้มีผลต่อการรีเฟรชข้อมูลและการแสดงผลรายงาน การรีเฟรชข้อมูลจะทำการรีเฟรชข้อมูลทั้งจากแหล่งข้อมูลและการรีเฟรชแบบสอบถาม ยกเว้นในกรณีที่ปิดใช้งานการรีเฟรชแบบสอบถาม หากเปิดใช้งานการรีเฟรชแบบสอบถาม ขีดจำกัดหน่วยความจำนี้ก็จะมีผลต่อแบบสอบถามเหล่านั้นด้วย แบบสอบถามที่ดำเนินการล้มเหลวใด ๆ ส่งผลให้การรีเฟรชตามกำหนดเวลานั้นอยู่ในสถานะล้มเหลว แม้ว่าการรีเฟรชข้อมูลจะประสบความสำเร็จก็ตาม

#### <a name="query-timeout"></a>หมดเวลาแบบสอบถาม

ใช้การตั้งค่านี้เพื่อรักษาการควบคุมแบบสอบถามที่ต้องดำเนินการเป็นระยะเวลานานให้ดียิ่งขึ้น ซึ่งจะส่งผลให้การโหลดรายงานสำหรับผู้ใช้นั้นช้าลง การตั้งค่านี้มีผลต่อการรีเฟรชข้อมูลและการแสดงผลรายงาน การรีเฟรชข้อมูลจะทำการรีเฟรชข้อมูลทั้งจากแหล่งข้อมูลและการรีเฟรชแบบสอบถาม ยกเว้นในกรณีที่ปิดใช้งานการรีเฟรชแบบสอบถาม หากเปิดใช้งานการรีเฟรชแบบสอบถาม ขีดจำกัดการหมดเวลานี้จะมีผลต่อแบบสอบถามเหล่านั้นด้วย
...
เมื่อทำการรีเฟรชกระแสข้อมูล ปริมาณงานกระแสข้อมูลจะให้กำเนิดคอนเทนเนอร์สำหรับแต่ละเอนทิตีในกระแสข้อมูล แต่ละคอนเทนเนอร์สามารถรองรับหน่วยความจำได้ถึงปริมาณตามที่ระบุใน**การตั้งค่าขนาดคอนเทนเนอร์ ค่าเริ่มต้นสำหรับ SKU ทั้งหมดคือ 700 MB คุณอาจต้องการเปลี่ยนการตั้งค่านี้หาก:
...
รายงานที่มีการแบ่งหน้าอนุญาตให้เรียกใช้รหัสแบบกำหนดเองเมื่อทำการแสดงรายงาน ตัวอย่างเช่น การเปลี่ยนสีข้อความแบบไดนามิกที่ยึดตามเนื้อหา ซึ่งสามารถรับหน่วยความจำเพิ่มเติมได้ Power BI Premium เรียกใช้รายงานแบบแบ่งหน้ามีช่องว่างที่มีอยู่ภายในกำลังการผลิต 
