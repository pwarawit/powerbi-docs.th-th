...
หากคุณแนะนำให้ผู้ใช้ของคุณใช้งาน Power BI Desktop ด้วยเครื่องมือที่จำเป็นใช้ไฟล์ตัวติดตั้ง Windows (ไฟล์ .msi) คุณสามารถแยกไฟล์ .msi จากไฟล์ .exe ของตัวติดตั้ง Power BI Desktop ได้ คุณสามารถใช้เครื่องมือของบุคคลที่สาม เช่น WiX Toolset เพื่อดำเนินการนี้ได้
...
* บนคอมพิวเตอร์ที่คุณดาวน์โหลดตัวติดตั้ง Power BI Desktop ให้ดาวน์โหลดและติดตั้งเวอร์ชันล่าสุดของ WiX Toolset จากเว็บไซต์ WiX ที่ https://wixtoolset.org/
* เปิดหน้าต่างบรรทัดคำสั่งในฐานะเป็นผู้ดูแลระบบ และนำทางไปยังโฟลเดอร์ที่คุณติดตั้ง WiX Toolset
...
นอกจากนี้ คุณยังสามารถใช้ **พารามิเตอร์ไวยากรณ์** ซึ่งระบุด้วยไวยกรณ์ "PROPERTY=VALUE" ต่อไปนี้ได้
...
|INSTALLDESKTOPSHORTCUT     |ค่าของ 1 ที่เพิ่มทางลัดไปยังเดสก์ท็อป         |
|INSTALLLOCATION     |พาธของไฟล์ไปยังตำแหน่งที่คุณต้องการติดตั้ง         |
|LANGUAGE     |รหัสตำแหน่งที่ตั้ง ตัวอย่างเช่น en-US, de-DE, pr-BR เพื่อใช้ภาษาตามการตั้งค่าเริ่มต้นของแอปพลิเคชัน หากไม่ได้ระบุภาษา Power BI Desktop จะแสดงภาษาของ Windows OS ซึ่งผู้ใช้สามารถเปลี่ยนได้ในกล่องโต้ตอบตัวเลือก         |
|REG_SHOWLEADGENDIALOG     |ค่า 0 ปิดใช้งานการแสดงกล่องโต้ตอบที่ปรากฏขึ้นมา ก่อนที่คุณจะลงชื่อเข้าใช้ Power BI Desktop         |




ตัวอย่างเช่น คุณสามารถใช้งานด้วยไวยากรณ์ต่อไปนี้ เพื่อติดตั้งโดยไม่ต้องมีอินเทอร์เฟซผู้ใช้ โดยใช้ภาษาเยอรมัน: 
