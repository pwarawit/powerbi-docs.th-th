...
ในการเพิ่มเกตเวย์ เพียงแค่[ดาวน์โหลด](https://go.microsoft.com/fwlink/?LinkId=698861)และติดตั้งเกตเวย์บนเซิร์ฟเวอร์ในสภาพแวดล้อมของคุณ หลังจากที่คุณได้ติดตั้งเกตเวย์ ซึ่งจะแสดงในรายการของเกตเวย์ภายใต้หัวข้อ**จัดการเกตเวย์**
...
คุณสามารถกำหนดค่าระดับความเป็นส่วนตัวให้กับแหล่งข้อมูลของคุณได้ ซึ่งจะเป็นการควบคุมการปะปนของข้อมูล โดยจะใช้เฉพาะสำหรับการรีเฟรชตามกำหนดการ จะไม่นำไปใช้กับการเชื่อมต่อสด [ศึกษาเพิ่มเติม](https://support.office.com/article/Privacy-levels-Power-Query-CC3EDE4D-359E-4B28-BC72-9BEE7900B540)
...
> [!NOTE]
> คุณอาจเปลี่ยนแปลงผู้ใชโดยไม่ได้ตั้งใจ ตัวอย่างเช่น ถ้าค่า**ที่นำมาแทน (ค่าเริ่มต้น)ของคุณ**คือ*@contoso.com*และ**ของคุณ ด้วย(ชื่อใหม่)** คือ *@contoso.local*ดังนั้น ผู้ใช้ทั้งหมดที่มีเครื่องหมายอยู่*@contoso.com*จะถูกแทนที่ด้วย*@contoso.local* นอกจากนี้ยัง ถ้าชื่อ**ที่นำมาแทน (ชื่อเดิม)ของคุณ**คือ*dave@contoso.com*และ**ของคุณ ด้วย(ชื่อใหม่)** คือ *dave@contoso.local*ผู้ใช้ที่มีเครื่องหมายอยู่v-dave@contoso.comจะถูกส่งเป็น v-dave*@contoso.local*
> 
> 
...
5. ระบบจะส่งผ่านคำ*UserPrincipalName*ส่งอีเมลเป็น*EffectiveUser*ไปยัง SSAS เช่น: *Alias@corp.on-prem.contoso*
