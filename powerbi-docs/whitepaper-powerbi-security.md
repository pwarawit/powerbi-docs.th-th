...
**Power BI** service ถูกสร้างบน**Azure**ซึ่งเป็นโครงสร้างพื้นฐานและแพลตฟอร์มการประมวลผลของ[Microsoft cloud](http://azure.microsoft.com/overview/what-is-azure/) ในขณะนี้มีการปรับใช้ power BI ในศูนย์ข้อมูลมากมายทั่วโลก – มีการปรับใช้ที่ใช้งานอยู่มากมายที่พร้อมใช้งานสำหรับลูกค้าในภูมิภาคที่ใช้ โดยศูนย์ข้อมูลเหล่านั้น และจำนวนของการปรับใช้แบบ passiveที่เท่ากันซึ่งทำหน้าที่เป็นข้อมูลสำรองสำหรับการปรับใช้ที่ใช้งานอยู่แต่ละครั้ง

การใช้งาน Power BI แต่ละรายการประกอบด้วยคลัสเตอร์สองตัว คลัสเตอร ์Front End (**WFE**) และคลัสเตอร์**Back End** คลัสเตอร์สองเหล่านี้จะแสดงในรูปต่อไปนี้ และให้พื้นหลังสำหรับส่วนเหลือของบทความนี้ 
...
คลัสเตอร์ WFE ใกล้กับมากผู้ใช้จัดการลำดับเข้าสู่ระบบและการรับรองความถูกต้อง (อธิบายไว้ในบทความนี้), และมีโทเค็น AAD ผู้ใช้เมื่อมีการรับรองความถูกต้องจะเสร็จสมบูรณ์ คอมโพเนนต์ ASP.NET ภายในคลัสเตอร์ WFE วิเคราะห์คำขอเพื่อกำหนดองค์กรที่ผู้ใช้เป็นสมาชิก แล้ว ปรึกษา Power BI **Global Service** บริการส่วนกลางคือ Azure ตารางเดียวที่ใช้ร่วมกันทั้งหมดระหว่างWFEทั่วโลก และคลัสเตอร์Back Endที่แมปผู้ใช้และองค์กรลูกค้าศูนย์ข้อมูลที่บรรจุผู้เช่า Power BI ของพวกเขา WFE ระบุไปยังเบราว์เซอร์ใดคลัสเตอร์ Back End ที่บ้านผู้เช่าขององค์กร เมื่อผู้ใช้จะรับรองความถูกต้อง โต้ตอบกับลูกค้าอื่น ๆ ที่ตามมาเกิดขึ้นกับคลัสเตอร์Back Endโดยตรง โดยไม่ต้อง WFE เป็นตัวกลางสำหรับคำขอเหล่านั้น

### <a name="the-power-bi-back-end-cluster"></a>คลัสเตอร์Power BI Back End

คลัสเตอร์**Back End**คือวิธีการที่ไคลเอนต์การรับรองตัวตนแล้วโต้ตอบกับ Power BI service คลัสเตอร์**Back End**จัดการการแสดงภาพ แดชบอร์ดผู้ใช้ ชุดข้อมูล รายงาน ที่เก็บข้อมูล การเชื่อมต่อข้อมูล การรีเฟรชข้อมูล และลักษณะอื่น ๆ ของโต้ตอบกับ Power BI service

![คลัสเตอร์Back End](media/whitepaper-powerbi-security/powerbi-security-whitepaper_03.png)
...
**สิ่งสำคัญ:** ต้องบันทึกว่า_Azure API Management_ (**APIM**) และบทบาทเกตเวย์ (**GW**) จะสามารถเข้าถึงผ่านอินเทอร์เน็ตสาธารณะ พวกเขาให้รับรองตัวตน การอนุญาต DDoS protection Throttling ปรับสมดุลการโหลด กำหนดเส้นทาง และความสามารถอื่น ๆ
...
### <a name="multiple-geographies-multi-geo---preview"></a>Multiple Geographies (Multi-geo) - ตัวอย่าง

บางองค์กรจำเป็นต้องมีสถานะ Power BI ในหลากหลายภูมิภาคหรือหลายพื้นที่ ยึดตามความต้องการทางธุรกิจ ตัวอย่าง ธุรกิจอาจมีผู้เช่าของ Power BI ในสหรัฐอเมริกา แต่อาจยังทำธุรกิจในพื้นที่ทางภูมิศาสตร์ เช่นออสเตรเลีย และต้องการบริการ Power BI และข้อมูลจะยังคงอยู่ในภูมิภาคระยะไกล  เริ่มต้นในครึ่งหลังของ 2018 องค์กรที่ มีผู้เช่าของพวกเขาในหนึ่งภูมิศาสตร์ยังสามารถเข้าถึงแหล่งข้อมูล Power BI ในภูมิศาสตร์อื่นเมื่อเตรียมใช้งานอย่างถูกต้อง คุณลักษณะนี้จะเรียกว่า**multi-geo**สำหรับความสะดวกสบายและการอ้างอิงตลอดทั้งเอกสารนี้

มีผลกระทบทางเทคนิคที่ควรทราบเมื่อทำงานในภูมิภาคอื่น ซึ่ง g-เข้าใจง่ายตลอดทั้งเอกสารนี้ ข้อควรพิจารณาสำคัญมีดังนี้:

- คิวรีที่แคชไว้ถูก่จัดเก็บในพื้นที่ระยะไกล จะยังคงอยู่ในพื้นที่ที่เหลือ อย่างไรก็ ตามข้อมูลอื่นๆในการส่งต่ออาจไปกลับมาระหว่างmultiple geographies
- รายงานใน PBIX หรือ XLSX ไฟล์ในภูมิภาคระยะไกลที่จะเผยแพร่ไปยัง Power BI ในบางครั้งทำสำเนาหรือสำเนาถูกเก็บไว้ในที่เก็บข้อมูล Azure Blob ของ Power BI และเมื่อเกิดกรณี ที่ข้อมูลถูกเข้ารหัสลับโดยใช้การเข้ารหัสลับบริการเก็บข้อมูล Azure (SSE)
- เมื่อย้ายข้อมูลจากบริเวณหนึ่งไปยังบริเวณอื่นในสิ่งแวดล้อมแบบmulti-geo การกำจัดข้อมูลขยะในเขตข้อมูลถูกย้ายภายใน 7 ถึง 10 วัน ในจุดคัดลอกของข้อมูลที่ถูกย้ายจากภูมิภาคต้นฉบับจะถูกทำลาย

รูปต่อไปนี้แสดงวิธีบริการของPower BI ที่ให้มาในภูมิภาคระยะไกลกับสิ่งแวดล้อมแบบmulti-geo ถูกส่งผ่าน**คลัสเตอร์Power BI Back End** ที่สร้างการเชื่อมต่อกับเครื่องเสมือนการสมัครสมาชิก Power BI ระยะไกลของลูกค้า
...
- [ภูมิภาค azure](http://azure.microsoft.com/regions/) – ข้อมูลเกี่ยวกับสถานะส่วนกลางของ Azure และตำแหน่งที่ตั้ง
- [บริการ azure ตามภูมิภาค](http://azure.microsoft.com/regions/#services)– รายการของบริการ Azure (ทั้งบริการโครงสร้างพื้นฐานและแพลตฟอร์มการบริการ) พร้อมใช้งานจาก Microsoft ในแต่ละภูมิภาค

ในปัจจุบัน บริการของPower BIจะพร้อมใช้งานในภูมิภาคต่อไปนี้ ให้บริการ โดยศูนย์ข้อมูลหลักการต่อไปนี้:
...
Microsoft ยังมีศูนย์ข้อมูลสำหรับ sovereignties สำหรับข้อมูลเพิ่มเติมเกี่ยวกับความพร้อมใช้งานของบริการคลาวด์สาธารณะ ดู[คลาวด์สาธารณะของ Power BI](https://powerbi.microsoft.com/clouds/)

สำหรับข้อมูลเพิ่มเติมเกี่ยวกับที่เก็บข้อมูลของคุณและวิธีใช้ โปรดดู[ศูนย์ความเชื่อถือ Microsoft](https://www.microsoft.com/TrustCenter/Transparency/default.aspx#_You_know_where) พันธสัญญาเกี่ยวกับตำแหน่งที่ตั้งของข้อมูลลูกค้าส่วนที่เหลือถูกระบุใน**เงื่อนไขการประมวลผลข้อมูล**ของ[เงื่อนไขบริการออนไลน์ของMicrosoft ](http://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&amp;DocumentTypeId=31)
...
1. เบราว์เซอร์ของผู้ใช้ที่ติดต่อแล้วระบุ Azure CDN หรือสำหรับบางแฟ้ม WFE ดาวน์โหลดคอลเลกชันของระบุไฟล์ทั่วไปที่จำเป็นต้องเปิดใช้งานการโต้ตอบของเบราว์เซอร์กับบริการ Power BI หน้าเบราว์เซอร์แล้วมีโทเค็นAAD ข้อมูลเซสชัน ตำแหน่งที่ตั้งของคลัสเตอร์Back Endที่เกี่ยวข้องและการรวบรวมของไฟล์ที่ดาวน์โหลดจากคลัสเตอร์ WFEและAzure CDNสำหรับระยะเวลาของการรวบรวมของเบราว์เซอร์บริการPower BI
...
บริการ Power BI ยังจัดการข้อมูลที่แตกต่างกันขึ้นอยู่กับว่ามีการเข้าถึงข้อมูลด้วย**DirectQuery**หรือไม่_หรือ_ไม่เข้าถึงด้วย DirectQuery เพื่อให้มีอยู่สองประเภทข้อมูลผู้ใช้สำหรับ Power BI: ข้อมูลที่มีการเข้าถึงด้วยDirectQuery และข้อมูลที่ไม่ได้เข้าถึงด้วย DirectQuery
...
แบบสอบถามที่ไม่**ไม่** DirectQuery ประกอบด้วยคอลเลกชันของแบบสอบถาม DAX ที่ใช้_ไม่_แปลเป็นภาษาแม่ของแหล่งข้อมูลต้นแบบโดยตรง คิวรี DirectQuery ไม่ใช่ไม่ต้องใส่ข้อมูลประจำตัวสำหรับข้อมูลเบื้องต้น และข้อมูลเบื้องต้นถูกโหลดลงในบริการ Power BI ยกเว้นว่าเป็นองค์กรเข้าถึงข้อมูล[Power BI Gateway](https://powerbi.microsoft.com/documentation/powerbi-gateway-enterprise/)ในกรณีแบบสอบถามเท่านั้น จัดเก็บการอ้างอิงไปยังข้อมูลในองค์กร
...
เมื่อข้อมูลอยู่ที่ส่วนที่เหลือ บริการของ Power BI จัดเก็บชุดข้อมูล รายงานและแดชบอร์ดไทล์ในลักษณะอธิบายไว้ในส่วนย่อยต่อไปนี้ ตามที่กล่าวถึงก่อนหน้านี้ ข้อมูลทั้งหมดในPower BIถูกเข้ารหัสลับ ETL หมายถึงแยก แปลง และโหลดในส่วนต่อไปนี้
...
2. ข้อมูลแบบคงที่
   ...
   ข้อมูลแบบคงที่มีวัตถุเช่นรูปภาพพื้นหลังและรูปภาพแบบกำหนดเอง
    ...
    a. สำหรับรายงานที่สร้างขึ้นด้วยExcelสำหรับ Office 365 ไม่มีสิ่งใดถูกเก็บไว้

    b. สำหรับรายงานPower BI ข้อมูลแบบคงถูกจัดเก็บ และเข้ารหัสลับในการเก็บข้อมูล Azure Blob

3. แคช a สำหรับรายงานที่สร้างขึ้นด้วยExcelสำหรับOffice 365 ไม่มีสิ่งใดถูกเก็บไว้

    b. สำหรับรายงาน Power BI ข้อมูลสำหรับภาพจะถูกแคเข้ารหัสลับในฐานข้อมูล SQL Azure
...
ต่อไปนี้อธิบายข้อมูลที่ถูกเก็บไว้บนอุปกรณ์ที่ไม่เปลี่ยนแปลงได้ transiently
...
โดยแต่ละแหล่งข้อมูล ผู้ใช้สร้างการเชื่อมต่อที่ยึดตามเข้าสู่ระบบและเข้าถึงข้อมูลด้วยข้อมูลประจำตัวเหล่านั้น ผู้ใช้สามารถสร้างแบบสอบถาม แดชบอร์ด และรายงานที่ยึดตามข้อมูลเบื้องต้นแล้ว
...
ExpressRoute เป็นบริการของ Azure ที่ช่วยให้คุณสร้างการเชื่อมต่อแบบส่วนตัวระหว่างศูนย์ข้อมูล Azure (ที่ Power BI อยู่) และโครงสร้างพื้นฐานภายในองค์กรของคุณ หรือสร้างการเชื่อมต่อแบบส่วนตัวระหว่างศูนย์ข้อมูล Azure และสภาพแวดล้อมโคโลเคชั่นของคุณ สำหรับข้อมูลเพิ่มเติม โปรดดูบทความ[Power BI และ ExpressRoute](https://powerbi.microsoft.com/documentation/powerbi-admin-power-bi-expressroute/)

## <a name="power-bi-mobile"></a>Power BI Mobile

Power BI สำหรับอุปกรณ์เคลื่อนคือคอลเลกชันของแอปที่ออกแบบมาสำหรับแพลตฟอร์มเคลื่อนหลักสาม: Android, iOS และ Windows Mobile ข้อควรพิจารณาเกี่ยวกับความปลอดภัยสำหรับแอป Power BI Mobile อยู่เป็นสองประเภท:

* ติดต่อสื่อสาร
* แอปพลิเคชันและข้อมูลบนอุปกรณ์

สำหรับ**สื่อสารอุปกรณ์**แอปพลิเคชัน Power BI Mobile ทั้งหมดการสื่อสารกับบริการPower BIและใช้เดียวกันเชื่อมต่อและรับรองความถูกต้องลำดับที่ใช้ โดยเบราว์เซอร์ ซึ่งจะอธิบายในรายละเอียดก่อนหน้านี้ในเอกสารทางเทคนิคนี้ แอปพลิเคชันสำหรับอุปกรณ์เคลื่อนของ Android Power BI และ iOS แสดงกล่องเซสชันเบราว์เซอร์ภายในแอปพลิเคชันเอง และแอปสำหรับอุปกรณ์ Windows ปรากฏเป็นตัวกลางเพื่อสร้างช่องทางการสื่อสารกับ Power BI
...
Power BI Mobile apps พยายามสื่อสารกับบริการ Power BI การตรวจสอบและส่งข้อมูลถูกใช้เพื่อรวบรวมสถิติการใช้งานแอปและข้อมูลที่คล้ายกัน ซึ่งจะถูกส่งไปยังบริการที่ถูกใช้เพื่อตรวจสอบการใช้งานและกิจกรรม ไม่มีข้อมูลส่วนบุคคล(PII)ถูกส่ง ด้วยข้อมูลระยะไกล
...
แอปพลิเคชันมือถือ BI power ไม่ได้ดูโฟลเดอร์บนอุปกรณ์ เรียนรู้เพิ่มเติมเกี่ยวกับ[ความสามารถของแบบออฟไลน์ในแอป mobile Power BI](https://powerbi.microsoft.com/documentation/powerbi-mobile-offline-android/)

ทุกแพลทฟอร์มสาม Power BI Mobile จะพร้อมใช้งานสนับสนุน Microsoft Intune บริการซอฟต์แวร์ที่มีการจัดการแอปพลิเคชันและอุปกรณ์เคลื่อนที่ ด้วย Intune เปิดใช้งาน และกำหนดค่า ถูกเข้ารหัสลับข้อมูลบนอุปกรณ์เคลื่อนที่ และแอปพลิเคชัน Power BI จะไม่สามารถติดตั้งบน SD การ์ด คุณสามารถ[เรียนรู้เพิ่มเติมเกี่ยวกับ Microsoft Intune](http://www.microsoft.com/cloud-platform/microsoft-intune)ได้
...
* **ข้อมูลประจำตัวการ power BI และข้อมูลประจำตัวของโดเมน:** ผู้ใช้ลงชื่อเข้าใช้ Power BI โดยใช้อยู่อีเมล เมื่อผู้ใช้พยายามเชื่อมต่อไปยังทรัพยากรข้อมูล Power BI ผ่านที่อยู่อีเมลที่เข้าสู่ระบบ Power BI เป็นข้อมูลประจำตัว สำหรับแหล่งข้อมูลที่เชื่อมต่อโดเมน (ใดภายในองค์กร หรือ บนระบบคลาวด์), เข้าสู่ระบบอีเมลที่ตรงกับตัว_ชื่อหลักผู้ใช้_ ([UPN](https://msdn.microsoft.com/library/windows/desktop/aa380525(v=vs.85).aspx)) โดยบริการไดเรกทอรีเพื่อตรวจสอบว่ามีข้อมูลประจำตัวเพียงพอที่จะอนุญาตให้เข้าถึง สำหรับองค์กรที่ใช้ที่อยู่อีเมลที่ทำงานลงชื่อเข้าใช้ Power BI (อีเมลเดียวกันที่พวกเขาใช้เพื่อลงชื่อเข้าใช้งานทรัพยากร เช่น_david@contoso.com_), การแมปสามารถเกิดขึ้นได้อย่างราบรื่น สำหรับองค์กร ที่ไม่ได้ใช้งานบน ที่อยู่อีเมล (เช่น_david@contoso.onmicrosoft.com_), ต้องสร้างแมปไดเรกทอรีเพื่ออนุญาตให้เข้าถึงทรัพยากรภายในองค์กรด้วยข้อมูลประจำตัวการเข้าสู่ระบบ Power BI

* **SQL Server Analysis Services และ Power BI:** สำหรับองค์กรที่ใช้ SQL Server Analysis Services ภายในองค์กร Power BI มีเกตเวย์ข้อมูลภายในองค์กร Power BI (ซึ่งเป็นการ**เกตเวย์**เป็นอ้างอิงในส่วนก่อนหน้า)  เกตเวย์ข้อมูลภายในองค์กร Power BI สามารถบังคับใช้บทบาทความปลอดภัยบนแหล่งข้อมูล (RLS) สำหรับข้อมูลเพิ่มเติมเกี่ยวกับ RLS ดู**รับรองความถูกต้องของผู้ใช้ไปยังแหล่งข้อมูล**ก่อนหน้านี้ในเอกสารนี้ คุณยังสามารถอ่านบทความเชิงลึกเกี่ยวกับ[Power BI Gateway](https://powerbi.microsoft.com/documentation/powerbi-gateway-enterprise/)ได้
...
* **การเชื่อมต่อโดยไม่มีโดเมน**: สำหรับการเชื่อมต่อข้อมูลที่ไม่เข้า ร่วมโดเมน และไม่มีความสามารถของบทบาทระดับความปลอดภัย (RLS), ผู้ใช้ต้องใส่ข้อมูลประจำตัวในระหว่างการเชื่อมต่อลำดับ ซึ่ง Power BI ส่งผ่านไปยังแหล่งข้อมูลเพื่อสร้างการเชื่อมต่อแล้ว ถ้ามีสิทธิ์เพียงพอ ข้อมูลถูกโหลดจากแหล่งข้อมูลลงในบริการ Power BI
...
**อย่างไรตามบทบาทความปลอดภัย การแชร์รายงาน หรือแดชบอร์ด และข้อมูลการเชื่อมต่อ มีวิธีการทำงานอย่างไรในเงื่อนไขของการเข้าถึงข้อมูล การดูแดชบอร์ด การเข้าถึงรายงานหรือรีเฟรช**
...
**ผู้ใช้ของเราเชื่อมต่อกับแหล่งข้อมูลเดียวกันตลอดเวลา บางส่วนที่จำเป็นต้องใช้ข้อมูลประจำตัวที่แตกต่างจากข้อมูลประจำตัวของพวกเขาโดเมน วิธีสามารถพวกเขาหลีกเลี่ยงไม่ต้องป้อนข้อมูลประจำตัวเหล่านี้แต่ละครั้งที่พวกเขาทำการเชื่อมต่อข้อมูลหรือไม่**
...
**พอร์ตใดที่ใช้โดยเกตเวย์ข้อมูลภายในองค์กรและเกตเวย์ส่วนบุคคล มีชื่อโดเมนใดๆ ที่จำเป็นต้องได้รับอนุญาตสำหรับวัตถุประสงค์ในการเชื่อมต่อหรือไม่**

* คำตอบของคำถามนี้อย่างละเอียดอยู่ในลิ้งค์ต่อไปนี้: [https://powerbi.microsoft.com/documentation/powerbi-gateway-enterprise](https://powerbi.microsoft.com/documentation/powerbi-gateway-enterprise)

**เมื่อทำงานกับเกตเวย์ข้อมูลภายในองค์กร วิธีคีย์การกู้คืนที่ใช้ และที่จะเก็บหรือไม่ ต้องทำอะไรเกี่ยวกับการจัดการข้อมูลประจำตัวความปลอดภัย**

* ในระหว่างการติดตั้งเกตเวย์และกำหนดค่า ผู้ดูแลชนิดในเกตเวย์**คีย์การกู้คืน** ว่า**คีย์การกู้คืน**ถูกใช้เพื่อสร้างชุดสองคีย์อย่างรัดกุมมาก:

  - คีย์**RSA** asymmetric
  - คีย์**AES** symmetric key
...
* เกตเวย์สนับสนุนโพรโทคอลที่ติดต่อสื่อสารสองทางต่อไปนี้:
  ...
  - **AMQP 1.0 – TCP + TLS** : โพรโทคอลนี้จำเป็นต้องใช้พอร์ต 443, 5671 5672 และ 9350 9354 ต้องเปิดสำหรับการติดต่อสื่อสารขาออก โพรโทคอลนี้เป็นสิ่งจำเป็น เนื่องจากมีค่าใช้จ่ายการติดต่อสื่อสารน้อยกว่า

  - **HTTPS – WebSockets over HTTPS + TLS** : โพรโทคอลนี้ใช้พอร์ต 443 เท่านั้น WebSocket ที่เริ่มต้นข้อความการเชื่อมต่อ HTTP เดียว เมื่อช่องสำเร็จ สื่อสารได้โดยหลัก ๆ แล้ว TCP + TLS คุณสามารถบังคับให้เกตเวย์เพื่อใช้โพรโทคอลนี้ โดยการปรับเปลี่ยนการตั้งค่าที่อธิบายไว้ในการ[บทความเกตเวย์องค์กร](https://powerbi.microsoft.com/documentation/powerbi-gateway-onprem/)ได้
...
* Power BI ใช้**Azure Content Delivery Network** (CDN) เพื่อแจกจ่ายเนื้อหาแบบคงที่ที่จำเป็นได้อย่างมีประสิทธิภาพและบันทึกเป็นไฟล์ในตัวผู้ใช้โดยยึดตามตำแหน่งที่ตั้งทางภูมิศาสตร์ เมื่อต้องไปลงในรายละเอียดเพิ่มเติม บริการของ Power BI ใช้หลาย**CDNs**การแจกจ่ายเนื้อหาแบบคงจำเป็นและไฟล์ไปยังผู้ใช้ผ่านอินเทอร์เน็ตสาธารณะได้อย่างมีประสิทธิภาพ ไฟล์คงที่เหล่านี้รวมถึงไฟล์ดาวน์โหลดผลิตภัณฑ์ (เช่น**Power BI Desktop** **เกตเวย์ข้อมูลภายในองค์กร**หรือ ชุดเนื้อหา BI Power จากผู้ให้บริการอิสระต่าง ๆ) ไฟล์การกำหนดค่าเบราว์เซอร์ที่ใช้เพื่อเริ่มต้นและสร้างการเชื่อมต่อใด ๆ ในเวลาต่อมาด้วย Power BI ตลอดจนการรักษาความปลอดภัยเริ่มต้นสำหรับหน้าเข้าสู่ระบบของ Power BI – ข้อมูลประจำตัวแท้จริงจะส่งผ่าน ExpressRoute
  ...
  ยึดตามข้อมูลที่มีอยู่ในระหว่างการเชื่อมต่อเริ่มต้นไปยังบริการ Power BI เบราว์เซอร์ของผู้ใช้ที่ติดต่อ Azure ระบุ**CDN** (หรือ สำหรับไฟล์บาง ไฟล์ การ**WFE** ) เพื่อดาวน์โหลดคอลเลกชันของ ระบุไฟล์ทั่วไปที่จำเป็นต้องเปิดใช้งานการโต้ตอบของเบราว์เซอร์กับบริการ Power BI หน้าเบราว์เซอร์แล้วมีโทเค็นAAD ข้อมูลเซสชัน ตำแหน่งที่ตั้งของคลัสเตอร**์Back End**ที่เกี่ยวข้องและการรวบรวมของไฟล์ที่ดาวน์โหลดจากคลัสเตอร์ **WFE**และAzure **CDN**สำหรับระยะเวลาของการรวบรวมของเบราว์เซอร์บริการPower BI
...
* ใช่ Bing Maps และภาพ ESRI ส่งข้อมูลออกจากบริการ Power BI สำหรับวิชวลที่ใช้บริการเหล่านั้น สำหรับข้อมูลเพิ่มเติม และคำอธิบายโดยละเอียดของปริมาณการใช้งานออกแบบของ--ผู้เช่า Power BI ดู[ **Power BI และ ExpressRoute**](https://powerbi.microsoft.com/documentation/powerbi-admin-power-bi-expressroute/)

**อย่างไรด้านอำนาจข้อมูล เราสามารถเตรียมใช้ผู้เช่าในศูนย์ข้อมูลที่อยู่ในพื้นที่เฉพาะ เพื่อให้แน่ใจว่า ข้อมูลไม่ออกจากเส้นขอบประเทศหรือไม่**

* ลูกค้าบางรายในบางภูมิภาคมีตัวเลือกในการสร้างผู้เช่าในระบบคลาวด์สาธารณะ ที่เก็บข้อมูลและการประมวลผลเก็บไว้แยกต่างหากจากศูนย์ข้อมูลอื่น ๆ ทั้งหมด บริการคลาวด์สาธารณะมีความปลอดภัย ชนิดที่แตกต่างกันเล็กน้อยเนื่องจากข้อมูลที่แยกต่างหากผู้ที่ทำงานระบบคลาวด์สาธารณะบริการ Power BI ในนามของ Microsoft

  อีกวิธีหนึ่งคือ ลูกค้ายังสามารถตั้งค่าผู้เช่าในภูมิภาคเฉพาะ อย่างไรก็ตาม ผู้เช่าดังกล่าวไม่ได้เป็นผู้ดูแลข้อมูลที่แยกต่างหากจาก Microsoft ราคาสำหรับ sovereign จะแตกต่างจากบริการ Power BI เชิงพาณิชย์พร้อมใช้งานโดยทั่วไปแล้ว สำหรับข้อมูลเพิ่มเติมเกี่ยวกับความพร้อมใช้งานของบริการคลาวด์สาธารณะ ดู[คลาวด์สาธารณะของ Power BI](https://powerbi.microsoft.com/clouds/)

**วิธีไม่ Microsoft ถือว่าเชื่อมต่อสำหรับลูกค้าที่มีการสมัครใช้งาน Power BI Premium ใช่หรือไม่ มีการเชื่อมต่อเหล่านั้นแตกต่างจากที่สร้างขึ้นสำหรับบริการไม่ใช่ Premium Power BI หรือไม่**
...
สำหรับข้อมูลเพิ่มเติมเกี่ยวกับPower BI ดูทรัพยากรต่อไปนี้
...
- [เกตเวย์ข้อมูลภายในองค์กร](https://powerbi.microsoft.com/documentation/powerbi-gateway-onprem/)
- [Power BI และ ExpressRoute](https://powerbi.microsoft.com/documentation/powerbi-admin-power-bi-expressroute/)
- [บริการคลาวด์สาธารณะ BI power](https://powerbi.microsoft.com/clouds/)
- [Power BI Premium](https://aka.ms/pbipremiumwhitepaper)
- [ใช้ KerberosสำหรับSSOจากPower BI ไปยังแหล่งข้อมูลภายในองค์กร](https://docs.microsoft.com/power-bi/service-gateway-kerberos-for-sso-pbi-to-on-premises-data)