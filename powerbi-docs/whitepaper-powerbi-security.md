...
โดยแต่ละแหล่งข้อมูล ผู้ใช้สร้างการเชื่อมต่อที่ยึดตามเข้าสู่ระบบของพวกเขา และเข้าถึงข้อมูล ด้วยข้อมูลประจำตัวเหล่านั้น ผู้ใช้สามารถสร้างแบบสอบถาม แดชบอร์ด และรายงานที่ยึดตามข้อมูลเบื้องต้นแล้ว
...
- [On-premises data gateway (เกตเวย์ข้อมูลภายในองค์กร)](service-gateway-manage.md)
