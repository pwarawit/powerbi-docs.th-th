...
รูปต่อไปนี้แสดงวิธีบริการของPower BI ที่ให้มาในภูมิภาคระยะไกลกับสิ่งแวดล้อมแบบmulti-geo ถูกส่งผ่าน**คลัสเตอร์ Power BI Back-End** ที่สร้างการเชื่อมต่อกับเครื่องเสมือนการสมัครสมาชิก Power BI ระยะไกลของลูกค้า
...
ในปัจจุบัน บริการของ Power BI จะพร้อมใช้งานในบางภูมิภาค ให้บริการ โดยศูนย์ข้อมูลตามที่อธิบายไว้ใน [Microsoft Trust Center]((https://www.microsoft.com/TrustCenter/CloudServices/business-application-platform/data-location) การเชื่อมโยงต่อไปนี้แสดงแผนผังของศูนย์ข้อมูล Power BI คุณสามารถเลื่อนไปเหนือขอบเขตเพื่อดูศูนย์ข้อมูลมีอยู่:
...
* **SQL Server Analysis Services และ Power BI:** สำหรับองค์กรที่ใช้ SQL Server Analysis Services ภายในองค์กร Power BI มีเกตเวย์ข้อมูลภายในองค์กร Power BI (ซึ่งเป็นการ**เกตเวย์**เป็นอ้างอิงในส่วนก่อนหน้า)  เกตเวย์ข้อมูลภายในองค์กร Power BI สามารถบังคับใช้บทบาทความปลอดภัยบนแหล่งข้อมูล (RLS) สำหรับข้อมูลเพิ่มเติมเกี่ยวกับ RLS ดู**รับรองความถูกต้องของผู้ใช้ไปยังแหล่งข้อมูล**ก่อนหน้านี้ในเอกสารนี้ คุณยังสามารถอ่านบทความเชิงลึกเกี่ยวกับ[Power BI Gateway](service-gateway-manage.md)ได้
...
* คำตอบของคำถามนี้อย่างละเอียดอยู่ในลิ้งค์ต่อไปนี้: [Power BI Gateway](service-gateway-manage.md)
...
* เกตเวย์สนับสนุนโพรโทคอลที่ติดต่อสื่อสารสองทางต่อไปนี้:
  ...
  - **HTTPS – WebSockets over HTTPS + TLS**: โพรโทคอลนี้ใช้พอร์ต 443 เท่านั้น WebSocket ที่เริ่มต้นข้อความการเชื่อมต่อ HTTP เดียว เมื่อช่องสำเร็จ สื่อสารได้โดยหลัก ๆ แล้ว TCP + TLS คุณสามารถบังคับให้เกตเวย์เพื่อใช้โพรโทคอลนี้ โดยการปรับเปลี่ยนการตั้งค่าที่อธิบายไว้ในการ[บทความเกตเวย์องค์กร](service-gateway-manage.md)ได้
...
* ใช่ Bing Maps และภาพ ESRI ส่งข้อมูลออกจากบริการ Power BI สำหรับวิชวลที่ใช้บริการเหล่านั้น สำหรับข้อมูลเพิ่มเติม และคำอธิบายโดยละเอียดของปริมาณการใช้งานออกแบบของ--ผู้เช่า Power BI ดู[ **Power BI และ ExpressRoute**](service-admin-power-bi-expressroute.md)
...
- [เกตเวย์ข้อมูลภายในองค์กร](service-gateway-manage.md)
- [Power BI และ ExpressRoute](service-admin-power-bi-expressroute.md)
