...
ถ้าคุณต้องการเพิ่มตัวกรอง URL ไปยังรายงานในแอป การจัดรูปแบบจะแตกต่างเล็กน้อย ลิงก์ไปยังรายงานในแอปจะมีพารามิเตอร์แบบสอบถาม (ctid) ที่จะถูกเพิ่มไปยัง URL พารามิเตอร์แบบสอบถามต้องถูกแยกด้วยเครื่องหมายและเป็น (&) ดังนั้นคุณต้องผนวกแบบสอบถามด้วย "&filter =" (หลังจากพารามิเตอร์ ctid) แทนที่จะเป็น "?filter =" 

ดังเช่นตัวอย่างนี้:

app.powerbi.com/groups/me/apps/*app-id*/reports/*report-id*/ReportSection ? ctid =*ctid*&filter=*ตาราง*/ *เขตข้อมูล* eq '*ค่า*'
...
* การกรองสตริงคิวรีไม่สามารถใช้ได้กับ [เผยแพร่ไปยังเว็บ](service-publish-to-web.md)
