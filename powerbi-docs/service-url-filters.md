...
ถ้าคุณต้องการเพิ่มตัวกรอง URL ไปยังรายงานในแอป การจัดรูปแบบจะแตกต่างเล็กน้อย ลิงก์ไปยังรายงานในแอปจะมีพารามิเตอร์แบบสอบถาม (ctid) ที่จะถูกเพิ่มไปยัง URL แยกพารามิเตอร์แบบสอบถาม ด้วยการเครื่องหมายและ (&) เก็บ "หรือไม่ตัวกรอง =" และย้ายพารามิเตอร์ ctid ส่วนท้ายของ URL นำหน้า ด้วยตัว (&) 

ดังเช่นตัวอย่างนี้:

app.powerbi.com/groups/me/apps/*id แอป*/reports/*รหัสรายงาน*/ReportSection ? filter =*ตาราง*/*เขตข้อมูล* eq '*ค่า*&'ctid =*ctid*
...
![รายงานที่ถูกกรองสำหรับ North Carolina](media/service-url-filters/power-bi-report4.png)
...
Power BI สนับสนุน OData V3 และ V4 สำหรับชนิดข้อมูล**วัน**และ **DateTimeOffset**  แสดงวันที่โดยใช้รูปแบบ EDM (2019-02-12T00:00:00), ดัง นั้นเมื่อคุณระบุวันที่เป็น 'ปปปปดด-วว' Power BI แปลเป็น ' ปปปป-ดด-DDT00:00:00'

ทำไมความแตกต่างนี้จึงสำคัญ สมมติว่า คุณสร้างพารามิเตอร์สตริแบบสอบถาม**gt ตาราง/วัน ' 2018 08 03'**  ผลลัพธ์จะรวมวันที่ 3 สิงหาคม 2018 หรือเริ่มต้นด้วยวันที่ 4 สิงหาคม 2018 หรือไม่? เนื่องจากแบบสอบถามของคุณเพื่อแปล Power BI **gt ตาราง/วัน ' 2018-08-03T00:00:00'** ผลลัพธ์ของคุณรวมถึงใส่วันที่มีส่วนไม่ใช่ศูนย์เวลาเนื่องจากวันที่เหล่านั้นจะมีค่ามากกว่า **' 2018-08-03T00:00:00'** .
...
* การกรองสตริงแบบสอบถามไม่ทำงานกับ[เผยแพร่ไปยังเว็บ](service-publish-to-web.md)หรือ[ส่งออกเป็น PDF](consumer/end-user-pdf.md)
