...
> [!NOTE]
> ไทล์[หน้ารายงานสด](service-dashboard-pin-live-tile-from-report.md)ที่ถูกปักหมุดยังไม่สนับสนุนตัวกรอง URL 
...
* ไทล์*หน้ารายงานสด*ที่ถูกปักหมุดยังไม่สนับสนุนตัวกรอง URL 
