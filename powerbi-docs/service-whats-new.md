...
* [แดชบอร์แบบธีม](service-dashboard-themes.md) ในบริการของ Power BI
* [Incremental refresh](service-premium-incremental-refresh.md) ด้วย Premium
* ร้องขอการเข้าถึงเวิร์กโฟลว์สำหรับ[Power BI Apps](service-create-distribute-apps.md)
* รับการปรับปรุงข้อมูลเพื่อให้ผู้ใช้ค้นหา[Power BI Apps](service-create-distribute-apps.md)ได้ง่าย
...
* ตอนนี้คุณสามารถใช้ Power BI เพื่อตรวจติดตาม สำรวจ และ[แสดงข้อมูล Adobe Analytics ของคุณได้](http://blogs.msdn.com/b/powerbi/archive/2015/08/25/exploring-your-adobe-analytics-data-in-power-bi.aspx) ด้วยชุดเนื้อหาแบบใช้ได้ทันที คุณสามารถเชื่อมต่อและค้นหาข้อมูลเชิงลึกจากข้อมูลของคุณได้ทันที เมื่อต้องการเรียนรู้เพิ่มเติม ไปที่[ชุด เนื้อหา Adobe Analytics สำหรับหน้าวิธีใช้ Power BI](service-connect-to-adobe-analytics.md)
...
* SweetIQ ช่วยให้คุณติดตามรายการภายในเครื่องของคุณได้ง่าย ๆ โดยระบุตำแหน่งที่ตั้ง และตรวจทานข้อมูลจากระบบการค้นหาภายในของคุณ Power BI ช่วยให้คุณสามารถวิเคราะห์และตรวจติดตามข้อมูลนั้น โดยการเสนอ[เนื้อหาแบบใช้ทันที](http://blogs.msdn.com/b/powerbi/archive/2015/06/16/analyze-and-monitor-your-sweetiq-data-with-power-bi.aspx)ซึ่งสร้างขึ้นจากข้อมูล SweetIQ ของคุณ สำหรับรายละเอียดเพิ่มเติมเกี่ยวกับวิธีการเริ่มต้นใช้งาน โปรดดู[หน้าความช่วยเหลือ](service-connect-to-sweetiq.md)ชุดเนื้อหา SweetIQ สำหรับ Power BI

**9 มิถุนายน 2015**

* Power BI ช่วยให้คุณสามารถตรวจติดตามและสำรวจข้อมูลนั้นโดยใช้ [MailChimp APIs](http://blogs.msdn.com/b/powerbi/archive/2015/06/09/user-power-bi-to-monitor-and-visualize-your-mailchimp-data.aspx) ได้ นำเสนอชุดของเนื้อหาแบบใช้ได้ทันทีสำหรับการวิเคราะห์ของคุณ แดชบอร์ด รายงาน และชุดข้อมูลที่รวบรวมไว้สำหรับสถานการณ์สมมติ MailChimp ช่วยให้คุณสามารถเข้าถึงข้อมูล เช่น แคมเปญสูงสุดของการเปิดทั้งหมดแยกตามวันของสัปดาห์ สำหรับรายละเอียดเพิ่มเติมเกี่ยวกับวิธีการเริ่มต้นใช้งาน โปรดดู[เอกสารประกอบ](service-connect-to-mailchimp.md)ชุดเนื้อหา MailChimp สำหรับ Power BI
...
* ด้วยการอัปเดตล่าสุดไปยัง Power BI คุณสามารถเชื่อมต่อกับข้อมูลที่บันทึกโดย**SQL Database Auditin**ด้วยชุดของรายงานที่ใช้ได้ทันทีและแดชบอร์ดแบบกำหนดเองได้ ชุดเนื้อหานี้ทำให้ง่ายต่อการค้นหาเหตุการณ์ที่น่าสงสัย กิจกรรมที่ผิดปกติ และแนวโน้มต่าง ๆ โดยยึดตามชุดข้อมูลที่มีการสร้างสำหรับการรายงานของคุณ เรียนรู้เพิ่มเติมใน[บล็อกโพสต์](http://blogs.msdn.com/b/powerbi/archive/2015/05/14/monitor-your-azure-sql-database-auditing-activity-with-power-bi.aspx)และ[เอกสารประกอบ](service-connect-to-azure-sql-database-auditing.md)
...
* ตอนนี้คุณสามารถแสดงภาพข้อมูลและสำรวจข้อมูล**Microsoft Dynamics Marketing**ของคุณด้วยชุดเนื้อหาใหม่ของเราได้แล้ว! สำหรับข้อมูลเพิ่มเติม คุณสามารถอ่าน[บล็อกโพสต์](http://blogs.msdn.com/b/powerbi/archive/2015/04/23/monitor-and-explore-your-microsoft-dynamics-marketing-data-with-power-bi.aspx)และ[เอกสารประกอบ](service-connect-to-microsoft-dynamics-marketing.md)ของเราได้
