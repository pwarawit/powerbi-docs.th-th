...
ms.locfileid: "66826606"
---
# <a name="publish-an-app-in-power-bi"></a>เผยแพร่แอปใน Power BI

ใน Power BI คุณสามารถสร้างเนื้อหาที่รวมเป็นแพคเกจอย่างเป็นทางการ จากนั้นแจกจ่ายให้กับผู้รับที่กว้างขวางเป็น*แอป*ได้ คุณสร้างแอปใน*พื้นที่ทำงานแอป*ที่คุณสามารถทำงานร่วมกันบนเนื้อหาของ Power BI กับเพื่อนร่วมงานของคุณ จากนั้น คุณสามารถเผยแพร่แอปที่เสร็จแล้วไปยังกลุ่มบุคคลขนาดใหญ่ต่างๆ ในองค์กรของคุณ 
...
* ตัวเลือกที่ 2: ถ้าพื้นที่ทำงานแอปของคุณอยู่ในความจุ Power BI Premium ผู้ใช้ฟรีในองค์กรของคุณสามารถดูเนื้อหาแอปได้ อ่าน[Power BI Premium คืออะไร](service-premium.md)สำหรับรายละเอียด
...
4. บน**การนำทาง** คุณเลือกเนื้อหาเผยแพร่เป็นส่วนหนึ่งของแอป จากนั้นคุณสามารถเพิ่มการนำทางของแอปเพื่อจัดระเบียบเนื้อหาในส่วนต่าง ๆ ดู[ออกแบบประสบการณ์การนำทางสำหรับแอปของคุณ](#design-the-navigation-experience-for-your-app)ในบทความนี้สำหรับรายละเอียด
...
5. บน**สิทธิ** ตัดสินใจว่าใครสามารถเข้าถึงแอป และสิ่งที่พวกเขาสามารถทำได้ในแอป 
    - ใน[พื้นที่ทำงานแบบคลาสสิก](service-create-workspaces.md): ทุกคนในองค์กร บุคคลที่เจาะจง หรือกลุ่มความปลอดภัยของ Azure Active Directory (AAD)
    - ใน[พื้นที่ทำงานประสบการณ์ใหม่](service-create-the-new-workspaces.md): บุคคลที่เจาะจง กลุ่มความปลอดภัย AAD และรายการการแจกจ่าย และกลุ่ม Office 365 ผู้ใช้พื้นที่ทำงานทั้งหมดจะมีสิทธิ์การเข้าถึงแอปสำหรับพื้นที่ทำงานโดยอัตโนมัติ
    - คุณสามารถอนุญาตให้ผู้ใช้แอปเชื่อมต่อกับชุดข้อมูลเบื้องต้นของแอปโดยใช้สิทธิ์ในการสร้าง ชุดข้อมูลเหล่านี้จะปรากฏในประสบการณ์การค้นหาชุดข้อมูล
    - คุณสามารถอนุญาตให้ผู้ใช้แอปทำสำเนารายงานในแอปนี้ไปยังพื้นที่ทำงานของฉันได้ 
...
หลังจากที่คุณเผยแพร่แอปฯ คุณอาจต้องการเปลี่ยนแปลงหรือปรับปรุงแอปฯนั้น การอัปเดตเป็นเรื่องง่ายถ้าคุณเป็นผู้ดูแลระบบหรือเป็นสมาชิกในพื้นที่ทำงานแอปใหม่ 
...
3. ย้อนกลับไปยังรายการพื้นที่ทำงานแอปของเนื้อหาและเลือก**อัปเดตแอป**ในมุมบนขวา
...
* หน้ารายงานจะแสดงในพื้นที่การนำทางแอปเป็นส่วนที่ขยายได้
* ถ้าคุณปิดตัวสร้างการนำทางใหม่และเผยแพร่ หรืออัปเดตแอป การแก้ไข/ปรับปรุงตามคำสั่งที่คุณทำจะหายไป ตัวอย่างเช่น หัวข้อ การจัดลำดับ ลิงก์ และชื่อที่กำหนดเองสำหรับรายการการนำทางจะหายไปทั้งหมด
...
* ถ้าผู้ใช้ไม่เห็นแอปในรายการแอปโดยทันที ผู้ใช้ควรรีเฟรช หรือปิดและเปิดเบราว์เซอร์ของตนอีกครั้ง

* พยายามอย่าส่งแอปฯมากเกินไป ระมัดระวังไม่ให้มีการส่งแอปฯมากเกินไป เพื่อให้ผู้ใช้ของคุณรู้สึกว่าแอปฯที่ติดตั้งไว้ล่วงหน้าจะมีประโยชน์กับพวกเขา เป็นเรื่องดีที่คุณควรควบคุมว่าใครสามารถส่งแอปฯให้กับผู้ใช้ปลายทางได้ เพื่อให้เหมาะสมกับกำหนดเวลา กำหนดผู้ติดต่อสำหรับการรับแอปในองค์กรของคุณที่ส่งไปยังผู้ใช้ปลายทางได้

* ผู้ใช้ที่เป็นผู้เยี่ยมชมที่ไม่ยอมรับคำเชิญจะไม่ได้รับแอปที่ติดตั้งโดยอัตโนมัติสำหรับพวกเขา  

## <a name="allowing-users-to-connect-to-the-apps-underlying-datasets"></a>การอนุญาตให้ผู้ใช้เชื่อมต่อกับชุดข้อมูลเบื้องต้นของแอป
เมื่อเลือกตัวเลือกเพื่ออนุญาตให้ผู้ใช้ทั้งหมดสามารถเชื่อมต่อกับชุดข้อมูลเบื้องต้นของแอปได้แล้ว ผู้ใช้แอปจะได้รับสิทธิ์ในการสร้างบนชุดข้อมูลเบื้องต้น ซึ่งจะอนุญาตให้ผู้ใช้ [ใช้ชุดข้อมูลของแอปในพื้นที่ทำงาน](service-datasets-across-workspaces.md) ค้นหาชุดข้อมูลเหล่านี้ใน Power BI Desktop และบริการที่มอบประสบการณ์การรับข้อมูล และสร้างรายงานและแดชบอร์ดโดยใช้ชุดข้อมูลเหล่านี้ 

เมื่อคุณยกเลิกการเลือกตัวเลือกนี้ ผู้ใช้รายใหม่ที่คุณเพิ่มเข้ามาในแอปจะไม่มีสิทธิ์ในการสร้างอีกต่อไป อย่างไรก็ตาม สิทธิ์ที่มีอยู่บนชุดข้อมูลเบื้องต้นจะไม่เปลี่ยนแปลง คุณสามารถใช้ส่วนติดต่อผู้ใช้ที่ระบุเพื่อลบสิทธิ์ในการสร้างออกด้วยตนเองจากผู้ใช้แอปที่ควรไม่ได้รับ อ่านเพิ่มเติมเกี่ยวกับ[สิทธิในการสร้าง](service-datasets-build-permissions.md#build-permissions-for-shared-datasets)

## <a name="allowing-users-to-make-a-copy-of-the-reports-in-the-app"></a>การอนุญาตให้ผู้ใช้สามารถทำสำเนารายงานในแอป
เมื่อตัวเลือกในการ**อนุญาตให้ผู้ใช้ทำสำเนารายงานในแอปนี้** หมายความว่าคุณกำลังอนุญาตให้ผู้ใชสามารถ้บันทึกรายงานในแอปลงในพื้นที่ทำงานของฉันได้ พวกเขาสามารถกำหนดรายงานตามความต้องการเฉพาะของตนได้ ตัวเลือกนี้จะต้องเปิดใช้งาน **อนุญาตให้ผู้ใช้แอปเชื่อมต่อกับชุดข้อมูลเบื้องต้นของแอปโดยใช้สิทธิ์ในการสร้าง** ความสามารถนี้มีลักษณะการทำงานเหมือนกับความสามารถ[คัดลอกรายงานจากพื้นที่ทำงานอื่น](service-datasets-copy-reports.md)ใหม่
